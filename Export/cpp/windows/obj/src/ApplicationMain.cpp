...
Void ApplicationMain_obj::main( ){
{
		...
		HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",15)
		...
		Void run(){
{
				HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",41)
				{
				}
				HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",47)
				bool hasMain = false;
				HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",49)
				{
					HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",49)
					int _g = (int)0;
					...
					while(((_g < _g1->length))){
						...
						HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",49)
						++(_g);
						HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",51)
						if (((methodName == HX_CSTRING("main")))){
							HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",53)
							hasMain = true;
							HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",54)
							break;
						}
					}
				}
				HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",58)
				if ((hasMain)){
					HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",59)
					...
					HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",63)
...
Dynamic ApplicationMain_obj::getAsset( ::String inName){
	...
	HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",89)
	if (((inName == HX_CSTRING("assets/nme.svg")))){
		HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",90)
		return ::nme::installer::Assets_obj::getBytes(HX_CSTRING("assets/nme.svg"));
	}
	HX_SOURCE_POS("Export/cpp/windows/haxe/ApplicationMain.hx",96)
	return null();
}
