...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/EventDispatcher.hx",168)
	this->mListner = inListener;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/EventDispatcher.hx",169)
	this->mUseCapture = inUseCapture;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/EventDispatcher.hx",170)
	this->mPriority = inPriority;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/EventDispatcher.hx",171)
...
Void Listener_obj::dispatchEvent( ::neash::events::Event event){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/EventDispatcher.hx",176)
		this->mListner(event);
	}
return null();
}
...
bool Listener_obj::Is( Dynamic inListener,bool inCapture){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/EventDispatcher.hx",182)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.events.Listener"), hx::TCanCast< Listener_obj> ,sStaticFields,sMemberFields,
