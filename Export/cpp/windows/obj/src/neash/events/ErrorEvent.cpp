...
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/ErrorEvent.hx",12)
	super::__construct(type,bubbles,cancelable,text);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/ErrorEvent.hx",13)
	this->errorID = id;
}
;
	return null();
...
::neash::events::Event ErrorEvent_obj::clone( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/ErrorEvent.hx",18)
...
::String ErrorEvent_obj::toString( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/ErrorEvent.hx",24)
