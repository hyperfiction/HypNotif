...
Void JoystickEvent_obj::__construct(::String type,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,hx::Null< int >  __o_device,hx::Null< int >  __o_id,hx::Null< double >  __o_x,hx::Null< double >  __o_y,hx::Null< double >  __o_z)
{
...
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/JoystickEvent.hx",22)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/JoystickEvent.hx",24)
	this->device = device;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/JoystickEvent.hx",25)
	this->id = id;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/JoystickEvent.hx",26)
	this->x = x;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/JoystickEvent.hx",27)
	this->y = y;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/JoystickEvent.hx",28)
	this->z = z;
}
;
	return null();
...
hx::ObjectPtr< JoystickEvent_obj > JoystickEvent_obj::__new(::String type,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,hx::Null< int >  __o_device,hx::Null< int >  __o_id,hx::Null< double >  __o_x,hx::Null< double >  __o_y,hx::Null< double >  __o_z)
...
::neash::events::Event JoystickEvent_obj::clone( ){
	HX_SOURCE_PUSH("JoystickEvent_obj::clone")
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/JoystickEvent.hx",33)
	return ::neash::events::JoystickEvent_obj::__new(this->nmeGetType(),this->nmeGetBubbles(),this->nmeGetCancelable(),this->device,this->id,this->x,this->y,this->z);
}


::String JoystickEvent_obj::toString( ){
	HX_SOURCE_PUSH("JoystickEvent_obj::toString")
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/JoystickEvent.hx",39)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.events.JoystickEvent"), hx::TCanCast< JoystickEvent_obj> ,sStaticFields,sMemberFields,
