...
Void MouseEvent_obj::__construct(::String type,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,hx::Null< double >  __o_localX,hx::Null< double >  __o_localY,::neash::display::InteractiveObject relatedObject,hx::Null< bool >  __o_ctrlKey,hx::Null< bool >  __o_altKey,hx::Null< bool >  __o_shiftKey,hx::Null< bool >  __o_buttonDown,hx::Null< int >  __o_delta,hx::Null< bool >  __o_commandKey,hx::Null< int >  __o_clickCount)
{
...
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",50)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",51)
	this->localX = localX;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",52)
	this->localY = localY;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",53)
	this->relatedObject = relatedObject;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",54)
	this->ctrlKey = ctrlKey;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",55)
	this->altKey = altKey;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",56)
	this->shiftKey = shiftKey;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",57)
	this->buttonDown = buttonDown;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",58)
	this->delta = delta;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",59)
	this->commandKey = commandKey;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",60)
...
::neash::events::Event MouseEvent_obj::clone( ){
	HX_SOURCE_PUSH("MouseEvent_obj::clone")
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",65)
	return ::neash::events::MouseEvent_obj::__new(this->nmeGetType(),this->nmeGetBubbles(),this->nmeGetCancelable(),this->localX,this->localY,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
}


::neash::events::MouseEvent MouseEvent_obj::nmeCreateSimilar( ::String inType,::neash::display::InteractiveObject related,::neash::display::InteractiveObject targ){
	HX_SOURCE_PUSH("MouseEvent_obj::nmeCreateSimilar")
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",83)
	::neash::events::MouseEvent result = ::neash::events::MouseEvent_obj::__new(inType,this->nmeGetBubbles(),this->nmeGetCancelable(),this->localX,this->localY,(  (((related == null()))) ? ::neash::display::InteractiveObject(this->relatedObject) : ::neash::display::InteractiveObject(related) ),this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",85)
	result->stageX = this->stageX;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",86)
	result->stageY = this->stageY;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",87)
	if (((targ != null()))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",88)
		result->nmeSetTarget(targ);
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",89)
	return result;
}
...
::String MouseEvent_obj::toString( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",94)
...
::neash::events::MouseEvent MouseEvent_obj::nmeCreate( ::String inType,Dynamic inEvent,::neash::geom::Point inLocal,::neash::display::InteractiveObject inTarget){
	HX_SOURCE_PUSH("MouseEvent_obj::nmeCreate")
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",72)
	int flags = inEvent->__Field(HX_CSTRING("flags"),true);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",73)
	::neash::events::MouseEvent evt = ::neash::events::MouseEvent_obj::__new(inType,true,false,inLocal->x,inLocal->y,null(),(((int(flags) & int(::neash::events::MouseEvent_obj::efCtrlDown))) != (int)0),(((int(flags) & int(::neash::events::MouseEvent_obj::efAltDown))) != (int)0),(((int(flags) & int(::neash::events::MouseEvent_obj::efShiftDown))) != (int)0),(((int(flags) & int(::neash::events::MouseEvent_obj::efLeftDown))) != (int)0),(int)0,null(),(int)0);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",74)
	evt->stageX = inEvent->__Field(HX_CSTRING("x"),true);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",75)
	evt->stageY = inEvent->__Field(HX_CSTRING("y"),true);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",76)
	evt->nmeSetTarget(inTarget);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/MouseEvent.hx",77)
	return evt;
}
...
Dynamic MouseEvent_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 13:
		...
		if (HX_FIELD_EQ(inName,"relatedObject") ) { relatedObject=inValue.Cast< ::neash::display::InteractiveObject >(); return inValue; }
		break;
	case 14:
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.events.MouseEvent"), hx::TCanCast< MouseEvent_obj> ,sStaticFields,sMemberFields,
