...
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/TouchEvent.hx",26)
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/TouchEvent.hx",27)
	this->touchPointID = (int)0;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/TouchEvent.hx",28)
...
::neash::events::MouseEvent TouchEvent_obj::nmeCreateSimilar( ::String inType,::neash::display::InteractiveObject related,::neash::display::InteractiveObject targ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/TouchEvent.hx",45)
	::neash::events::TouchEvent result = ::neash::events::TouchEvent_obj::__new(inType,this->nmeGetBubbles(),this->nmeGetCancelable(),this->localX,this->localY,(  (((related == null()))) ? ::neash::display::InteractiveObject(this->relatedObject) : ::neash::display::InteractiveObject(related) ),this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/TouchEvent.hx",47)
	result->touchPointID = this->touchPointID;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/TouchEvent.hx",48)
	result->isPrimaryTouchPoint = this->isPrimaryTouchPoint;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/TouchEvent.hx",49)
	if (((targ != null()))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/TouchEvent.hx",50)
		result->nmeSetTarget(targ);
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/TouchEvent.hx",51)
	return result;
}
...
::neash::events::TouchEvent TouchEvent_obj::nmeCreate( ::String inType,Dynamic inEvent,::neash::geom::Point inLocal,::neash::display::InteractiveObject inTarget){
	HX_SOURCE_PUSH("TouchEvent_obj::nmeCreate")
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/TouchEvent.hx",34)
	int flags = inEvent->__Field(HX_CSTRING("flags"),true);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/TouchEvent.hx",35)
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/TouchEvent.hx",36)
	evt->stageX = inEvent->__Field(HX_CSTRING("x"),true);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/TouchEvent.hx",37)
	evt->stageY = inEvent->__Field(HX_CSTRING("y"),true);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/TouchEvent.hx",38)
	evt->nmeSetTarget(inTarget);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/TouchEvent.hx",39)
	return evt;
}
