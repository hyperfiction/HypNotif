...
::neash::display::SpreadMethod SpreadMethod_obj::PAD;

::neash::display::SpreadMethod SpreadMethod_obj::REFLECT;

::neash::display::SpreadMethod SpreadMethod_obj::REPEAT;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.display.SpreadMethod"), hx::TCanCast< SpreadMethod_obj >,sStaticFields,sMemberFields,
