...
::neash::display::StageDisplayState StageDisplayState_obj::FULL_SCREEN;

::neash::display::StageDisplayState StageDisplayState_obj::FULL_SCREEN_INTERACTIVE;

::neash::display::StageDisplayState StageDisplayState_obj::NORMAL;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.display.StageDisplayState"), hx::TCanCast< StageDisplayState_obj >,sStaticFields,sMemberFields,
