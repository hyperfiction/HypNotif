...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/display/IGraphicsData.hx",11)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.display.IGraphicsData"), hx::TCanCast< IGraphicsData_obj> ,sStaticFields,sMemberFields,
