...
::neash::display::StageAlign StageAlign_obj::BOTTOM;

::neash::display::StageAlign StageAlign_obj::BOTTOM_LEFT;

::neash::display::StageAlign StageAlign_obj::BOTTOM_RIGHT;

::neash::display::StageAlign StageAlign_obj::LEFT;

::neash::display::StageAlign StageAlign_obj::RIGHT;

::neash::display::StageAlign StageAlign_obj::TOP;

::neash::display::StageAlign StageAlign_obj::TOP_LEFT;

::neash::display::StageAlign StageAlign_obj::TOP_RIGHT;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.display.StageAlign"), hx::TCanCast< StageAlign_obj >,sStaticFields,sMemberFields,
