...
::neash::display::BlendMode BlendMode_obj::ADD;

::neash::display::BlendMode BlendMode_obj::ALPHA;

::neash::display::BlendMode BlendMode_obj::DARKEN;

::neash::display::BlendMode BlendMode_obj::DIFFERENCE;

::neash::display::BlendMode BlendMode_obj::ERASE;

::neash::display::BlendMode BlendMode_obj::HARDLIGHT;

::neash::display::BlendMode BlendMode_obj::INVERT;

::neash::display::BlendMode BlendMode_obj::LAYER;

::neash::display::BlendMode BlendMode_obj::LIGHTEN;

::neash::display::BlendMode BlendMode_obj::MULTIPLY;

::neash::display::BlendMode BlendMode_obj::NORMAL;

::neash::display::BlendMode BlendMode_obj::OVERLAY;

::neash::display::BlendMode BlendMode_obj::SCREEN;

::neash::display::BlendMode BlendMode_obj::SUBTRACT;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.display.BlendMode"), hx::TCanCast< BlendMode_obj >,sStaticFields,sMemberFields,
