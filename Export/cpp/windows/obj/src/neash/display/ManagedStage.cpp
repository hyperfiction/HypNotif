...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/display/ManagedStage.hx",42)
	super::__construct(::neash::display::ManagedStage_obj::nme_managed_stage_create(inWidth,inHeight),inWidth,inHeight);
}
;
	return null();
}
...
double ManagedStage_obj::nmeDoProcessStageEvent( Dynamic inEvent){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/display/ManagedStage.hx",61)
	this->nmePollTimers();
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/display/ManagedStage.hx",63)
	double wake = this->super::nmeDoProcessStageEvent(inEvent);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/display/ManagedStage.hx",64)
	this->setNextWake(wake);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/display/ManagedStage.hx",66)
	return wake;
}
...
Void ManagedStage_obj::nmeRender( bool inSendEnterFrame){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/display/ManagedStage.hx",75)
		this->beginRender();
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/display/ManagedStage.hx",76)
		this->super::nmeRender(inSendEnterFrame);
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/display/ManagedStage.hx",77)
		this->endRender();
	}
return null();
}
...
Void ManagedStage_obj::pumpEvent( Dynamic inEvent){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/display/ManagedStage.hx",82)
		::neash::display::ManagedStage_obj::nme_managed_stage_pump_event(this->nmeHandle,inEvent);
	}
return null();
}
...
Void ManagedStage_obj::resize( int inWidth,int inHeight){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/display/ManagedStage.hx",88)
...
Void ManagedStage_obj::sendQuit( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/display/ManagedStage.hx",94)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.display.ManagedStage"), hx::TCanCast< ManagedStage_obj> ,sStaticFields,sMemberFields,
...
void ManagedStage_obj::__boot()
{
	...
	hx::Static(nme_managed_stage_create) = ::neash::Loader_obj::load(HX_CSTRING("nme_managed_stage_create"),(int)2);
	hx::Static(nme_managed_stage_pump_event) = ::neash::Loader_obj::load(HX_CSTRING("nme_managed_stage_pump_event"),(int)2);
}
