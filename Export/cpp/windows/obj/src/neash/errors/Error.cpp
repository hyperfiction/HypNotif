...
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/errors/Error.hx",13)
	this->message = inMessage;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/errors/Error.hx",14)
	this->errorID = id;
}
;
	return null();
...
::String Error_obj::getStackTrace( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/errors/Error.hx",19)
	return HX_CSTRING("");
}
...
::String Error_obj::toString( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/errors/Error.hx",25)
	return this->message;
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.errors.Error"), hx::TCanCast< Error_obj> ,sStaticFields,sMemberFields,
