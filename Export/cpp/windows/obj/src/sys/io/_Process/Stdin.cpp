...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",33)
	this->p = p;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",34)
...
Void Stdin_obj::close( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",38)
		this->super::close();
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",39)
...
Void Stdin_obj::writeByte( int c){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",43)
		this->buf->b[(int)0] = c;
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",44)
...
int Stdin_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",48)
	try{
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",48)
		...
		{
			Dynamic e = __e;{
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",50)
				hx::Throw (::haxe::io::Eof_obj::__new());
			}
		}
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",53)
	return (int)0;
}
