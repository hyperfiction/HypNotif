...
{
{
	struct _Function_1_1{
		inline static Dynamic Block( ::String &cmd,Array< ::String > &args){
			{
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",104)
				try{
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",104)
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",105)
	this->_stdin = ::sys::io::_Process::Stdin_obj::__new(this->p);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",106)
	this->_stdout = ::sys::io::_Process::Stdout_obj::__new(this->p,true);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",107)
...
int Process_obj::getPid( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",110)
...
int Process_obj::exitCode( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",114)
...
Void Process_obj::close( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",118)
...
{
		HX_SOURCE_PUSH("Process_obj::kill")
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/Process.hx",122)
