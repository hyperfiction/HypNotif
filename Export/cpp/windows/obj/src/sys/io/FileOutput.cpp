...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/FileOutput.hx",33)
	this->__f = f;
}
;
	return null();
...
Void FileOutput_obj::writeByte( int c){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/FileOutput.hx",37)
		try{
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/FileOutput.hx",38)
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
	...
	struct _Function_1_1{
		inline static int Block( ::sys::io::FileOutput_obj *__this,::haxe::io::Bytes &s,int &p,int &l){
			{
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/FileOutput.hx",42)
				try{
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/FileOutput.hx",42)
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/FileOutput.hx",41)
...
Void FileOutput_obj::flush( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/FileOutput.hx",45)
...
Void FileOutput_obj::close( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/FileOutput.hx",50)
		this->super::close();
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/FileOutput.hx",51)
...
Void FileOutput_obj::seek( int p,::sys::io::FileSeek pos){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/FileOutput.hx",54)
...
int FileOutput_obj::tell( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/sys/io/FileOutput.hx",58)
