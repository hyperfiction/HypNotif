						...
						Void run(Dynamic _1){
{
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Lib.hx",57)
	return null();
}
...
Void Lib_obj::rethrow( Dynamic inExp){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Lib.hx",60)
		hx::Throw (inExp);
	}
return null();
}
...
Void Lib_obj::stringReference( Dynamic inExp){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Lib.hx",62)
		hx::Throw (inExp);
	}
return null();
}
...
Void Lib_obj::print( Dynamic v){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Lib.hx",67)
		::__hxcpp_print(v);
	}
return null();
}
...
Dynamic Lib_obj::haxeToNeko( Dynamic v){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Lib.hx",75)
	return v;
}
...
Dynamic Lib_obj::nekoToHaxe( Dynamic v){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Lib.hx",83)
	return v;
}
...
Void Lib_obj::println( Dynamic v){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/Lib.hx",89)
		::__hxcpp_println(v);
	}
return null();
}
