...
Void Assets_obj::initialize( ){
{
		...
		if ((!(::nme::installer::Assets_obj::initialized))){
			...
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/nme.svg"),HX_CSTRING("assets/nme.svg"));
	...
	HX_SOURCE_PUSH("Assets_obj::getBitmapData");
{
		...
		::nme::installer::Assets_obj::initialize();
		HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",48)
		if (((bool(::nme::installer::Assets_obj::resourceTypes->exists(id)) && bool((::nme::installer::Assets_obj::resourceTypes->get(id) == HX_CSTRING("image")))))){
			...
			if (((bool(useCache) && bool(::nme::installer::Assets_obj::cachedBitmapData->exists(id))))){
				...
				HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",58)
				if ((useCache)){
					HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",58)
			...
			::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no BitmapData asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),70,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getBitmapData")));
...
::neash::utils::ByteArray Assets_obj::getBytes( ::String id){
	...
	HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",81)
	::nme::installer::Assets_obj::initialize();
	HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",83)
	if ((::nme::installer::Assets_obj::resourceNames->exists(id))){
		...
		::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no String or ByteArray asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),89,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getBytes")));
		HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",91)
		return null();
	}
	HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",83)
	return null();
...
::neash::text::Font Assets_obj::getFont( ::String id){
	...
	HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",100)
	::nme::installer::Assets_obj::initialize();
	HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",102)
	if (((bool(::nme::installer::Assets_obj::resourceTypes->exists(id)) && bool((::nme::installer::Assets_obj::resourceTypes->get(id) == HX_CSTRING("font")))))){
		...
		::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no Font asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),108,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getFont")));
		HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",110)
		return null();
	}
	HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",102)
	return null();
...
::neash::media::Sound Assets_obj::getSound( ::String id){
	...
	HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",119)
	::nme::installer::Assets_obj::initialize();
	HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",121)
	if ((::nme::installer::Assets_obj::resourceTypes->exists(id))){
		HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",121)
		if (((::nme::installer::Assets_obj::resourceTypes->get(id) == HX_CSTRING("sound")))){
			HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",123)
	...
	::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no Sound asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),135,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getSound")));
...
::String Assets_obj::getText( ::String id){
	...
	HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",144)
	::neash::utils::ByteArray bytes = ::nme::installer::Assets_obj::getBytes(id);
	HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",146)
	if (((bytes == null()))){
		HX_SOURCE_POS("Export/cpp/windows/haxe/nme/installer/Assets.hx",146)
		return null();
	}
