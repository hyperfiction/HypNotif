...
class SoundChannel_obj : public ::neash::events::EventDispatcher_obj{
	public:
		...
		SoundChannel_obj();
		Void __construct(Dynamic inSoundHandle,double startTime,int loops,::neash::media::SoundTransform sndTransform);

	public:
		static hx::ObjectPtr< SoundChannel_obj > __new(Dynamic inSoundHandle,double startTime,int loops,::neash::media::SoundTransform sndTransform);
