...
class FocusEvent_obj : public ::neash::events::Event_obj{
	public:
		...
		FocusEvent_obj();
		Void __construct(::String inType,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,::neash::display::InteractiveObject relatedObject,hx::Null< bool >  __o_shiftKey,hx::Null< int >  __o_keyCode,hx::Null< ::String >  __o_direction);

	public:
		static hx::ObjectPtr< FocusEvent_obj > __new(::String inType,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,::neash::display::InteractiveObject relatedObject,hx::Null< bool >  __o_shiftKey,hx::Null< int >  __o_keyCode,hx::Null< ::String >  __o_direction);
