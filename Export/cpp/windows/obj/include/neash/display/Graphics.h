...
class Graphics_obj : public hx::Object{
	...
	public:
		...
		virtual Void beginGradientFill( ::neash::display::GradientType type,Dynamic colors,Dynamic alphas,Dynamic ratios,::neash::geom::Matrix matrix,::neash::display::SpreadMethod spreadMethod,::neash::display::InterpolationMethod interpolationMethod,hx::Null< double >  focalPointRatio);
		...
		virtual Void drawTiles( ::neash::display::Tilesheet sheet,Array< double > inXYID,hx::Null< bool >  inSmooth,hx::Null< int >  inFlags);
		Dynamic drawTiles_dyn();

		virtual Void drawTriangles( Array< double > vertices,Array< int > indices,Array< double > uvtData,::neash::display::TriangleCulling culling,Array< int > colours,hx::Null< int >  blendMode,Array< double > viewport);
		...
		virtual Void lineGradientStyle( ::neash::display::GradientType type,Dynamic colors,Dynamic alphas,Dynamic ratios,::neash::geom::Matrix matrix,::neash::display::SpreadMethod spreadMethod,::neash::display::InterpolationMethod interpolationMethod,hx::Null< double >  focalPointRatio);
		Dynamic lineGradientStyle_dyn();

		virtual Void lineStyle( Dynamic thickness,hx::Null< int >  color,hx::Null< double >  alpha,hx::Null< bool >  pixelHinting,::neash::display::LineScaleMode scaleMode,::neash::display::CapsStyle caps,::neash::display::JointStyle joints,hx::Null< double >  miterLimit);
