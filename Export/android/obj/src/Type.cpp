...
Dynamic Type_obj::allEnums( ::Enum e){
	HX_SOURCE_PUSH("Type_obj::allEnums")
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",152)
	Array< ::String > names = e->GetClassFields();
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",153)
	Dynamic enums = Dynamic( Array_obj<Dynamic>::__new() );
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",154)
	{
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",154)
		int _g = (int)0;
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",154)
		while(((_g < names->length))){
			...
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",154)
			++(_g);
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",156)
			try{
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",157)
				Dynamic result = e->mConstructEnum(name,null());
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",158)
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe/std/cpp/_std/Type.hx",162)
	return enums;
}
