...
{
{
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",25)
	this->_aContent = Dynamic( Array_obj<Dynamic>::__new());
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",26)
	...
	HX_SOURCE_PUSH("PriorityQueue_obj::add");
{
		...
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",39)
		Dynamic desc = _Function_1_1::Block(value,prio);
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",41)
		this->_add(desc,prio);
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",42)
		this->_bInvalidate = true;
	}
return null();
}
...
{
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",53)
		Dynamic desc;
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",54)
		bool b = false;
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",55)
		{
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",55)
			int _g = (int)0;
			...
			while(((_g < _g1->__Field(HX_CSTRING("length"),true)))){
				...
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",55)
				++(_g);
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",56)
				if (((bool((desc1->__Field(HX_CSTRING("content"),true) == value)) && bool(((bool((prio == (int)-1)) || bool((desc1->__Field(HX_CSTRING("prio"),true) == prio)))))))){
					HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",57)
					this->_aContent->__Field(HX_CSTRING("remove"),true)(desc1);
					HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",58)
					b = true;
					HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",59)
					break;
				}
			}
		}
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",62)
		this->_bInvalidate = true;
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",63)
		return b;
	}
}
...
bool PriorityQueue_obj::contains( Dynamic value,int prio){
	...
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",74)
	bool b = false;
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",75)
	{
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",75)
		int _g = (int)0;
		Dynamic _g1 = this->_aContent;
		...
		while(((_g < _g1->__Field(HX_CSTRING("length"),true)))){
			...
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",75)
			++(_g);
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",76)
			if (((bool((desc->__Field(HX_CSTRING("content"),true) == value)) && bool((desc->__Field(HX_CSTRING("prio"),true) == prio))))){
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",77)
				b = true;
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",78)
				break;
			}
		}
	}
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",82)
	return b;
}
...
Void PriorityQueue_obj::sort( ){
{
		...
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",91)
		this->_sort();
	}
return null();
}
...
::org::shoebox::collections::PrioQueueIterator PriorityQueue_obj::iterator( ){
	...
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",103)
	if ((!(this->_bInvalidate))){
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",104)
		return this->_oIterator;
	}
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",106)
	this->_oIterator = ::org::shoebox::collections::PrioQueueIterator_obj::__new(this->_aContent);
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",107)
	return this->_oIterator;
}
...
Void PriorityQueue_obj::setPrioOf( Dynamic value,int prio){
{
		...
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",118)
		{
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",118)
			int _g = (int)0;
			Dynamic _g1 = this->_aContent;
			...
			while(((_g < _g1->__Field(HX_CSTRING("length"),true)))){
				...
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",118)
				++(_g);
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",119)
				if (((o->__Field(HX_CSTRING("content"),true) == value))){
					HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",120)
					o->__FieldRef(HX_CSTRING("prio")) = prio;
				}
			}
		}
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",122)
		this->_sort();
	}
return null();
}
...
int PriorityQueue_obj::getPrioOf( Dynamic value){
	...
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",133)
	bool b = false;
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",134)
	int p = (int)-1;
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",135)
	{
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",135)
		int _g = (int)0;
		Dynamic _g1 = this->_aContent;
		...
		while(((_g < _g1->__Field(HX_CSTRING("length"),true)))){
			...
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",135)
			++(_g);
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",136)
			if (((desc->__Field(HX_CSTRING("content"),true) == value))){
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",137)
				p = desc->__Field(HX_CSTRING("prio"),true);
			}
		}
	}
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",140)
	return p;
}
...
Dynamic PriorityQueue_obj::getContent( ){
	...
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",149)
...
Void PriorityQueue_obj::_sort( ){
{
		...
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",162)
		Dynamic a = this->_aContent->__Field(HX_CSTRING("copy"),true)();
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",163)
		this->_aContent = Dynamic( Array_obj<Dynamic>::__new());
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",164)
		{
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",164)
			int _g = (int)0;
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",164)
			while(((_g < a->__Field(HX_CSTRING("length"),true)))){
				...
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",164)
				++(_g);
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",165)
				this->_add(desc,desc->__Field(HX_CSTRING("prio"),true));
			}
		}
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",166)
		this->_bInvalidate = true;
	}
return null();
}
...
Void PriorityQueue_obj::_add( Dynamic desc,int prio){
{
		...
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",176)
		int inc = this->_aContent->__Field(HX_CSTRING("length"),true);
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",177)
		while((((inc)-- > (int)0))){
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",177)
			if (((this->_aContent->__GetItem(inc)->__Field(HX_CSTRING("prio"),true) >= prio))){
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",179)
				break;
			}
		}
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",182)
...
int PriorityQueue_obj::_getLength( ){
	...
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",191)
