	...
	HX_SOURCE_PUSH("PriorityQueue_obj::add");
{
		...
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",72)
...
{
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",88)
		Dynamic desc;
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",89)
		bool b = false;
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",90)
		{
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",90)
			int _g = (int)0;
			...
			while(((_g < _g1->__Field(HX_CSTRING("length"),true)))){
				...
				if (((bool((desc1->__Field(HX_CSTRING("content"),true) == value)) && bool(((bool((prio == (int)-1)) || bool((desc1->__Field(HX_CSTRING("prio"),true) == prio)))))))){
					HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",92)
					this->_aContent->__Field(HX_CSTRING("remove"),true)(desc1);
					HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",93)
					b = true;
					HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",94)
					break;
				}
			}
		}
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",97)
		this->_bInvalidate = true;
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",98)
		return b;
	}
}
...
bool PriorityQueue_obj::contains( Dynamic value,int prio){
	...
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",111)
	bool b = false;
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",112)
	{
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",112)
		int _g = (int)0;
		Dynamic _g1 = this->_aContent;
		...
		while(((_g < _g1->__Field(HX_CSTRING("length"),true)))){
			...
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",112)
			++(_g);
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",113)
			if (((bool((desc->__Field(HX_CSTRING("content"),true) == value)) && bool((desc->__Field(HX_CSTRING("prio"),true) == prio))))){
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",114)
				b = true;
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",115)
				break;
			}
		}
	}
...
Void PriorityQueue_obj::sort( ){
{
		...
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",128)
		this->_sort();
	}
return null();
}
...
::org::shoebox::collections::PrioQueueIterator PriorityQueue_obj::iterator( ){
	...
	if ((!(this->_bInvalidate))){
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",141)
		return this->_oIterator;
	}
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",143)
	this->_oIterator = ::org::shoebox::collections::PrioQueueIterator_obj::__new(this->_aContent);
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",144)
	return this->_oIterator;
}
...
Void PriorityQueue_obj::setPrioOf( Dynamic value,int prio){
{
		...
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",157)
		{
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",157)
			int _g = (int)0;
			Dynamic _g1 = this->_aContent;
			...
			while(((_g < _g1->__Field(HX_CSTRING("length"),true)))){
				...
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",157)
				++(_g);
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",158)
				if (((o->__Field(HX_CSTRING("content"),true) == value))){
					HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",159)
					o->__FieldRef(HX_CSTRING("prio")) = prio;
				}
			}
		}
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",161)
		this->_sort();
	}
return null();
}
...
int PriorityQueue_obj::getPrioOf( Dynamic value){
	...
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",174)
	bool b = false;
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",175)
	int p = (int)-1;
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",176)
	{
		...
		while(((_g < _g1->__Field(HX_CSTRING("length"),true)))){
			...
			if (((desc->__Field(HX_CSTRING("content"),true) == value))){
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",178)
				p = desc->__Field(HX_CSTRING("prio"),true);
			}
		}
	}
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",181)
	return p;
}
...
Dynamic PriorityQueue_obj::getContent( ){
	...
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",190)
...
Void PriorityQueue_obj::_sort( ){
{
		...
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",203)
		Dynamic a = this->_aContent->__Field(HX_CSTRING("copy"),true)();
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",204)
		this->_aContent = Dynamic( Array_obj<Dynamic>::__new());
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",205)
		{
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",205)
			int _g = (int)0;
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",205)
			while(((_g < a->__Field(HX_CSTRING("length"),true)))){
				...
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",205)
				++(_g);
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",206)
				this->_add(desc,desc->__Field(HX_CSTRING("prio"),true));
			}
		}
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",207)
		this->_bInvalidate = true;
	}
return null();
}
...
Void PriorityQueue_obj::_add( Dynamic desc,int prio){
{
		...
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",219)
		int inc = this->_aContent->__Field(HX_CSTRING("length"),true);
		HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",220)
		while((((inc)-- > (int)0))){
			HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",220)
			if (((this->_aContent->__GetItem(inc)->__Field(HX_CSTRING("prio"),true) >= prio))){
				HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",222)
				break;
			}
		}
...
int PriorityQueue_obj::_getLength( ){
	...
	HX_SOURCE_POS("../inthebox/src/org/shoebox/collections/PriorityQueue.hx",234)
