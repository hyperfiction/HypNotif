...
{
{
	HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",55)
	this->_oQueue = ::org::shoebox::collections::PriorityQueue_obj::__new();
	HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",56)
...
{
		HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",69)
		if ((this->_exist(f,prio))){
			HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",70)
			return null();
		}
		...
		HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",72)
		Dynamic s = _Function_1_1::Block(f,count);
		HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",73)
...
{
		HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",85)
		Dynamic content = this->_oQueue->getContent();
		HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",86)
		{
			HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",86)
			int _g = (int)0;
			HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",86)
			while(((_g < content->__Field(HX_CSTRING("length"),true)))){
				...
				HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",86)
				++(_g);
				HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",88)
				if (((bool((o->__Field(HX_CSTRING("content"),true)->__Field(HX_CSTRING("listener"),true) == f)) && bool((o->__Field(HX_CSTRING("prio"),true) == prio))))){
					HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",89)
					content->__Field(HX_CSTRING("remove"),true)(o);
					HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",90)
					break;
				}
			}
		}
...
Void ASignal_obj::dispose( ){
{
		...
		HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",102)
		this->_oQueue = null();
	}
return null();
}
...
{
		HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",116)
		bool b = false;
		HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",117)
		Dynamic content = this->_oQueue->getContent();
		HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",118)
		{
			HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",118)
			int _g = (int)0;
			HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",118)
			while(((_g < content->__Field(HX_CSTRING("length"),true)))){
				...
				HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",118)
				++(_g);
				HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",119)
				if (((bool((o->__Field(HX_CSTRING("content"),true)->__Field(HX_CSTRING("listener"),true) == f)) && bool((o->__Field(HX_CSTRING("prio"),true) == prio))))){
					HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",120)
					b = true;
					HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",121)
					break;
				}
			}
		}
		HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",124)
		return b;
	}
}
...
Void ASignal_obj::_check( Dynamic l){
{
		...
		HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",136)
		if (((l->__Field(HX_CSTRING("count"),true) != (int)-1))){
			HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",137)
			(l->__FieldRef(HX_CSTRING("count")))--;
		}
		HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",139)
		if (((l->__Field(HX_CSTRING("count"),true) == (int)0))){
			HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",140)
...
bool ASignal_obj::_setEnabled( bool b){
	...
	HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",151)
	this->enabled = b;
	HX_SOURCE_POS("../inthebox/src/org/shoebox/utils/system/ASignal.hx",152)
	return b;
}
