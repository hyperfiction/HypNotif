...
Void RangeError_obj::__construct(hx::Null< ::String >  __o_inMessage)
{
::String inMessage = __o_inMessage.Default(HX_CSTRING(""));
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/errors/RangeError.hx",8)
...
hx::ObjectPtr< RangeError_obj > RangeError_obj::__new(hx::Null< ::String >  __o_inMessage)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.errors.RangeError"), hx::TCanCast< RangeError_obj> ,sStaticFields,sMemberFields,
