		...
		Void run(Dynamic inFrameHandle){
{
				...
				try{
					...
					{
						Dynamic e = __e;{
							HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/Lib.hx",75)
							::haxe::Log_obj::trace((HX_CSTRING("ERROR: ") + e),hx::SourceInfo(HX_CSTRING("Lib.hx"),75,HX_CSTRING("neash.Lib"),HX_CSTRING("create")));
						}
					}
				}
			}
...
Void Lib_obj::exit( ){
{
		...
		if (((quit != null()))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/Lib.hx",97)
			if (((quit == ::neash::Lib_obj::close_dyn()))){
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/Lib.hx",98)
				::Sys_obj::exit((int)0);
			}
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/Lib.hx",102)
			quit().Cast< Void >();
		}
	}
return null();
...
Void Lib_obj::postUICallback( Dynamic inCallback){
{
		...
		::neash::Lib_obj::nme_post_ui_callback(inCallback);
	}
return null();
}
...
void Lib_obj::__boot()
{
	...
	hx::Static(file);
	hx::Static(nme_post_ui_callback) = ::neash::Loader_obj::load(HX_CSTRING("nme_post_ui_callback"),(int)1);
