...
::neash::display::GradientType GradientType_obj::LINEAR;

::neash::display::GradientType GradientType_obj::RADIAL;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.display.GradientType"), hx::TCanCast< GradientType_obj >,sStaticFields,sMemberFields,
