...
::neash::display::PixelSnapping PixelSnapping_obj::ALWAYS;

::neash::display::PixelSnapping PixelSnapping_obj::AUTO;

::neash::display::PixelSnapping PixelSnapping_obj::NEVER;
