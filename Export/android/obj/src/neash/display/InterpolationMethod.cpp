...
::neash::display::InterpolationMethod InterpolationMethod_obj::LINEAR_RGB;

::neash::display::InterpolationMethod InterpolationMethod_obj::RGB;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.display.InterpolationMethod"), hx::TCanCast< InterpolationMethod_obj >,sStaticFields,sMemberFields,
