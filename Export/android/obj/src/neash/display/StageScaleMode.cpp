...
::neash::display::StageScaleMode StageScaleMode_obj::EXACT_FIT;

::neash::display::StageScaleMode StageScaleMode_obj::NO_BORDER;

::neash::display::StageScaleMode StageScaleMode_obj::NO_SCALE;

::neash::display::StageScaleMode StageScaleMode_obj::SHOW_ALL;
