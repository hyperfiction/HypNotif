...
::neash::display::StageQuality StageQuality_obj::BEST;

::neash::display::StageQuality StageQuality_obj::HIGH;

::neash::display::StageQuality StageQuality_obj::LOW;

::neash::display::StageQuality StageQuality_obj::MEDIUM;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.display.StageQuality"), hx::TCanCast< StageQuality_obj >,sStaticFields,sMemberFields,
