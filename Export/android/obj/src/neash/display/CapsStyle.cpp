...
::neash::display::CapsStyle CapsStyle_obj::NONE;

::neash::display::CapsStyle CapsStyle_obj::ROUND;

::neash::display::CapsStyle CapsStyle_obj::SQUARE;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.display.CapsStyle"), hx::TCanCast< CapsStyle_obj >,sStaticFields,sMemberFields,
