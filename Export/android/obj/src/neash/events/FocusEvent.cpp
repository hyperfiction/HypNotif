...
Void FocusEvent_obj::__construct(::String inType,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,::neash::display::InteractiveObject relatedObject,hx::Null< bool >  __o_shiftKey,hx::Null< int >  __o_keyCode,hx::Null< ::String >  __o_direction)
{
...
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/FocusEvent.hx",22)
	super::__construct(inType,bubbles,cancelable);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/FocusEvent.hx",23)
	this->relatedObject = relatedObject;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/FocusEvent.hx",24)
	this->keyCode = keyCode;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/FocusEvent.hx",25)
...
hx::ObjectPtr< FocusEvent_obj > FocusEvent_obj::__new(::String inType,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,::neash::display::InteractiveObject relatedObject,hx::Null< bool >  __o_shiftKey,hx::Null< int >  __o_keyCode,hx::Null< ::String >  __o_direction)
...
::neash::events::Event FocusEvent_obj::clone( ){
	HX_SOURCE_PUSH("FocusEvent_obj::clone")
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/FocusEvent.hx",30)
	return ::neash::events::FocusEvent_obj::__new(this->nmeGetType(),this->nmeGetBubbles(),this->nmeGetCancelable(),this->relatedObject,this->shiftKey,this->keyCode,null());
}


::String FocusEvent_obj::toString( ){
	HX_SOURCE_PUSH("FocusEvent_obj::toString")
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/FocusEvent.hx",36)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.events.FocusEvent"), hx::TCanCast< FocusEvent_obj> ,sStaticFields,sMemberFields,
