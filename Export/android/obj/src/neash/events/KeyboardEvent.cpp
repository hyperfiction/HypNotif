...
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/KeyboardEvent.hx",22)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/KeyboardEvent.hx",24)
	this->keyCode = keyCodeValue;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/KeyboardEvent.hx",25)
	this->keyLocation = (  (((keyLocationValue == null()))) ? int((int)0) : int(keyLocationValue) );
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/KeyboardEvent.hx",26)
	this->charCode = (  (((charCodeValue == null()))) ? int((int)0) : int(charCodeValue) );
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/KeyboardEvent.hx",28)
	this->shiftKey = shiftKeyValue;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/KeyboardEvent.hx",29)
	this->altKey = altKeyValue;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/KeyboardEvent.hx",30)
	this->controlKey = controlKeyValue;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/KeyboardEvent.hx",31)
	this->commandKey = commandKeyValue;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/KeyboardEvent.hx",32)
...
::neash::events::Event KeyboardEvent_obj::clone( ){
	HX_SOURCE_PUSH("KeyboardEvent_obj::clone")
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/KeyboardEvent.hx",37)
	return ::neash::events::KeyboardEvent_obj::__new(this->nmeGetType(),this->nmeGetBubbles(),this->nmeGetCancelable(),this->charCode,this->keyCode,this->keyLocation,this->ctrlKey,this->altKey,this->shiftKey,this->controlKey,this->commandKey);
}


::String KeyboardEvent_obj::toString( ){
	HX_SOURCE_PUSH("KeyboardEvent_obj::toString")
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/events/KeyboardEvent.hx",43)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.events.KeyboardEvent"), hx::TCanCast< KeyboardEvent_obj> ,sStaticFields,sMemberFields,
