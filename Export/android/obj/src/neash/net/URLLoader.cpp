...
{
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",53)
	super::__construct(null());
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",54)
	this->nmeHandle = (int)0;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",55)
	this->bytesLoaded = (int)0;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",56)
	this->bytesTotal = (int)-1;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",57)
	this->state = (int)0;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",58)
	this->dataFormat = ::neash::net::URLLoaderDataFormat_obj::TEXT_dyn();
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",59)
	if (((request != null()))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",60)
		this->load(request);
	}
}
;
...
Array< ::String > URLLoader_obj::getCookies( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",71)
...
::neash::net::URLLoaderDataFormat _switch_1 = (this->dataFormat);
				...
				{
					Dynamic e = __e;{
						HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",108)
						this->onError(e);
						HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",109)
						return null();
					}
				}
			}
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",112)
			this->nmeDataComplete();
		}
		else{
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",116)
			request->nmePrepare();
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",117)
			this->nmeHandle = ::neash::net::URLLoader_obj::nme_curl_create(request);
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",118)
			if (((this->nmeHandle == null()))){
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",119)
				this->onError(HX_CSTRING("Could not open URL"));
			}
			else{
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",123)
...
Void URLLoader_obj::onError( ::String msg){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",170)
		::neash::net::URLLoader_obj::activeLoaders->remove(hx::ObjectPtr<OBJ_>(this));
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",171)
...
Void URLLoader_obj::dispatchHTTPStatus( int code){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",174)
...
::neash::net::URLLoaderDataFormat _switch_2 = (this->dataFormat);
					...
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",217)
					this->nmeHandle = null();
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",218)
					this->dispatchEvent(evt);
				}
			}
			else{
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",221)
				if (((this->state == (int)4))){
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",223)
					this->dispatchHTTPStatus(code);
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",225)
					...
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",226)
					this->nmeHandle = null();
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",227)
					this->dispatchEvent(evt);
				}
			}
		}
...
bool URLLoader_obj::hasActive( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",77)
...
Void URLLoader_obj::initialize( ::String inCACertFilePath){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",83)
...
bool URLLoader_obj::nmeLoadPending( ){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",146)
	return !(::neash::net::URLLoader_obj::activeLoaders->isEmpty());
}
...
Void URLLoader_obj::nmePollData( ){
{
		...
		if ((!(::neash::net::URLLoader_obj::activeLoaders->isEmpty()))){
			...
			for(::cpp::FastIterator_obj< ::neash::net::URLLoader > *__it = ::cpp::CreateFastIterator< ::neash::net::URLLoader >(oldLoaders->iterator());  __it->hasNext(); ){
				...
				{
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",160)
					loader->update();
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",161)
					if (((loader->state == (int)2))){
						HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/neash/net/URLLoader.hx",162)
