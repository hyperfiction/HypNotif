...
Void Timer_obj::stop( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",132)
		if ((this->mRunning)){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",136)
			this->mRunning = false;
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",137)
...
Void Timer_obj::nmeCheck( double inTime){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",174)
		if (((inTime >= this->mFireAt))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",178)
			hx::AddEq(this->mFireAt,this->mTime);
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",179)
			this->run();
		}
	}
return null();
...
double Timer_obj::nmeNextWake( double limit){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",149)
	double now = (::haxe::Timer_obj::nme_time_stamp() * 1000.0);
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",151)
	{
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",151)
		int _g = (int)0;
		...
		while(((_g < _g1->length))){
			...
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",151)
			++(_g);
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",153)
			double sleep = (timer->mFireAt - now);
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",155)
			if (((sleep < limit))){
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",157)
				limit = sleep;
				HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",159)
				if (((limit < (int)0))){
					HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",159)
					return (int)0;
				}
...
Void Timer_obj::nmeCheckTimers( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",191)
		double now = ::haxe::Timer_obj::GetMS();
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",193)
		{
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",193)
			int _g = (int)0;
			Array< ::haxe::Timer > _g1 = ::haxe::Timer_obj::sRunningTimers;
...
::haxe::Timer Timer_obj::delay( Dynamic f,int time){
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",210)
	Dynamic f1 = Dynamic( Array_obj<Dynamic>::__new().Add(f));
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",212)
	...
	Void run(){
{
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",215)
			t->__get((int)0)->stop();
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",216)
	...
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",214)
	t->__get((int)0)->run =  Dynamic(new _Function_1_1(t,f1));
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,3,2/haxe/Timer.hx",219)
