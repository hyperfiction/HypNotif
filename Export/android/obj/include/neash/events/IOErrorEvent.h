...
class IOErrorEvent_obj : public ::neash::events::ErrorEvent_obj{
	public:
		...
		IOErrorEvent_obj();
		Void __construct(::String inType,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,hx::Null< ::String >  __o_text,hx::Null< int >  __o_id);

	public:
		static hx::ObjectPtr< IOErrorEvent_obj > __new(::String inType,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,hx::Null< ::String >  __o_text,hx::Null< int >  __o_id);
