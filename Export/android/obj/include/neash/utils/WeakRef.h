...
#define INCLUDED_neash_utils_WeakRef

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS2(neash,utils,WeakRef)
namespace neash{
namespace utils{
...
class WeakRef_obj : public hx::Object{
	...
	public:
		...
		static Dynamic &nme_weak_ref_create_dyn() { return nme_weak_ref_create;}
		static Dynamic nme_weak_ref_get; /* REM */ 
		static Dynamic &nme_weak_ref_get_dyn() { return nme_weak_ref_get;}
};

} // end namespace neash
} // end namespace utils

#endif /* INCLUDED_neash_utils_WeakRef */ 
