...
class Lib_obj : public hx::Object{
	...
	public:
		...
		static Void create( Dynamic inOnLoaded,int inWidth,int inHeight,hx::Null< double >  inFrameRate,hx::Null< int >  inColour,hx::Null< int >  inFlags,hx::Null< ::String >  inTitle,::neash::display::BitmapData inIcon);
		static Dynamic create_dyn();

		static ::neash::display::ManagedStage createManagedStage( int inWidth,int inHeight);
		...
		static Dynamic nme_post_ui_callback; /* REM */ 
		static Dynamic &nme_post_ui_callback_dyn() { return nme_post_ui_callback;}
