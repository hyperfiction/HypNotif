...
#define INCLUDED_nme_Test

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS1(nme,Test)
namespace nme{
...
class Test_obj : public hx::Object{
	...
	public:
		static hx::ObjectPtr< Test_obj > __new(Dynamic handle);
		...
		static ::nme::Test create( Dynamic arg0);
