...
class BitmapData_obj : public hx::Object{
	...
	public:
		...
		virtual Void copyPixels( ::nme::display::BitmapData sourceBitmapData,::nme::geom::Rectangle sourceRect,::nme::geom::Point destPoint,::nme::display::BitmapData alphaBitmapData,::nme::geom::Point alphaPoint,hx::Null< bool >  mergeAlpha);
		...
		virtual Void draw( ::nme::display::IBitmapDrawable source,::nme::geom::Matrix matrix,::nme::geom::ColorTransform colorTransform,::String blendMode,::nme::geom::Rectangle clipRect,hx::Null< bool >  smoothing);
		Dynamic draw_dyn();

		virtual Void dumpBits( );
		Dynamic dumpBits_dyn();

		virtual ::nme::utils::ByteArray encode( ::String inFormat,hx::Null< double >  inQuality);
		Dynamic encode_dyn();
