...
class Lib_obj : public hx::Object{
	...
	public:
		...
		static Void create( Dynamic inOnLoaded,int inWidth,int inHeight,hx::Null< double >  inFrameRate,hx::Null< int >  inColour,hx::Null< int >  inFlags,hx::Null< ::String >  inTitle,::nme::display::BitmapData inIcon);
