...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/filters/BitmapFilter.hx",12)
	this->type = inType;
}
;
	return null();
...
::nme::filters::BitmapFilter BitmapFilter_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/filters/BitmapFilter.hx",19)
	hx::Throw (HX_CSTRING("clone not implemented"));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/filters/BitmapFilter.hx",20)
	return null();
}
