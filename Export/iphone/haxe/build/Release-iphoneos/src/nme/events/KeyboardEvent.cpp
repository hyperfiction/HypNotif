...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/KeyboardEvent.hx",23)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/KeyboardEvent.hx",25)
	this->keyCode = keyCodeValue;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/KeyboardEvent.hx",26)
	this->keyLocation = (  (((keyLocationValue == null()))) ? int((int)0) : int(keyLocationValue) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/KeyboardEvent.hx",27)
	this->charCode = (  (((charCodeValue == null()))) ? int((int)0) : int(charCodeValue) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/KeyboardEvent.hx",29)
	this->shiftKey = shiftKeyValue;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/KeyboardEvent.hx",30)
	this->altKey = altKeyValue;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/KeyboardEvent.hx",31)
	this->controlKey = controlKeyValue;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/KeyboardEvent.hx",32)
	this->commandKey = commandKeyValue;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/KeyboardEvent.hx",33)
...
::nme::events::Event KeyboardEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/KeyboardEvent.hx",38)
...
::String KeyboardEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/KeyboardEvent.hx",44)
