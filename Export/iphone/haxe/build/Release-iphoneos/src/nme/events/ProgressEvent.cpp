...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/ProgressEvent.hx",17)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/ProgressEvent.hx",18)
	this->bytesLoaded = bytesLoaded;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/ProgressEvent.hx",19)
...
::nme::events::Event ProgressEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/ProgressEvent.hx",24)
...
::String ProgressEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/ProgressEvent.hx",30)
