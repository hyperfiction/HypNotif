...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/IOErrorEvent.hx",12)
...
::nme::events::Event IOErrorEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/IOErrorEvent.hx",18)
...
::String IOErrorEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/IOErrorEvent.hx",24)
