...
Void FocusEvent_obj::__construct(::String inType,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,::nme::display::InteractiveObject relatedObject,hx::Null< bool >  __o_shiftKey,hx::Null< int >  __o_keyCode,hx::Null< ::String >  __o_direction)
{
...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/FocusEvent.hx",23)
	super::__construct(inType,bubbles,cancelable);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/FocusEvent.hx",24)
	this->relatedObject = relatedObject;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/FocusEvent.hx",25)
	this->keyCode = keyCode;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/FocusEvent.hx",26)
...
hx::ObjectPtr< FocusEvent_obj > FocusEvent_obj::__new(::String inType,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,::nme::display::InteractiveObject relatedObject,hx::Null< bool >  __o_shiftKey,hx::Null< int >  __o_keyCode,hx::Null< ::String >  __o_direction)
...
::nme::events::Event FocusEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/FocusEvent.hx",31)
...
::String FocusEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/FocusEvent.hx",37)
