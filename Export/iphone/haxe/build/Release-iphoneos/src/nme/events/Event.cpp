...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",55)
	this->_type = type;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",56)
	this->_bubbles = bubbles;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",57)
	this->_cancelable = cancelable;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",58)
	this->nmeIsCancelled = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",59)
	this->nmeIsCancelledNow = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",60)
	this->_target = null();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",61)
	this->_currentTarget = null();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",62)
...
::nme::events::Event Event_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",67)
...
bool Event_obj::nmeGetIsCancelled( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",73)
...
bool Event_obj::nmeGetIsCancelledNow( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",79)
...
Void Event_obj::nmeSetPhase( int inPhase){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",85)
...
Void Event_obj::stopImmediatePropagation( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",92)
		if ((this->nmeGetCancelable())){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",94)
...
Void Event_obj::stopPropagation( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",99)
		if ((this->nmeGetCancelable())){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",101)
...
::String Event_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",106)
...
bool Event_obj::nmeGetBubbles( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",116)
...
bool Event_obj::nmeGetCancelable( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",117)
...
Dynamic Event_obj::nmeGetCurrentTarget( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",118)
...
Dynamic Event_obj::nmeSetCurrentTarget( Dynamic v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",119)
...
int Event_obj::nmeGetEventPhase( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",120)
...
Dynamic Event_obj::nmeGetTarget( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",121)
	return this->_target;
}
...
Dynamic Event_obj::nmeSetTarget( Dynamic v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",122)
	this->_target = v;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",122)
	return v;
}
...
::String Event_obj::nmeGetType( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/Event.hx",123)
	return this->_type;
}
