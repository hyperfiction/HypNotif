...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",19)
	this->nmeTarget = (  (((target == null()))) ? ::nme::events::IEventDispatcher(hx::ObjectPtr<OBJ_>(this)) : ::nme::events::IEventDispatcher(target) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",20)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",26)
		if (((this->nmeEventMap == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",27)
			this->nmeEventMap = ::Hash_obj::__new();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",28)
		Array< ::nme::utils::WeakRef > list = this->nmeEventMap->get(type);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",29)
		if (((list == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",31)
			list = Array_obj< ::nme::utils::WeakRef >::__new();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",32)
			this->nmeEventMap->set(type,list);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",35)
		::nme::events::Listener l = ::nme::events::Listener_obj::__new(listener,useCapture,priority);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",36)
...
Void EventDispatcher_obj::DispatchCompleteEvent( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",46)
		::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::COMPLETE,null(),null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",47)
...
bool EventDispatcher_obj::dispatchEvent( ::nme::events::Event event){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",53)
	if (((this->nmeEventMap == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",54)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",55)
	if (((event->nmeGetTarget() == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",56)
		event->nmeSetTarget(this->nmeTarget);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",58)
	if (((event->nmeGetCurrentTarget() == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",59)
		event->nmeSetCurrentTarget(this->nmeTarget);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",61)
	Array< ::nme::utils::WeakRef > list = this->nmeEventMap->get(event->nmeGetType());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",62)
	bool capture = (event->nmeGetEventPhase() == ::nme::events::EventPhase_obj::CAPTURING_PHASE);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",64)
	if (((list != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",66)
		int idx = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",67)
		while(((idx < list->length))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",69)
			::nme::utils::WeakRef list_item = list->__get(idx);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",70)
			::nme::events::Listener listener = (  (((list_item != null()))) ? ::nme::events::Listener(list_item->get()) : ::nme::events::Listener(null()) );
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",72)
			if (((listener == null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",73)
				list->splice(idx,(int)1);
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",79)
				if (((listener->mUseCapture == capture))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",81)
					listener->dispatchEvent(event);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",82)
					if ((event->nmeGetIsCancelledNow())){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",83)
						return true;
					}
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",85)
				(idx)++;
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",89)
		return true;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",92)
	return false;
}
...
Void EventDispatcher_obj::DispatchIOErrorEvent( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",102)
		::nme::events::IOErrorEvent evt = ::nme::events::IOErrorEvent_obj::__new(::nme::events::IOErrorEvent_obj::IO_ERROR,null(),null(),null(),null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",103)
		this->dispatchEvent(evt);
	}
return null();
}
...
bool EventDispatcher_obj::hasEventListener( ::String type){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",109)
	if (((this->nmeEventMap == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",110)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",111)
	Array< ::nme::utils::WeakRef > h = this->nmeEventMap->get(type);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",112)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",118)
		if (((this->nmeEventMap == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",119)
			return null();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",121)
		if ((!(this->nmeEventMap->exists(type)))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",121)
			return null();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",123)
		Array< ::nme::utils::WeakRef > list = this->nmeEventMap->get(type);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",124)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",124)
			int _g1 = (int)0;
			int _g = list->length;
			...
			while(((_g1 < _g))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",124)
				int i = (_g1)++;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",126)
				if (((list->__get(i) != null()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",128)
					::nme::events::Listener li = list->__get(i)->get();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",129)
					if ((li->Is(listener,capture))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",132)
						list[i] = null();
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",133)
						return null();
					}
				}
			}
...
::String EventDispatcher_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",141)
...
bool EventDispatcher_obj::willTrigger( ::String type){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",148)
	if (((this->nmeEventMap == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",149)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",150)
