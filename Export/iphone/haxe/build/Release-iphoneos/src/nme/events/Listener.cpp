...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",169)
	this->mListner = inListener;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",170)
	this->mUseCapture = inUseCapture;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",171)
	this->mPriority = inPriority;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",172)
...
Void Listener_obj::dispatchEvent( ::nme::events::Event event){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",177)
		this->mListner(event);
	}
return null();
}
...
bool Listener_obj::Is( Dynamic inListener,bool inCapture){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/EventDispatcher.hx",183)
