...
Void ErrorEvent_obj::__construct(::String type,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,hx::Null< ::String >  __o_text,hx::Null< int >  __o_id)
{
...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/ErrorEvent.hx",13)
	super::__construct(type,bubbles,cancelable,text);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/ErrorEvent.hx",14)
	this->errorID = id;
}
;
	return null();
...
hx::ObjectPtr< ErrorEvent_obj > ErrorEvent_obj::__new(::String type,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,hx::Null< ::String >  __o_text,hx::Null< int >  __o_id)
...
::nme::events::Event ErrorEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/ErrorEvent.hx",19)
...
::String ErrorEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/ErrorEvent.hx",25)
