...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/JoystickEvent.hx",22)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/JoystickEvent.hx",24)
	this->device = device;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/JoystickEvent.hx",25)
	this->id = id;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/JoystickEvent.hx",26)
	this->x = x;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/JoystickEvent.hx",27)
	this->y = y;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/JoystickEvent.hx",28)
	this->z = z;
}
;
	return null();
...
::nme::events::Event JoystickEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/JoystickEvent.hx",33)
...
::String JoystickEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/JoystickEvent.hx",39)
