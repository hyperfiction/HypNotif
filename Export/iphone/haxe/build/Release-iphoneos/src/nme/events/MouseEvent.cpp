...
Void MouseEvent_obj::__construct(::String type,hx::Null< bool >  __o_bubbles,hx::Null< bool >  __o_cancelable,hx::Null< double >  __o_localX,hx::Null< double >  __o_localY,::nme::display::InteractiveObject relatedObject,hx::Null< bool >  __o_ctrlKey,hx::Null< bool >  __o_altKey,hx::Null< bool >  __o_shiftKey,hx::Null< bool >  __o_buttonDown,hx::Null< int >  __o_delta,hx::Null< bool >  __o_commandKey,hx::Null< int >  __o_clickCount)
{
...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",51)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",52)
	this->localX = localX;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",53)
	this->localY = localY;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",54)
	this->relatedObject = relatedObject;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",55)
	this->ctrlKey = ctrlKey;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",56)
	this->altKey = altKey;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",57)
	this->shiftKey = shiftKey;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",58)
	this->buttonDown = buttonDown;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",59)
	this->delta = delta;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",60)
	this->commandKey = commandKey;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",61)
...
::nme::events::Event MouseEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",66)
...
::nme::events::MouseEvent MouseEvent_obj::nmeCreateSimilar( ::String inType,::nme::display::InteractiveObject related,::nme::display::InteractiveObject targ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",84)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",86)
	if (((targ != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",87)
		result->nmeSetTarget(targ);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",88)
	return result;
}
...
::String MouseEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",93)
...
::nme::events::MouseEvent MouseEvent_obj::nmeCreate( ::String inType,Dynamic inEvent,::nme::geom::Point inLocal,::nme::display::InteractiveObject inTarget){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",73)
	int flags = inEvent->__Field(HX_CSTRING("flags"),true);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",74)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",75)
	evt->stageX = inEvent->__Field(HX_CSTRING("x"),true);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",76)
	evt->stageY = inEvent->__Field(HX_CSTRING("y"),true);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",77)
	evt->nmeSetTarget(inTarget);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/MouseEvent.hx",78)
	return evt;
}
