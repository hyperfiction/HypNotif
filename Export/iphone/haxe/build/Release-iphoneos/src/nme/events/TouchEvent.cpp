...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/TouchEvent.hx",27)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/TouchEvent.hx",28)
	this->touchPointID = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/TouchEvent.hx",29)
...
::nme::events::MouseEvent TouchEvent_obj::nmeCreateSimilar( ::String inType,::nme::display::InteractiveObject related,::nme::display::InteractiveObject targ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/TouchEvent.hx",46)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/TouchEvent.hx",48)
	result->touchPointID = this->touchPointID;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/TouchEvent.hx",49)
	result->isPrimaryTouchPoint = this->isPrimaryTouchPoint;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/TouchEvent.hx",50)
	if (((targ != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/TouchEvent.hx",51)
		result->nmeSetTarget(targ);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/TouchEvent.hx",52)
	return result;
}
...
::nme::events::TouchEvent TouchEvent_obj::nmeCreate( ::String inType,Dynamic inEvent,::nme::geom::Point inLocal,::nme::display::InteractiveObject inTarget){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/TouchEvent.hx",35)
	int flags = inEvent->__Field(HX_CSTRING("flags"),true);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/TouchEvent.hx",36)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/TouchEvent.hx",37)
	evt->stageX = inEvent->__Field(HX_CSTRING("x"),true);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/TouchEvent.hx",38)
	evt->stageY = inEvent->__Field(HX_CSTRING("y"),true);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/TouchEvent.hx",39)
	evt->nmeSetTarget(inTarget);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/TouchEvent.hx",40)
	return evt;
}
