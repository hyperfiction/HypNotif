...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/HTTPStatusEvent.hx",14)
	super::__construct(inType,bubbles,cancelable);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/HTTPStatusEvent.hx",15)
	this->status = status;
}
;
	return null();
...
::nme::events::Event HTTPStatusEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/HTTPStatusEvent.hx",20)
	return ::nme::events::HTTPStatusEvent_obj::__new(this->nmeGetType(),this->nmeGetBubbles(),this->nmeGetCancelable(),this->status);
}


::String HTTPStatusEvent_obj::toString( ){
	HX_SOURCE_PUSH("HTTPStatusEvent_obj::toString")
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/events/HTTPStatusEvent.hx",26)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("nme.events.HTTPStatusEvent"), hx::TCanCast< HTTPStatusEvent_obj> ,sStaticFields,sMemberFields,
