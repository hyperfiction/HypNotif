...
Void Sound_obj::__construct(::nme::net::URLRequest stream,::nme::media::SoundLoaderContext context,hx::Null< bool >  __o_forcePlayAsMusic)
{
bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",30)
	super::__construct(null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",31)
	this->bytesLoaded = this->bytesTotal = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",32)
	this->nmeLoading = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",33)
	this->nmeDynamicSound = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",34)
	if (((stream != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",35)
...
hx::ObjectPtr< Sound_obj > Sound_obj::__new(::nme::net::URLRequest stream,::nme::media::SoundLoaderContext context,hx::Null< bool >  __o_forcePlayAsMusic)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",40)
		this->super::addEventListener(type,listener,useCapture,priority,useWeakReference);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",41)
		if (((type == ::nme::events::SampleDataEvent_obj::SAMPLE_DATA))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",43)
			if (((this->nmeHandle != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",44)
				hx::Throw (HX_CSTRING("Can't use dynamic sound once file loaded"));
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",45)
			this->nmeDynamicSound = true;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",46)
			this->nmeLoading = false;
		}
	}
return null();
...
Void Sound_obj::close( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",54)
		if (((this->nmeHandle != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",55)
			::nme::media::Sound_obj::nme_sound_close(this->nmeHandle);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",56)
		this->nmeHandle = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",57)
		this->nmeLoading = false;
	}
return null();
}
...
Void Sound_obj::load( ::nme::net::URLRequest stream,::nme::media::SoundLoaderContext context,hx::Null< bool >  __o_forcePlayAsMusic){
bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
	HX_SOURCE_PUSH("Sound_obj::load");
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",63)
		this->bytesLoaded = this->bytesTotal = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",64)
		this->nmeHandle = ::nme::media::Sound_obj::nme_sound_from_file(stream->url,forcePlayAsMusic);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",65)
		if (((this->nmeHandle == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",66)
			hx::Throw ((HX_CSTRING("Could not load:") + stream->url));
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",71)
			this->url = stream->url;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",72)
			this->nmeLoading = true;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",73)
			this->nmeLoading = false;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",74)
...
Void Sound_obj::nmeCheckLoading( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",80)
		if (((bool((bool(!(this->nmeDynamicSound)) && bool(this->nmeLoading))) && bool((this->nmeHandle != null()))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",83)
			Dynamic status = ::nme::media::Sound_obj::nme_sound_get_status(this->nmeHandle);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",84)
			if (((status == null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",85)
				hx::Throw (HX_CSTRING("Could not get sound status"));
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",86)
			this->bytesLoaded = status->__Field(HX_CSTRING("bytesLoaded"),true);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",87)
			this->bytesTotal = status->__Field(HX_CSTRING("bytesTotal"),true);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",88)
			this->nmeLoading = (this->bytesLoaded < this->bytesTotal);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",89)
			if (((status->__Field(HX_CSTRING("error"),true) != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",90)
...
Void Sound_obj::nmeOnError( ::String msg){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",99)
		this->dispatchEvent(::nme::events::IOErrorEvent_obj::__new(::nme::events::IOErrorEvent_obj::IO_ERROR,true,false,msg,null()));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",100)
		this->nmeHandle = null();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",101)
		this->nmeLoading = true;
	}
return null();
}
...
::nme::media::SoundChannel Sound_obj::play( hx::Null< double >  __o_startTime,hx::Null< int >  __o_loops,::nme::media::SoundTransform sndTransform){
double startTime = __o_startTime.Default(0);
int loops = __o_loops.Default(0);
	HX_SOURCE_PUSH("Sound_obj::play");
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",107)
		this->nmeCheckLoading();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",108)
		if ((this->nmeDynamicSound)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",110)
			::nme::events::SampleDataEvent request = ::nme::events::SampleDataEvent_obj::__new(::nme::events::SampleDataEvent_obj::SAMPLE_DATA,null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",111)
			this->dispatchEvent(request);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",112)
			if (((request->data->length > (int)0))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",113)
				this->nmeHandle = ::nme::media::Sound_obj::nme_sound_channel_create_dynamic(request->data,sndTransform);
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",116)
			if (((this->nmeHandle == null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",117)
				return null();
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",118)
			::nme::media::SoundChannel result = ::nme::media::SoundChannel_obj::createDynamic(this->nmeHandle,sndTransform,hx::ObjectPtr<OBJ_>(this));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",119)
			this->nmeHandle = null();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",120)
			return result;
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",124)
			if (((bool((this->nmeHandle == null())) || bool(this->nmeLoading)))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",125)
				return null();
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",127)
...
::nme::media::ID3Info Sound_obj::nmeGetID3( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",139)
	this->nmeCheckLoading();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",140)
	if (((bool((this->nmeHandle == null())) || bool(this->nmeLoading)))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",141)
		return null();
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",142)
	::nme::media::ID3Info id3 = ::nme::media::ID3Info_obj::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",143)
	::nme::media::Sound_obj::nme_sound_get_id3(this->nmeHandle,id3);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",144)
	return id3;
}
...
bool Sound_obj::nmeGetIsBuffering( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",150)
	this->nmeCheckLoading();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",151)
...
double Sound_obj::nmeGetLength( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",157)
	if (((bool((this->nmeHandle == null())) || bool(this->nmeLoading)))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",158)
		return (int)0;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/Sound.hx",159)
...
void Sound_obj::__boot()
{
	...
	hx::Static(nme_sound_channel_create_dynamic) = ::nme::Loader_obj::load(HX_CSTRING("nme_sound_channel_create_dynamic"),(int)2);
}
