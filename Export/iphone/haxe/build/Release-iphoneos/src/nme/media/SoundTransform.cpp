...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundTransform.hx",14)
	this->volume = vol;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundTransform.hx",15)
	this->pan = panning;
}
;
	return null();
...
::nme::media::SoundTransform SoundTransform_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundTransform.hx",20)
