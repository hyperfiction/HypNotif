...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",30)
	super::__construct(null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",32)
	if (((sndTransform != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",33)
		this->nmeTransform = sndTransform->clone();
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",37)
	if (((inSoundHandle != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",38)
		this->nmeHandle = ::nme::media::SoundChannel_obj::nme_sound_channel_create(inSoundHandle,startTime,loops,this->nmeTransform);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",40)
	if (((this->nmeHandle != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",41)
...
bool SoundChannel_obj::nmeCheckComplete( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",59)
	if (((this->nmeHandle != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",61)
		if (((bool((this->nmeDataProvider != null())) && bool(::nme::media::SoundChannel_obj::nme_sound_channel_needs_data(this->nmeHandle))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",63)
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",64)
			request->position = ::nme::media::SoundChannel_obj::nme_sound_channel_get_data_position(this->nmeHandle);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",65)
			this->nmeDataProvider->dispatchEvent(request);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",66)
			if (((request->data->length > (int)0))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",67)
				::nme::media::SoundChannel_obj::nme_sound_channel_add_data(this->nmeHandle,request->data);
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",70)
		if ((::nme::media::SoundChannel_obj::nme_sound_channel_is_complete(this->nmeHandle))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",72)
			this->nmeHandle = null();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",73)
			if (((this->nmeDataProvider != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",74)
				(::nme::media::SoundChannel_obj::nmeDynamicSoundCount)--;
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",75)
			::nme::events::Event complete = ::nme::events::Event_obj::__new(::nme::events::Event_obj::SOUND_COMPLETE,null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",76)
			this->dispatchEvent(complete);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",77)
			return true;
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",81)
	return false;
}
...
Void SoundChannel_obj::stop( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",111)
...
double SoundChannel_obj::nmeGetLeft( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",121)
...
double SoundChannel_obj::nmeGetRight( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",122)
...
double SoundChannel_obj::nmeGetPosition( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",123)
...
::nme::media::SoundTransform SoundChannel_obj::nmeGetTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",128)
	if (((this->nmeTransform == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",129)
		this->nmeTransform = ::nme::media::SoundTransform_obj::__new(null(),null());
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",133)
...
::nme::media::SoundTransform SoundChannel_obj::nmeSetTransform( ::nme::media::SoundTransform inTransform){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",139)
	this->nmeTransform = inTransform->clone();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",140)
	::nme::media::SoundChannel_obj::nme_sound_channel_set_transform(this->nmeHandle,this->nmeTransform);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",142)
	return inTransform;
}
...
::nme::media::SoundChannel SoundChannel_obj::createDynamic( Dynamic inSoundHandle,::nme::media::SoundTransform sndTransform,::nme::events::EventDispatcher dataProvider){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",46)
	::nme::media::SoundChannel result = ::nme::media::SoundChannel_obj::__new(null(),(int)0,(int)0,sndTransform);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",47)
	result->nmeDataProvider = dataProvider;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",48)
	result->nmeHandle = inSoundHandle;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",49)
	::nme::media::SoundChannel_obj::nmeIncompleteList->push(result);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",50)
	(::nme::media::SoundChannel_obj::nmeDynamicSoundCount)++;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",51)
	return result;
}
...
bool SoundChannel_obj::nmeCompletePending( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",86)
...
Void SoundChannel_obj::nmePollComplete( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",92)
		if (((::nme::media::SoundChannel_obj::nmeIncompleteList->length > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",95)
			Array< ::nme::media::SoundChannel > incomplete = Array_obj< ::nme::media::SoundChannel >::__new();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",97)
			{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",97)
				int _g = (int)0;
				...
				while(((_g < _g1->length))){
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",97)
					++(_g);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",99)
					if ((!(channel->nmeCheckComplete()))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",100)
						incomplete->push(channel);
					}
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/media/SoundChannel.hx",105)
...
Dynamic SoundChannel_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 12:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"soundTransform") ) { if (inCallProp) return nmeSetTransform(inValue);soundTransform=inValue.Cast< ::nme::media::SoundTransform >(); return inValue; }
		break;
	case 15:
...
void SoundChannel_obj::__boot()
{
	...
	hx::Static(nme_sound_channel_get_data_position) = ::nme::Loader_obj::load(HX_CSTRING("nme_sound_channel_get_data_position"),(int)1);
	...
	hx::Static(nme_sound_channel_needs_data) = ::nme::Loader_obj::load(HX_CSTRING("nme_sound_channel_needs_data"),(int)1);
	hx::Static(nme_sound_channel_add_data) = ::nme::Loader_obj::load(HX_CSTRING("nme_sound_channel_add_data"),(int)2);
}
