...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",66)
	int fill_col;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",67)
	int fill_alpha;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",69)
	if (((inFillRGBA == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",71)
		fill_col = (int)16777215;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",72)
		fill_alpha = (int)255;
	}
	else{
		struct _Function_2_1{
			inline static int Block( Dynamic &inFillRGBA){
				{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",76)
					int v = inFillRGBA;
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",76)
		...
		struct _Function_2_2{
			inline static int Block( Dynamic &inFillRGBA){
				{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",77)
					int v = inFillRGBA;
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",77)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",80)
	if (((bool((inWidth < (int)1)) || bool((inHeight < (int)1))))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",81)
		this->nmeHandle = null();
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",86)
		int flags = ::nme::display::BitmapData_obj::HARDWARE;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",88)
		if ((inTransparent)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",89)
			hx::OrEq(flags,::nme::display::BitmapData_obj::TRANSPARENT);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",91)
...
Void BitmapData_obj::applyFilter( ::nme::display::BitmapData sourceBitmapData,::nme::geom::Rectangle sourceRect,::nme::geom::Point destPoint,::nme::filters::BitmapFilter filter){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",105)
...
Void BitmapData_obj::clear( int color){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",115)
...
::nme::display::BitmapData BitmapData_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",126)
	::nme::display::BitmapData bm = ::nme::display::BitmapData_obj::__new((int)0,(int)0,null(),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",127)
	bm->nmeHandle = ::nme::display::BitmapData_obj::nme_bitmap_data_clone(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",128)
	return bm;
}
...
Void BitmapData_obj::colorTransform( ::nme::geom::Rectangle rect,::nme::geom::ColorTransform colorTransform){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",138)
...
Void BitmapData_obj::copyChannel( ::nme::display::BitmapData sourceBitmapData,::nme::geom::Rectangle sourceRect,::nme::geom::Point destPoint,int inSourceChannel,int inDestChannel){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",152)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",167)
...
Void BitmapData_obj::createHardwareSurface( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",184)
...
Void BitmapData_obj::destroyHardwareSurface( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",190)
...
Void BitmapData_obj::dispose( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",197)
		this->nmeHandle = null();
	}
return null();
}
...
Void BitmapData_obj::draw( ::nme::display::IBitmapDrawable source,::nme::geom::Matrix matrix,::nme::geom::ColorTransform colorTransform,::String blendMode,::nme::geom::Rectangle clipRect,hx::Null< bool >  __o_smoothing){
bool smoothing = __o_smoothing.Default(false);
	HX_SOURCE_PUSH("BitmapData_obj::draw");
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",203)
...
Void BitmapData_obj::dumpBits( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",209)
...
::nme::utils::ByteArray BitmapData_obj::encode( ::String inFormat,hx::Null< double >  __o_inQuality){
double inQuality = __o_inQuality.Default(0.9);
	HX_SOURCE_PUSH("BitmapData_obj::encode");
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",215)
...
Void BitmapData_obj::fillRect( ::nme::geom::Rectangle rect,int inColour){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",242)
		int a = hx::UShr(inColour,(int)24);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",243)
		int c = (int(inColour) & int((int)16777215));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",244)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",249)
...
::nme::geom::Rectangle BitmapData_obj::generateFilterRect( ::nme::geom::Rectangle sourceRect,::nme::filters::BitmapFilter filter){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",256)
	::nme::geom::Rectangle result = ::nme::geom::Rectangle_obj::__new(null(),null(),null(),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",257)
	::nme::display::BitmapData_obj::nme_bitmap_data_generate_filter_rect(sourceRect,filter,result);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",258)
	return result;
}
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",264)
		::nme::geom::Rectangle result = ::nme::geom::Rectangle_obj::__new(null(),null(),null(),null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",265)
		::nme::display::BitmapData_obj::nme_bitmap_data_get_color_bounds_rect(this->nmeHandle,mask,color,findColor,result);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",266)
		return result;
	}
}
...
int BitmapData_obj::getPixel( int x,int y){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",271)
...
int BitmapData_obj::getPixel32( int x,int y){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",277)
...
::nme::utils::ByteArray BitmapData_obj::getPixels( ::nme::geom::Rectangle rect){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",288)
	::nme::utils::ByteArray result = ::nme::display::BitmapData_obj::nme_bitmap_data_get_pixels(this->nmeHandle,rect);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",290)
	if (((result != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",291)
		result->position = result->length;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",293)
	return result;
}
...
Array< int > BitmapData_obj::getVector( ::nme::geom::Rectangle rect){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",299)
	int pixels = ::Std_obj::_int((rect->width * rect->height));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",301)
	if (((pixels < (int)1))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",302)
		return Array_obj< int >::__new();
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",304)
	Array< int > result = Array_obj< int >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",305)
	result[(pixels - (int)1)] = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",308)
	::nme::display::BitmapData_obj::nme_bitmap_data_get_array(this->nmeHandle,rect,result);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",316)
	return result;
}
...
Void BitmapData_obj::nmeDrawToSurface( Dynamic inSurface,::nme::geom::Matrix matrix,::nme::geom::ColorTransform colorTransform,::String blendMode,::nme::geom::Rectangle clipRect,bool smoothing){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",371)
...
Void BitmapData_obj::scroll( int inDX,int inDY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",378)
...
Void BitmapData_obj::setFlags( int inFlags){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",384)
...
Void BitmapData_obj::setPixel( int inX,int inY,int inColour){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",391)
...
Void BitmapData_obj::setPixel32( int inX,int inY,int inColour){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",397)
...
Void BitmapData_obj::setPixels( ::nme::geom::Rectangle rect,::nme::utils::ByteArray pixels){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",408)
		int size = ::Std_obj::_int(((rect->width * rect->height) * (int)4));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",409)
		pixels->checkData(::Std_obj::_int(size));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",410)
		::nme::display::BitmapData_obj::nme_bitmap_data_set_bytes(this->nmeHandle,rect,pixels,pixels->position);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",411)
...
Void BitmapData_obj::setVector( ::nme::geom::Rectangle rect,Array< int > inPixels){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",417)
		int count = ::Std_obj::_int((rect->width * rect->height));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",418)
		if (((inPixels->length < count))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",419)
			return null();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",422)
...
Void BitmapData_obj::setFormat( int format){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",438)
...
::nme::geom::Rectangle BitmapData_obj::nmeGetRect( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",446)
...
int BitmapData_obj::nmeGetWidth( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",447)
...
int BitmapData_obj::nmeGetHeight( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",448)
...
bool BitmapData_obj::nmeGetTransparent( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",449)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",173)
...
int BitmapData_obj::extractAlpha( int v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",221)
	return hx::UShr(v,(int)24);
}
...
int BitmapData_obj::extractColor( int v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",231)
	return (int(v) & int((int)16777215));
}
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",328)
		::nme::display::BitmapData result = ::nme::display::BitmapData_obj::__new((int)0,(int)0,null(),null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",329)
		result->nmeHandle = ::nme::display::BitmapData_obj::nme_bitmap_data_load(inFilename,format);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",330)
		return result;
	}
}
...
::nme::display::BitmapData BitmapData_obj::loadFromBytes( ::nme::utils::ByteArray inBytes,::nme::utils::ByteArray inRawAlpha){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",344)
	::nme::display::BitmapData result = ::nme::display::BitmapData_obj::__new((int)0,(int)0,null(),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",345)
	result->nmeHandle = ::nme::display::BitmapData_obj::nme_bitmap_data_from_bytes(inBytes,inRawAlpha);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",346)
	return result;
}
...
::nme::display::BitmapData BitmapData_obj::loadFromHaxeBytes( ::haxe::io::Bytes inBytes,::haxe::io::Bytes inRawAlpha){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/BitmapData.hx",359)
