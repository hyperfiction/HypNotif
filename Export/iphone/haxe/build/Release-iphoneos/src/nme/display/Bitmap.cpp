...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",35)
	super::__construct(::nme::display::DisplayObject_obj::nme_create_display_object(),HX_CSTRING("Bitmap"));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",37)
	this->pixelSnapping = inPixelSnapping;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",38)
	this->nmeSetSmoothing(inSmoothing);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",40)
...
Void Bitmap_obj::nmeRebuid( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",46)
		::nme::display::Graphics gfx = this->nmeGetGraphics();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",47)
		gfx->clear();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",49)
		if (((this->bitmapData != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",51)
			gfx->beginBitmapFill(this->bitmapData,null(),false,this->smoothing);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",52)
			gfx->drawRect((int)0,(int)0,this->bitmapData->nmeGetWidth(),this->bitmapData->nmeGetHeight());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",53)
			gfx->endFill();
		}
	}
return null();
...
::nme::display::BitmapData Bitmap_obj::nmeSetBitmapData( ::nme::display::BitmapData inBitmapData){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",65)
	this->bitmapData = inBitmapData;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",66)
	this->nmeRebuid();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",68)
	return inBitmapData;
}
...
bool Bitmap_obj::nmeSetSmoothing( bool inSmooth){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",74)
	this->smoothing = inSmooth;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",75)
	this->nmeRebuid();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Bitmap.hx",77)
	return inSmooth;
}
...
Dynamic Bitmap_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"bitmapData") ) { if (inCallProp) return nmeSetBitmapData(inValue);bitmapData=inValue.Cast< ::nme::display::BitmapData >(); return inValue; }
		break;
	case 13:
