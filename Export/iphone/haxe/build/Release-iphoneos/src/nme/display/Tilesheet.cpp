...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Tilesheet.hx",46)
	this->nmeBitmap = inImage;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Tilesheet.hx",50)
...
Void Tilesheet_obj::addTileRect( ::nme::geom::Rectangle rectangle,::nme::geom::Point centerPoint){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Tilesheet.hx",70)
...
Void Tilesheet_obj::drawTiles( ::nme::display::Graphics graphics,Array< double > tileData,hx::Null< bool >  __o_smooth,hx::Null< int >  __o_flags){
bool smooth = __o_smooth.Default(false);
int flags = __o_flags.Default(0);
	HX_SOURCE_PUSH("Tilesheet_obj::drawTiles");
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Tilesheet.hx",168)
