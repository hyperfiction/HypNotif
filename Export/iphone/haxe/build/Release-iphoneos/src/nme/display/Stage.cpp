...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",86)
	super::__construct(inHandle,HX_CSTRING("Stage"));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",87)
	this->nmeMouseOverObjects = Array_obj< ::nme::display::InteractiveObject >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",88)
	this->nmeFocusOverObjects = Array_obj< ::nme::display::InteractiveObject >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",89)
	this->active = true;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",90)
	this->pauseWhenDeactivated = true;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",95)
	this->renderRequest = null();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",98)
	::nme::display::Stage_obj::nme_set_stage_handler(this->nmeHandle,this->nmeProcessStageEvent_dyn(),inWidth,inHeight);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",99)
	this->nmeInvalid = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",100)
	this->nmeLastRender = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",101)
	this->nmeLastDown = Array_obj< ::nme::display::InteractiveObject >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",102)
	this->nmeLastClickTime = 0.0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",103)
	this->nmeSetFrameRate((int)100);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",104)
	this->nmeTouchInfo = ::IntHash_obj::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",105)
...
Void Stage_obj::invalidate( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",121)
...
Void Stage_obj::nmeCheckFocusInOuts( Dynamic inEvent,Array< ::nme::display::InteractiveObject > inStack){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",129)
		int new_n = inStack->length;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",130)
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",131)
		int old_n = this->nmeFocusOverObjects->length;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",132)
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",134)
		if (((new_obj != old_obj))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",137)
			int common = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",138)
			while(((bool((bool((common < new_n)) && bool((common < old_n)))) && bool((inStack->__get(common) == this->nmeFocusOverObjects->__get(common)))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",139)
				(common)++;
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",141)
			::nme::events::FocusEvent focusOut = ::nme::events::FocusEvent_obj::__new(::nme::events::FocusEvent_obj::FOCUS_OUT,false,false,new_obj,(inEvent->__Field(HX_CSTRING("flags"),true) > (int)0),inEvent->__Field(HX_CSTRING("code"),true),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",143)
			int i = (old_n - (int)1);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",144)
			while(((i >= common))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",146)
				this->nmeFocusOverObjects->__get(i)->nmeDispatchEvent(focusOut);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",147)
				(i)--;
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",150)
			::nme::events::FocusEvent focusIn = ::nme::events::FocusEvent_obj::__new(::nme::events::FocusEvent_obj::FOCUS_IN,false,false,old_obj,(inEvent->__Field(HX_CSTRING("flags"),true) > (int)0),inEvent->__Field(HX_CSTRING("code"),true),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",151)
			int i1 = (new_n - (int)1);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",153)
			while(((i1 >= common))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",155)
				inStack->__get(i1)->nmeDispatchEvent(focusIn);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",156)
				(i1)--;
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",159)
...
bool Stage_obj::nmeCheckInOuts( ::nme::events::MouseEvent inEvent,Array< ::nme::display::InteractiveObject > inStack,::nme::display::TouchInfo touchInfo){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",166)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",167)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",169)
	int new_n = inStack->length;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",170)
	::nme::display::InteractiveObject new_obj = (  (((new_n > (int)0))) ? ::nme::display::InteractiveObject(inStack->__get((new_n - (int)1))) : ::nme::display::InteractiveObject(null()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",171)
	int old_n = prev->length;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",172)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",174)
	if (((new_obj != old_obj))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",177)
		if (((old_obj != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",178)
			old_obj->nmeFireEvent(inEvent->nmeCreateSimilar(events->__get((int)0),new_obj,old_obj));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",180)
		if (((new_obj != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",181)
			new_obj->nmeFireEvent(inEvent->nmeCreateSimilar(events->__get((int)1),old_obj,null()));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",184)
		int common = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",185)
		while(((bool((bool((common < new_n)) && bool((common < old_n)))) && bool((inStack->__get(common) == prev->__get(common)))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",186)
			(common)++;
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",188)
		::nme::events::MouseEvent rollOut = inEvent->nmeCreateSimilar(events->__get((int)2),new_obj,old_obj);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",189)
		int i = (old_n - (int)1);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",190)
		while(((i >= common))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",192)
			prev->__get(i)->nmeDispatchEvent(rollOut);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",193)
			(i)--;
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",196)
		::nme::events::MouseEvent rollOver = inEvent->nmeCreateSimilar(events->__get((int)3),old_obj,null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",197)
		int i1 = (new_n - (int)1);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",198)
		while(((i1 >= common))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",200)
			inStack->__get(i1)->nmeDispatchEvent(rollOver);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",201)
			(i1)--;
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",204)
		if (((touchInfo == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",205)
			this->nmeMouseOverObjects = inStack;
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",207)
			touchInfo->touchOverObjects = inStack;
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",209)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",212)
	return true;
}
...
Void Stage_obj::nmeCheckRender( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",217)
		if (((this->frameRate > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",221)
			double now = ::haxe::Timer_obj::stamp();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",222)
			if (((now >= (this->nmeLastRender + this->nmeFramePeriod)))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",224)
				this->nmeLastRender = now;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",225)
				if (((this->renderRequest_dyn() != null()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",226)
					this->renderRequest();
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",228)
					this->nmeRender(true);
				}
			}
		}
...
double Stage_obj::nmeDoProcessStageEvent( Dynamic inEvent){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",236)
	double result = 0.0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",238)
	int type = ::Std_obj::_int(::Reflect_obj::field(inEvent,HX_CSTRING("type")));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",240)
	switch( (int)(type)){
		case (int)2: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",242)
			if (((this->onKey_dyn() != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",244)
		...
		;break;
		case (int)1: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",246)
			this->nmeOnKey(inEvent,::nme::events::KeyboardEvent_obj::KEY_DOWN);
		}
		;break;
		case (int)3: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",249)
			this->nmeOnKey(inEvent,::nme::events::KeyboardEvent_obj::KEY_UP);
		}
		;break;
		case (int)4: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",252)
			this->nmeOnMouse(inEvent,::nme::events::MouseEvent_obj::MOUSE_MOVE,true);
		}
		;break;
		case (int)5: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",255)
			this->nmeOnMouse(inEvent,::nme::events::MouseEvent_obj::MOUSE_DOWN,true);
		}
		;break;
		case (int)6: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",258)
			this->nmeOnMouse(inEvent,::nme::events::MouseEvent_obj::CLICK,true);
		}
		;break;
		case (int)7: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",261)
			this->nmeOnMouse(inEvent,::nme::events::MouseEvent_obj::MOUSE_UP,true);
		}
		;break;
		case (int)8: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",265)
			this->nmeOnResize(inEvent->__Field(HX_CSTRING("x"),true),inEvent->__Field(HX_CSTRING("y"),true));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",266)
			if (((this->renderRequest_dyn() == null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",267)
				this->nmeRender(false);
			}
		}
		;break;
		case (int)9: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",269)
			this->nmePollTimers();
		}
		;break;
		case (int)10: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",272)
			if (((this->onQuit_dyn() != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",274)
				this->onQuit();
			}
		}
		;break;
		case (int)11: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",276)
			this->nmeOnFocus(inEvent);
		}
		;break;
		case (int)12: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",279)
			if ((::nme::display::Stage_obj::shouldRotateInterface(inEvent->__Field(HX_CSTRING("value"),true)))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",281)
				inEvent->__FieldRef(HX_CSTRING("result")) = (int)2;
			}
		}
		;break;
		case (int)14: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",283)
			this->nmeRender(true);
		}
		;break;
		case (int)15: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",287)
			::nme::display::TouchInfo touchInfo = ::nme::display::TouchInfo_obj::__new();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",288)
			this->nmeTouchInfo->set(inEvent->__Field(HX_CSTRING("value"),true),touchInfo);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",289)
			this->nmeOnTouch(inEvent,::nme::events::TouchEvent_obj::TOUCH_BEGIN,touchInfo);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",291)
			if (((((int(inEvent->__Field(HX_CSTRING("flags"),true)) & int((int)32768))) > (int)0))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",292)
				this->nmeOnMouse(inEvent,::nme::events::MouseEvent_obj::MOUSE_DOWN,false);
			}
		}
		;break;
		case (int)16: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",295)
			::nme::display::TouchInfo touchInfo = this->nmeTouchInfo->get(inEvent->__Field(HX_CSTRING("value"),true));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",296)
			this->nmeOnTouch(inEvent,::nme::events::TouchEvent_obj::TOUCH_MOVE,touchInfo);
		}
		;break;
		case (int)17: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",299)
			::nme::display::TouchInfo touchInfo = this->nmeTouchInfo->get(inEvent->__Field(HX_CSTRING("value"),true));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",300)
			this->nmeOnTouch(inEvent,::nme::events::TouchEvent_obj::TOUCH_END,touchInfo);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",301)
			this->nmeTouchInfo->remove(inEvent->__Field(HX_CSTRING("value"),true));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",303)
			if (((((int(inEvent->__Field(HX_CSTRING("flags"),true)) & int((int)32768))) > (int)0))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",304)
		...
		;break;
		case (int)19: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",309)
			this->nmeOnChange(inEvent);
		}
		;break;
		case (int)20: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",312)
			this->nmeSetActive(true);
		}
		;break;
		case (int)21: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",315)
			this->nmeSetActive(false);
		}
		;break;
		case (int)22: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",319)
			::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::GOT_INPUT_FOCUS,null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",320)
			this->nmeBroadcast(evt);
		}
		;break;
		case (int)23: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",323)
			::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::LOST_INPUT_FOCUS,null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",324)
			this->nmeBroadcast(evt);
		}
		;break;
		case (int)24: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",326)
			this->nmeOnJoystick(inEvent,::nme::events::JoystickEvent_obj::AXIS_MOVE);
		}
		;break;
		case (int)25: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",329)
			this->nmeOnJoystick(inEvent,::nme::events::JoystickEvent_obj::BALL_MOVE);
		}
		;break;
		case (int)26: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",332)
			this->nmeOnJoystick(inEvent,::nme::events::JoystickEvent_obj::HAT_MOVE);
		}
		;break;
		case (int)27: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",335)
			this->nmeOnJoystick(inEvent,::nme::events::JoystickEvent_obj::BUTTON_DOWN);
		}
		;break;
		case (int)28: {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",338)
			this->nmeOnJoystick(inEvent,::nme::events::JoystickEvent_obj::BUTTON_UP);
		}
		;break;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",344)
	result = this->nmeUpdateNextWake();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",347)
	return result;
}
...
Void Stage_obj::dummyTrace( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",350)
		::haxe::Log_obj::trace(HX_CSTRING(""),hx::SourceInfo(HX_CSTRING("Stage.hx"),350,HX_CSTRING("nme.display.Stage"),HX_CSTRING("dummyTrace")));
	}
return null();
}
...
Dynamic Stage_obj::nmeProcessStageEvent( Dynamic inEvent){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",358)
	this->nmeDoProcessStageEvent(inEvent);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",359)
	return null();
}
...
Void Stage_obj::nmeDrag( ::nme::geom::Point inMouse){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",365)
		::nme::display::DisplayObjectContainer p = this->nmeDragObject->nmeGetParent();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",366)
		if (((p != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",367)
			inMouse = p->globalToLocal(inMouse);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",369)
		double x = (inMouse->x + this->nmeDragOffsetX);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",370)
		double y = (inMouse->y + this->nmeDragOffsetY);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",372)
		if (((this->nmeDragBounds != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",374)
			if (((x < this->nmeDragBounds->x))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",374)
				x = this->nmeDragBounds->x;
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",375)
				if (((x > this->nmeDragBounds->nmeGetRight()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",375)
					x = this->nmeDragBounds->nmeGetRight();
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",377)
			if (((y < this->nmeDragBounds->y))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",377)
				y = this->nmeDragBounds->y;
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",378)
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",381)
		this->nmeDragObject->nmeSetX(x);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",382)
...
::nme::display::Stage Stage_obj::nmeGetStage( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",387)
...
double Stage_obj::nmeNextFrameDue( double inOtherTimers){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",394)
	if (((bool(!(this->active)) && bool(this->pauseWhenDeactivated)))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",395)
		return inOtherTimers;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",396)
	if (((this->frameRate > (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",398)
		double next = (((this->nmeLastRender + this->nmeFramePeriod) - ::haxe::Timer_obj::stamp()) - ::nme::display::Stage_obj::nmeEarlyWakeup);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",399)
		if (((next < inOtherTimers))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",400)
			return next;
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",402)
	return inOtherTimers;
}
...
Void Stage_obj::nmeOnChange( Dynamic inEvent){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",408)
		::nme::display::DisplayObject obj = this->nmeFindByID(inEvent->__Field(HX_CSTRING("id"),true));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",409)
		if (((obj != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",410)
...
Void Stage_obj::nmeOnFocus( Dynamic inEvent){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",416)
		Array< ::nme::display::InteractiveObject > stack = Array_obj< ::nme::display::InteractiveObject >::__new();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",417)
		::nme::display::DisplayObject obj = this->nmeFindByID(inEvent->__Field(HX_CSTRING("id"),true));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",418)
		if (((obj != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",419)
			obj->nmeGetInteractiveObjectStack(stack);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",420)
		if (((bool((stack->length > (int)0)) && bool(((bool((inEvent->__Field(HX_CSTRING("value"),true) == (int)1)) || bool((inEvent->__Field(HX_CSTRING("value"),true) == (int)2)))))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",422)
			::nme::display::InteractiveObject obj1 = stack->__get((int)0);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",423)
			::nme::events::FocusEvent evt = ::nme::events::FocusEvent_obj::__new((  (((inEvent->__Field(HX_CSTRING("value"),true) == (int)1))) ? ::String(::nme::events::FocusEvent_obj::MOUSE_FOCUS_CHANGE) : ::String(::nme::events::FocusEvent_obj::KEY_FOCUS_CHANGE) ),true,true,(  (((this->nmeFocusOverObjects->length == (int)0))) ? ::nme::display::InteractiveObject(null()) : ::nme::display::InteractiveObject(this->nmeFocusOverObjects->__get((int)0)) ),(inEvent->__Field(HX_CSTRING("flags"),true) > (int)0),inEvent->__Field(HX_CSTRING("code"),true),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",424)
			obj1->nmeFireEvent(evt);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",425)
			if ((evt->nmeGetIsCancelled())){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",427)
				inEvent->__FieldRef(HX_CSTRING("result")) = (int)1;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",428)
				return null();
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",432)
		stack->reverse();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",434)
...
Void Stage_obj::nmeOnJoystick( Dynamic inEvent,::String inType){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",440)
		::nme::events::JoystickEvent evt = null();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",441)
		::String _switch_1 = (inType);
		if (  ( _switch_1==::nme::events::JoystickEvent_obj::AXIS_MOVE)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",444)
			Dynamic data = this->nmeJoyAxisData->get(inEvent->__Field(HX_CSTRING("id"),true));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",445)
			if (((data == null()))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",446)
				data = _Function_3_1::Block();
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",450)
			double value = (double(inEvent->__Field(HX_CSTRING("value"),true)) / double((int)32767));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",451)
			if (((value < (int)-1))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",451)
				value = (int)-1;
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",453)
			switch( (int)(inEvent->__Field(HX_CSTRING("code"),true))){
				case (int)0: {
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",455)
					data->__FieldRef(HX_CSTRING("x")) = value;
				}
				;break;
				case (int)1: {
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",456)
					data->__FieldRef(HX_CSTRING("y")) = value;
				}
				;break;
				case (int)2: {
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",457)
					data->__FieldRef(HX_CSTRING("z")) = value;
				}
				;break;
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",460)
			evt = ::nme::events::JoystickEvent_obj::__new(inType,false,false,inEvent->__Field(HX_CSTRING("id"),true),(int)0,data->__Field(HX_CSTRING("x"),true),data->__Field(HX_CSTRING("y"),true),data->__Field(HX_CSTRING("z"),true));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",462)
			this->nmeJoyAxisData->set(inEvent->__Field(HX_CSTRING("id"),true),data);
		}
		else if (  ( _switch_1==::nme::events::JoystickEvent_obj::BALL_MOVE)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",464)
			evt = ::nme::events::JoystickEvent_obj::__new(inType,false,false,inEvent->__Field(HX_CSTRING("id"),true),inEvent->__Field(HX_CSTRING("code"),true),inEvent->__Field(HX_CSTRING("x"),true),inEvent->__Field(HX_CSTRING("y"),true),null());
		}
		else if (  ( _switch_1==::nme::events::JoystickEvent_obj::HAT_MOVE)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",468)
			int x = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",469)
			int y = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",471)
			if (((((int(inEvent->__Field(HX_CSTRING("value"),true)) & int((int)1))) != (int)0))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",472)
				y = (int)-1;
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",475)
				if (((((int(inEvent->__Field(HX_CSTRING("value"),true)) & int((int)4))) != (int)0))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",476)
					y = (int)1;
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",480)
			if (((((int(inEvent->__Field(HX_CSTRING("value"),true)) & int((int)2))) != (int)0))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",481)
				x = (int)1;
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",484)
				if (((((int(inEvent->__Field(HX_CSTRING("value"),true)) & int((int)8))) != (int)0))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",485)
					x = (int)-1;
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",489)
			evt = ::nme::events::JoystickEvent_obj::__new(inType,false,false,inEvent->__Field(HX_CSTRING("id"),true),inEvent->__Field(HX_CSTRING("code"),true),x,y,null());
		}
		else  {
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",491)
			evt = ::nme::events::JoystickEvent_obj::__new(inType,false,false,inEvent->__Field(HX_CSTRING("id"),true),inEvent->__Field(HX_CSTRING("code"),true),null(),null(),null());
		}
;
;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",494)
...
Void Stage_obj::nmeOnKey( Dynamic inEvent,::String inType){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",500)
		Array< ::nme::display::InteractiveObject > stack = Array_obj< ::nme::display::InteractiveObject >::__new();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",501)
		::nme::display::DisplayObject obj = this->nmeFindByID(inEvent->__Field(HX_CSTRING("id"),true));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",502)
		if (((obj != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",503)
			obj->nmeGetInteractiveObjectStack(stack);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",504)
		if (((stack->length > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",506)
			::nme::display::InteractiveObject obj1 = stack->__get((int)0);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",507)
			int flags = inEvent->__Field(HX_CSTRING("flags"),true);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",508)
			::nme::events::KeyboardEvent evt = ::nme::events::KeyboardEvent_obj::__new(inType,true,true,inEvent->__Field(HX_CSTRING("code"),true),inEvent->__Field(HX_CSTRING("value"),true),(  (((((int(flags) & int(::nme::display::Stage_obj::efLocationRight))) == (int)0))) ? int((int)1) : int((int)0) ),(((int(flags) & int(::nme::display::Stage_obj::efCtrlDown))) != (int)0),(((int(flags) & int(::nme::display::Stage_obj::efAltDown))) != (int)0),(((int(flags) & int(::nme::display::Stage_obj::efShiftDown))) != (int)0),null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",509)
			obj1->nmeFireEvent(evt);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",510)
			if ((evt->nmeGetIsCancelled())){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",511)
				inEvent->__FieldRef(HX_CSTRING("result")) = (int)1;
			}
		}
	}
...
Void Stage_obj::nmeOnMouse( Dynamic inEvent,::String inType,bool inFromMouse){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",518)
		::String type = inType;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",519)
		int button = inEvent->__Field(HX_CSTRING("value"),true);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",520)
		if ((!(inFromMouse))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",521)
			button = (int)0;
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",522)
		int wheel = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",523)
		if (((inType == ::nme::events::MouseEvent_obj::MOUSE_DOWN))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",525)
			if (((button > (int)2))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",526)
				return null();
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",527)
			type = ::nme::display::Stage_obj::sDownEvents->__get(button);
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",529)
			if (((inType == ::nme::events::MouseEvent_obj::MOUSE_UP))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",530)
				if (((button > (int)2))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",533)
					type = ::nme::events::MouseEvent_obj::MOUSE_WHEEL;
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",534)
					wheel = (  (((button == (int)3))) ? int((int)1) : int((int)-1) );
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",538)
					type = ::nme::display::Stage_obj::sUpEvents->__get(button);
				}
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",541)
		if (((this->nmeDragObject != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",542)
			this->nmeDrag(::nme::geom::Point_obj::__new(inEvent->__Field(HX_CSTRING("x"),true),inEvent->__Field(HX_CSTRING("y"),true)));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",544)
		Array< ::nme::display::InteractiveObject > stack = Array_obj< ::nme::display::InteractiveObject >::__new();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",545)
		::nme::display::DisplayObject obj = this->nmeFindByID(inEvent->__Field(HX_CSTRING("id"),true));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",546)
		if (((obj != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",547)
			obj->nmeGetInteractiveObjectStack(stack);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",549)
		::nme::geom::Point local = null();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",550)
		if (((stack->length > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",552)
			::nme::display::InteractiveObject obj1 = stack->__get((int)0);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",553)
			stack->reverse();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",554)
			local = obj1->globalToLocal(::nme::geom::Point_obj::__new(inEvent->__Field(HX_CSTRING("x"),true),inEvent->__Field(HX_CSTRING("y"),true)));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",555)
			::nme::events::MouseEvent evt = ::nme::events::MouseEvent_obj::nmeCreate(type,inEvent,local,obj1);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",556)
			evt->delta = wheel;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",557)
			if ((inFromMouse)){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",558)
				this->nmeCheckInOuts(evt,stack,null());
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",559)
			obj1->nmeFireEvent(evt);
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",564)
			local = ::nme::geom::Point_obj::__new(inEvent->__Field(HX_CSTRING("x"),true),inEvent->__Field(HX_CSTRING("y"),true));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",565)
			::nme::events::MouseEvent evt = ::nme::events::MouseEvent_obj::nmeCreate(type,inEvent,local,null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",566)
			evt->delta = wheel;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",567)
			if ((inFromMouse)){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",568)
				this->nmeCheckInOuts(evt,stack,null());
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",571)
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",572)
		if (((bool((inType == ::nme::events::MouseEvent_obj::MOUSE_DOWN)) && bool((button < (int)3))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",573)
			this->nmeLastDown[button] = click_obj;
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",576)
			if (((bool((inType == ::nme::events::MouseEvent_obj::MOUSE_UP)) && bool((button < (int)3))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",578)
				if (((click_obj == this->nmeLastDown->__get(button)))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",580)
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",581)
					click_obj->nmeFireEvent(evt);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",583)
					if (((bool((button == (int)0)) && bool(click_obj->doubleClickEnabled)))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",585)
						double now = ::haxe::Timer_obj::stamp();
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",586)
						if ((((now - this->nmeLastClickTime) < 0.25))){
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",588)
							...
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",589)
							click_obj->nmeFireEvent(evt1);
						}
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",591)
						this->nmeLastClickTime = now;
					}
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",594)
...
Void Stage_obj::nmeOnResize( double inW,double inH){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",601)
		::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::RESIZE,null(),null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",602)
		this->nmeDispatchEvent(evt);
	}
return null();
}
...
Void Stage_obj::nmeOnTouch( Dynamic inEvent,::String inType,::nme::display::TouchInfo touchInfo){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",608)
		Array< ::nme::display::InteractiveObject > stack = Array_obj< ::nme::display::InteractiveObject >::__new();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",609)
		::nme::display::DisplayObject obj = this->nmeFindByID(inEvent->__Field(HX_CSTRING("id"),true));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",610)
		if (((obj != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",611)
			obj->nmeGetInteractiveObjectStack(stack);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",613)
		if (((stack->length > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",615)
			::nme::display::InteractiveObject obj1 = stack->__get((int)0);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",616)
			stack->reverse();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",617)
			::nme::geom::Point local = obj1->globalToLocal(::nme::geom::Point_obj::__new(inEvent->__Field(HX_CSTRING("x"),true),inEvent->__Field(HX_CSTRING("y"),true)));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",618)
			::nme::events::TouchEvent evt = ::nme::events::TouchEvent_obj::nmeCreate(inType,inEvent,local,obj1);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",619)
			evt->touchPointID = inEvent->__Field(HX_CSTRING("value"),true);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",620)
			evt->isPrimaryTouchPoint = (((int(inEvent->__Field(HX_CSTRING("flags"),true)) & int((int)32768))) > (int)0);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",622)
			this->nmeCheckInOuts(evt,stack,touchInfo);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",623)
			obj1->nmeFireEvent(evt);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",624)
			if (((bool(evt->isPrimaryTouchPoint) && bool((inType == ::nme::events::TouchEvent_obj::TOUCH_MOVE))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",626)
				if (((this->nmeDragObject != null()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",627)
					this->nmeDrag(::nme::geom::Point_obj::__new(inEvent->__Field(HX_CSTRING("x"),true),inEvent->__Field(HX_CSTRING("y"),true)));
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",629)
				::nme::events::MouseEvent evt1 = ::nme::events::MouseEvent_obj::nmeCreate(::nme::events::MouseEvent_obj::MOUSE_MOVE,inEvent,local,obj1);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",630)
				obj1->nmeFireEvent(evt1);
			}
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",636)
			::nme::events::TouchEvent evt = ::nme::events::TouchEvent_obj::nmeCreate(inType,inEvent,::nme::geom::Point_obj::__new(inEvent->__Field(HX_CSTRING("x"),true),inEvent->__Field(HX_CSTRING("y"),true)),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",637)
			evt->touchPointID = inEvent->__Field(HX_CSTRING("value"),true);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",638)
			evt->isPrimaryTouchPoint = (((int(inEvent->__Field(HX_CSTRING("flags"),true)) & int((int)32768))) > (int)0);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",640)
			this->nmeCheckInOuts(evt,stack,touchInfo);
		}
	}
return null();
...
Void Stage_obj::nmePollTimers( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",648)
		::haxe::Timer_obj::nmeCheckTimers();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",649)
		::nme::media::SoundChannel_obj::nmePollComplete();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",650)
		::nme::net::URLLoader_obj::nmePollData();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",651)
		this->nmeCheckRender();
	}
return null();
}
...
Void Stage_obj::nmeRender( bool inSendEnterFrame){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",657)
		if ((!(this->active))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",658)
			return null();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",661)
		if ((inSendEnterFrame)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",662)
			this->nmeBroadcast(::nme::events::Event_obj::__new(::nme::events::Event_obj::ENTER_FRAME,null(),null()));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",665)
		if ((this->nmeInvalid)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",667)
			this->nmeInvalid = false;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",668)
			this->nmeBroadcast(::nme::events::Event_obj::__new(::nme::events::Event_obj::RENDER,null(),null()));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",670)
...
Void Stage_obj::nmeSetActive( bool inActive){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",675)
		if (((inActive != this->active))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",679)
			this->active = inActive;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",680)
			if ((!(this->active))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",681)
				this->nmeLastRender = ::haxe::Timer_obj::stamp();
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",683)
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",684)
			this->nmeBroadcast(evt);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",685)
			if ((inActive)){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",686)
				this->nmePollTimers();
			}
		}
	}
...
Void Stage_obj::nmeStartDrag( ::nme::display::Sprite sprite,bool lockCenter,::nme::geom::Rectangle bounds){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",693)
		this->nmeDragBounds = (  (((bounds == null()))) ? ::nme::geom::Rectangle(null()) : ::nme::geom::Rectangle(bounds->clone()) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",694)
		this->nmeDragObject = sprite;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",696)
		if (((this->nmeDragObject != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",697)
			if ((lockCenter)){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",700)
				this->nmeDragOffsetX = (double(-(this->nmeDragObject->nmeGetWidth())) / double((int)2));
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",701)
				this->nmeDragOffsetY = (double(-(this->nmeDragObject->nmeGetHeight())) / double((int)2));
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",705)
				::nme::geom::Point mouse = ::nme::geom::Point_obj::__new(this->nmeGetMouseX(),this->nmeGetMouseY());
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",706)
				::nme::display::DisplayObjectContainer p = this->nmeDragObject->nmeGetParent();
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",707)
				if (((p != null()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",708)
					mouse = p->globalToLocal(mouse);
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",710)
				this->nmeDragOffsetX = (this->nmeDragObject->nmeGetX() - mouse->x);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",711)
...
Void Stage_obj::nmeStopDrag( ::nme::display::Sprite sprite){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",719)
		this->nmeDragBounds = null();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",720)
...
double Stage_obj::nmeUpdateNextWake( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",727)
	double next_wake = ::haxe::Timer_obj::nmeNextWake(315000000.0);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",728)
	if (((bool((next_wake > 0.001)) && bool((::nme::media::SoundChannel_obj::nmeDynamicSoundCount > (int)0))))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",729)
		next_wake = 0.001;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",730)
	if (((bool((next_wake > 0.02)) && bool(((bool(::nme::media::SoundChannel_obj::nmeCompletePending()) || bool(::nme::net::URLLoader_obj::nmeLoadPending()))))))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",731)
		next_wake = (  (((bool(this->active) || bool(!(this->pauseWhenDeactivated))))) ? double(0.020) : double(0.500) );
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",734)
	next_wake = this->nmeNextFrameDue(next_wake);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",735)
	::nme::display::Stage_obj::nme_stage_set_next_wake(this->nmeHandle,next_wake);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",736)
	return next_wake;
}
...
Void Stage_obj::showCursor( bool inShow){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",754)
...
::nme::display::StageAlign Stage_obj::nmeGetAlign( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",766)
	int i = ::nme::display::Stage_obj::nme_stage_get_align(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",767)
...
::nme::display::StageAlign Stage_obj::nmeSetAlign( ::nme::display::StageAlign inMode){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",773)
	::nme::display::Stage_obj::nme_stage_set_align(this->nmeHandle,inMode->__Index());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",774)
	return inMode;
}
...
::nme::display::StageDisplayState Stage_obj::nmeGetDisplayState( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",780)
	int i = ::nme::display::Stage_obj::nme_stage_get_display_state(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",781)
...
::nme::display::StageDisplayState Stage_obj::nmeSetDisplayState( ::nme::display::StageDisplayState inState){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",787)
	::nme::display::Stage_obj::nme_stage_set_display_state(this->nmeHandle,inState->__Index());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",788)
	return inState;
}
...
double Stage_obj::nmeGetDPIScale( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",793)
...
::nme::display::InteractiveObject Stage_obj::nmeGetFocus( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",800)
	int id = ::nme::display::Stage_obj::nme_stage_get_focus_id(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",801)
	::nme::display::DisplayObject obj = this->nmeFindByID(id);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",802)
	return obj;
}
...
::nme::display::InteractiveObject Stage_obj::nmeSetFocus( ::nme::display::InteractiveObject inObject){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",808)
	if (((inObject == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",809)
		::nme::display::Stage_obj::nme_stage_set_focus(this->nmeHandle,null(),(int)0);
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",811)
		::nme::display::Stage_obj::nme_stage_set_focus(this->nmeHandle,inObject->nmeHandle,(int)0);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",812)
	return inObject;
}
...
double Stage_obj::nmeSetFrameRate( double inRate){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",818)
	this->frameRate = inRate;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",819)
	this->nmeFramePeriod = (  (((this->frameRate <= (int)0))) ? double(this->frameRate) : double((double(1.0) / double(this->frameRate))) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",820)
	return inRate;
}
...
bool Stage_obj::nmeIsOpenGL( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",825)
...
::nme::display::StageQuality Stage_obj::nmeGetQuality( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",832)
	int i = ::nme::display::Stage_obj::nme_stage_get_quality(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",833)
...
::nme::display::StageQuality Stage_obj::nmeSetQuality( ::nme::display::StageQuality inQuality){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",839)
	::nme::display::Stage_obj::nme_stage_set_quality(this->nmeHandle,inQuality->__Index());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",840)
	return inQuality;
}
...
::nme::display::StageScaleMode Stage_obj::nmeGetScaleMode( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",846)
	int i = ::nme::display::Stage_obj::nme_stage_get_scale_mode(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",847)
...
::nme::display::StageScaleMode Stage_obj::nmeSetScaleMode( ::nme::display::StageScaleMode inMode){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",853)
	::nme::display::Stage_obj::nme_stage_set_scale_mode(this->nmeHandle,inMode->__Index());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",854)
	return inMode;
}
...
bool Stage_obj::nmeGetStageFocusRect( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",858)
...
bool Stage_obj::nmeSetStageFocusRect( bool inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",861)
	::nme::display::Stage_obj::nme_stage_set_focus_rect(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",862)
	return inVal;
}
...
int Stage_obj::nmeGetStageHeight( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",867)
...
int Stage_obj::nmeGetStageWidth( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",873)
...
int run(){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",110)
...
int run(){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",115)
	return ::nme::display::Stage_obj::nme_stage_get_normal_orientation();
}
HX_END_LOCAL_FUNC0(return )
HX_END_DEFAULT_FUNC
...
Void Stage_obj::setFixedOrientation( int inOrientation){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",741)
...
bool run(int inOrientation){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Stage.hx",748)
...
Dynamic Stage_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"align") ) { if (inCallProp) return nmeSetAlign(inValue);align=inValue.Cast< ::nme::display::StageAlign >(); return inValue; }
		if (HX_FIELD_EQ(inName,"focus") ) { if (inCallProp) return nmeSetFocus(inValue);focus=inValue.Cast< ::nme::display::InteractiveObject >(); return inValue; }
	...
	case 6:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"quality") ) { if (inCallProp) return nmeSetQuality(inValue);quality=inValue.Cast< ::nme::display::StageQuality >(); return inValue; }
		break;
	case 8:
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"scaleMode") ) { if (inCallProp) return nmeSetScaleMode(inValue);scaleMode=inValue.Cast< ::nme::display::StageScaleMode >(); return inValue; }
		break;
	case 10:
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"displayState") ) { if (inCallProp) return nmeSetDisplayState(inValue);displayState=inValue.Cast< ::nme::display::StageDisplayState >(); return inValue; }
...
void Stage_obj::__boot()
{
	...
	hx::Static(nme_stage_get_normal_orientation) = ::nme::Loader_obj::load(HX_CSTRING("nme_stage_get_normal_orientation"),(int)0);
}
