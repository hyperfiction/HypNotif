...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Sprite.hx",18)
...
::String Sprite_obj::nmeGetType( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Sprite.hx",25)
	::String type = ::Type_obj::getClassName(::Type_obj::getClass(hx::ObjectPtr<OBJ_>(this)));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Sprite.hx",26)
	int pos = type.lastIndexOf(HX_CSTRING("."),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Sprite.hx",27)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Sprite.hx",32)
		if (((this->nmeGetStage() != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Sprite.hx",34)
...
Void Sprite_obj::stopDrag( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Sprite.hx",39)
		if (((this->nmeGetStage() != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Sprite.hx",41)
