...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/InteractiveObject.hx",21)
	this->doubleClickEnabled = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/InteractiveObject.hx",22)
	this->nmeMouseEnabled = true;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/InteractiveObject.hx",24)
...
::nme::display::InteractiveObject InteractiveObject_obj::nmeAsInteractiveObject( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/InteractiveObject.hx",29)
...
bool InteractiveObject_obj::requestSoftKeyboard( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/InteractiveObject.hx",35)
...
bool InteractiveObject_obj::nmeGetMouseEnabled( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/InteractiveObject.hx",45)
...
bool InteractiveObject_obj::nmeSetMouseEnabled( bool inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/InteractiveObject.hx",48)
	this->nmeMouseEnabled = inVal;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/InteractiveObject.hx",49)
	::nme::display::InteractiveObject_obj::nme_display_object_set_mouse_enabled(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/InteractiveObject.hx",50)
	return this->nmeMouseEnabled;
}
...
bool InteractiveObject_obj::nmeSetMoveForSoftKeyboard( bool inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/InteractiveObject.hx",56)
	::nme::display::InteractiveObject_obj::nme_display_object_set_moves_for_soft_keyboard(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/InteractiveObject.hx",57)
	return inVal;
}
...
bool InteractiveObject_obj::nmeGetMoveForSoftKeyboard( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/InteractiveObject.hx",62)
...
bool InteractiveObject_obj::nmeSetNeedsSoftKeyboard( bool inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/InteractiveObject.hx",69)
	::nme::display::InteractiveObject_obj::nme_display_object_set_needs_soft_keyboard(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/InteractiveObject.hx",70)
	return inVal;
}
...
bool InteractiveObject_obj::nmeGetNeedsSoftKeyboard( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/InteractiveObject.hx",75)
