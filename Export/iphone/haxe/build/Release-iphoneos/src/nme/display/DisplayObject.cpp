...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",173)
	super::__construct(hx::ObjectPtr<OBJ_>(this));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",175)
	this->nmeParent = null();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",176)
	this->nmeHandle = inHandle;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",177)
	this->nmeID = ::nme::display::DisplayObject_obj::nme_display_object_get_id(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",178)
...
bool DisplayObject_obj::dispatchEvent( ::nme::events::Event event){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",184)
	bool result = this->nmeDispatchEvent(event);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",186)
	if ((event->nmeGetIsCancelled())){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",187)
		return true;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",189)
	if (((bool(event->nmeGetBubbles()) && bool((this->nmeGetParent() != null()))))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",190)
		this->nmeGetParent()->dispatchEvent(event);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",194)
	return result;
}
...
::nme::geom::Point DisplayObject_obj::globalToLocal( ::nme::geom::Point inGlobal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",205)
	::nme::geom::Point result = inGlobal->clone();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",206)
	::nme::display::DisplayObject_obj::nme_display_object_global_to_local(this->nmeHandle,result);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",207)
	return result;
}
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",223)
...
::nme::geom::Point DisplayObject_obj::localToGlobal( ::nme::geom::Point inLocal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",235)
	::nme::geom::Point result = inLocal->clone();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",236)
	::nme::display::DisplayObject_obj::nme_display_object_local_to_global(this->nmeHandle,result);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",237)
	return result;
}
...
::nme::display::InteractiveObject DisplayObject_obj::nmeAsInteractiveObject( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",242)
	return null();
}
...
Void DisplayObject_obj::nmeBroadcast( ::nme::events::Event inEvt){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",248)
...
bool DisplayObject_obj::nmeDispatchEvent( ::nme::events::Event inEvt){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",255)
	if (((inEvt->nmeGetTarget() == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",256)
		inEvt->nmeSetTarget(hx::ObjectPtr<OBJ_>(this));
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",259)
	inEvt->nmeSetCurrentTarget(hx::ObjectPtr<OBJ_>(this));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",260)
...
Void DisplayObject_obj::nmeDrawToSurface( Dynamic inSurface,::nme::geom::Matrix matrix,::nme::geom::ColorTransform colorTransform,::String blendMode,::nme::geom::Rectangle clipRect,bool smoothing){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",265)
...
::nme::display::DisplayObject DisplayObject_obj::nmeFindByID( int inID){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",273)
	if (((this->nmeID == inID))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",274)
		return hx::ObjectPtr<OBJ_>(this);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",275)
	return null();
}
...
Void DisplayObject_obj::nmeFireEvent( ::nme::events::Event inEvt){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",281)
		Array< ::nme::display::InteractiveObject > stack = Array_obj< ::nme::display::InteractiveObject >::__new();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",283)
		if (((this->nmeParent != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",284)
			this->nmeParent->nmeGetInteractiveObjectStack(stack);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",286)
		int l = stack->length;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",288)
		if (((l > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",291)
			inEvt->nmeSetPhase(::nme::events::EventPhase_obj::CAPTURING_PHASE);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",292)
			stack->reverse();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",294)
			{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",294)
				int _g = (int)0;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",294)
				while(((_g < stack->length))){
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",294)
					++(_g);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",296)
					inEvt->nmeSetCurrentTarget(obj);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",297)
					obj->nmeDispatchEvent(inEvt);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",299)
					if ((inEvt->nmeGetIsCancelled())){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",300)
						return null();
					}
				}
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",306)
		inEvt->nmeSetPhase(::nme::events::EventPhase_obj::AT_TARGET);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",307)
		inEvt->nmeSetCurrentTarget(hx::ObjectPtr<OBJ_>(this));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",308)
		this->nmeDispatchEvent(inEvt);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",310)
		if ((inEvt->nmeGetIsCancelled())){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",311)
			return null();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",314)
		if ((inEvt->nmeGetBubbles())){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",316)
			inEvt->nmeSetPhase(::nme::events::EventPhase_obj::BUBBLING_PHASE);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",317)
			stack->reverse();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",319)
			{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",319)
				int _g = (int)0;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",319)
				while(((_g < stack->length))){
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",319)
					++(_g);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",321)
					inEvt->nmeSetCurrentTarget(obj);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",322)
					obj->nmeDispatchEvent(inEvt);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",324)
					if ((inEvt->nmeGetIsCancelled())){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",325)
						return null();
					}
				}
			}
...
::nme::geom::ColorTransform DisplayObject_obj::nmeGetColorTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",333)
	::nme::geom::ColorTransform trans = ::nme::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",334)
	::nme::display::DisplayObject_obj::nme_display_object_get_color_transform(this->nmeHandle,trans,false);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",335)
	return trans;
}
...
::nme::geom::ColorTransform DisplayObject_obj::nmeGetConcatenatedColorTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",341)
	::nme::geom::ColorTransform trans = ::nme::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",342)
	::nme::display::DisplayObject_obj::nme_display_object_get_color_transform(this->nmeHandle,trans,true);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",343)
	return trans;
}
...
::nme::geom::Matrix DisplayObject_obj::nmeGetConcatenatedMatrix( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",349)
	::nme::geom::Matrix mtx = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",350)
	::nme::display::DisplayObject_obj::nme_display_object_get_matrix(this->nmeHandle,mtx,true);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",351)
	return mtx;
}
...
Void DisplayObject_obj::nmeGetInteractiveObjectStack( Array< ::nme::display::InteractiveObject > outStack){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",357)
		::nme::display::InteractiveObject io = this->nmeAsInteractiveObject();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",359)
		if (((io != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",360)
			outStack->push(io);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",362)
		if (((this->nmeParent != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",363)
...
::nme::geom::Matrix DisplayObject_obj::nmeGetMatrix( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",369)
	::nme::geom::Matrix mtx = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",370)
	::nme::display::DisplayObject_obj::nme_display_object_get_matrix(this->nmeHandle,mtx,false);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",371)
	return mtx;
}
...
Void DisplayObject_obj::nmeGetObjectsUnderPoint( ::nme::geom::Point point,Array< ::nme::display::DisplayObject > result){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",376)
		if ((::nme::display::DisplayObject_obj::nme_display_object_hit_test_point(this->nmeHandle,point->x,point->y,true,false))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",378)
...
::nme::geom::Rectangle DisplayObject_obj::nmeGetPixelBounds( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",384)
	::nme::geom::Rectangle rect = ::nme::geom::Rectangle_obj::__new(null(),null(),null(),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",385)
	::nme::display::DisplayObject_obj::nme_display_object_get_pixel_bounds(this->nmeHandle,rect);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",386)
	return rect;
}
...
Void DisplayObject_obj::nmeOnAdded( ::nme::display::DisplayObject inObj,bool inIsOnStage){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",392)
		if (((inObj == hx::ObjectPtr<OBJ_>(this)))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",394)
			::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::ADDED,true,false);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",395)
			evt->nmeSetTarget(inObj);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",396)
			this->dispatchEvent(evt);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",399)
		if ((inIsOnStage)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",401)
			::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::ADDED_TO_STAGE,false,false);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",402)
			evt->nmeSetTarget(inObj);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",403)
			this->dispatchEvent(evt);
		}
	}
return null();
...
Void DisplayObject_obj::nmeOnRemoved( ::nme::display::DisplayObject inObj,bool inWasOnStage){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",410)
		if (((inObj == hx::ObjectPtr<OBJ_>(this)))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",412)
			::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::REMOVED,true,false);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",413)
			evt->nmeSetTarget(inObj);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",414)
			this->dispatchEvent(evt);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",417)
		if ((inWasOnStage)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",419)
			::nme::events::Event evt = ::nme::events::Event_obj::__new(::nme::events::Event_obj::REMOVED_FROM_STAGE,false,false);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",420)
			evt->nmeSetTarget(inObj);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",421)
			this->dispatchEvent(evt);
		}
	}
return null();
...
Void DisplayObject_obj::nmeSetColorTransform( ::nme::geom::ColorTransform inTrans){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",427)
...
Void DisplayObject_obj::nmeSetMatrix( ::nme::geom::Matrix inMatrix){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",433)
...
::String DisplayObject_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",442)
...
double DisplayObject_obj::nmeGetAlpha( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",452)
...
double DisplayObject_obj::nmeSetAlpha( double inAlpha){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",455)
	::nme::display::DisplayObject_obj::nme_display_object_set_alpha(this->nmeHandle,inAlpha);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",456)
	return inAlpha;
}
...
Dynamic DisplayObject_obj::nmeGetBG( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",462)
	int i = ::nme::display::DisplayObject_obj::nme_display_object_get_bg(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",463)
	if (((((int(i) & int((int)16777216))) == (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",464)
		return null();
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",466)
...
Dynamic DisplayObject_obj::nmeSetBG( Dynamic inBG){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",472)
	if (((inBG == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",473)
		::nme::display::DisplayObject_obj::nme_display_object_set_bg(this->nmeHandle,(int)0);
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",475)
		::nme::display::DisplayObject_obj::nme_display_object_set_bg(this->nmeHandle,inBG);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",477)
	return inBG;
}
...
::nme::display::BlendMode DisplayObject_obj::nmeGetBlendMode( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",483)
	int i = ::nme::display::DisplayObject_obj::nme_display_object_get_blend_mode(this->nmeHandle);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",484)
...
::nme::display::BlendMode DisplayObject_obj::nmeSetBlendMode( ::nme::display::BlendMode inMode){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",490)
	::nme::display::DisplayObject_obj::nme_display_object_set_blend_mode(this->nmeHandle,inMode->__Index());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",491)
	return inMode;
}
...
bool DisplayObject_obj::nmeGetCacheAsBitmap( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",495)
...
bool DisplayObject_obj::nmeSetCacheAsBitmap( bool inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",498)
	::nme::display::DisplayObject_obj::nme_display_object_set_cache_as_bitmap(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",499)
	return inVal;
}
...
Dynamic DisplayObject_obj::nmeGetFilters( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",505)
	if (((this->nmeFilters == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",505)
		return Dynamic( Array_obj<Dynamic>::__new());
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",507)
	Dynamic result = Dynamic( Array_obj<Dynamic>::__new() );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",509)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",509)
		int _g = (int)0;
		...
		while(((_g < _g1->__Field(HX_CSTRING("length"),true)))){
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",509)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",510)
			result->__Field(HX_CSTRING("push"),true)(filter->__Field(HX_CSTRING("clone"),true)());
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",512)
	return result;
}
...
Dynamic DisplayObject_obj::nmeSetFilters( Dynamic inFilters){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",518)
	if (((inFilters == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",519)
		this->nmeFilters = null();
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",524)
		this->nmeFilters = Dynamic( Array_obj<Dynamic>::__new() );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",526)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",526)
			int _g = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",526)
			while(((_g < inFilters->__Field(HX_CSTRING("length"),true)))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",526)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",527)
				this->nmeFilters->__Field(HX_CSTRING("push"),true)(filter->__Field(HX_CSTRING("clone"),true)());
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",530)
	::nme::display::DisplayObject_obj::nme_display_object_set_filters(this->nmeHandle,this->nmeFilters);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",532)
	return inFilters;
}
...
::nme::display::Graphics DisplayObject_obj::nmeGetGraphics( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",538)
	if (((this->nmeGraphicsCache == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",539)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",540)
...
double DisplayObject_obj::nmeGetHeight( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",544)
...
double DisplayObject_obj::nmeSetHeight( double inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",547)
	::nme::display::DisplayObject_obj::nme_display_object_set_height(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",548)
	return inVal;
}
...
::nme::display::DisplayObject DisplayObject_obj::nmeSetMask( ::nme::display::DisplayObject inObject){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",554)
	this->mask = inObject;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",555)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",556)
	return inObject;
}
...
double DisplayObject_obj::nmeGetMouseX( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",560)
...
double DisplayObject_obj::nmeGetMouseY( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",561)
...
::String DisplayObject_obj::nmeGetName( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",564)
...
::String DisplayObject_obj::nmeSetName( ::String inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",567)
	::nme::display::DisplayObject_obj::nme_display_object_set_name(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",568)
	return inVal;
}
...
::nme::display::DisplayObjectContainer DisplayObject_obj::nmeGetParent( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",572)
...
::nme::display::DisplayObjectContainer DisplayObject_obj::nmeSetParent( ::nme::display::DisplayObjectContainer inParent){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",577)
	if (((inParent == this->nmeParent))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",578)
		return inParent;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",580)
	if (((this->nmeParent != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",581)
		this->nmeParent->nmeRemoveChildFromArray(hx::ObjectPtr<OBJ_>(this));
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",583)
	if (((bool((this->nmeParent == null())) && bool((inParent != null()))))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",585)
		this->nmeParent = inParent;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",586)
		this->nmeOnAdded(hx::ObjectPtr<OBJ_>(this),(this->nmeGetStage() != null()));
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",588)
		if (((bool((this->nmeParent != null())) && bool((inParent == null()))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",590)
			bool was_on_stage = (this->nmeGetStage() != null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",591)
			this->nmeParent = inParent;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",592)
			this->nmeOnRemoved(hx::ObjectPtr<OBJ_>(this),was_on_stage);
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",595)
			this->nmeParent = inParent;
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",599)
	return inParent;
}
...
double DisplayObject_obj::nmeGetRotation( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",603)
...
double DisplayObject_obj::nmeSetRotation( double inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",606)
	::nme::display::DisplayObject_obj::nme_display_object_set_rotation(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",607)
	return inVal;
}
...
::nme::geom::Rectangle DisplayObject_obj::nmeGetScale9Grid( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",611)
...
::nme::geom::Rectangle DisplayObject_obj::nmeSetScale9Grid( ::nme::geom::Rectangle inRect){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",614)
	this->nmeScale9Grid = (  (((inRect == null()))) ? ::nme::geom::Rectangle(null()) : ::nme::geom::Rectangle(inRect->clone()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",615)
	::nme::display::DisplayObject_obj::nme_display_object_set_scale9_grid(this->nmeHandle,this->nmeScale9Grid);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",616)
	return inRect;
}
...
double DisplayObject_obj::nmeGetScaleX( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",620)
...
double DisplayObject_obj::nmeSetScaleX( double inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",623)
	::nme::display::DisplayObject_obj::nme_display_object_set_scale_x(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",624)
	return inVal;
}
...
double DisplayObject_obj::nmeGetScaleY( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",628)
...
double DisplayObject_obj::nmeSetScaleY( double inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",631)
	::nme::display::DisplayObject_obj::nme_display_object_set_scale_y(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",632)
	return inVal;
}
...
::nme::geom::Rectangle DisplayObject_obj::nmeGetScrollRect( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",636)
...
::nme::geom::Rectangle DisplayObject_obj::nmeSetScrollRect( ::nme::geom::Rectangle inRect){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",639)
	this->nmeScrollRect = (  (((inRect == null()))) ? ::nme::geom::Rectangle(null()) : ::nme::geom::Rectangle(inRect->clone()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",640)
	::nme::display::DisplayObject_obj::nme_display_object_set_scroll_rect(this->nmeHandle,this->nmeScrollRect);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",641)
	return inRect;
}
...
::nme::display::Stage DisplayObject_obj::nmeGetStage( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",647)
	if (((this->nmeParent != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",648)
		return this->nmeParent->nmeGetStage();
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",650)
	return null();
}
...
::nme::geom::Transform DisplayObject_obj::nmeGetTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",654)
...
::nme::geom::Transform DisplayObject_obj::nmeSetTransform( ::nme::geom::Transform inTransform){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",657)
	this->nmeSetMatrix(inTransform->nmeGetMatrix());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",658)
	this->nmeSetColorTransform(inTransform->nmeGetColorTransform());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",659)
	return inTransform;
}
...
bool DisplayObject_obj::nmeGetVisible( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",663)
...
bool DisplayObject_obj::nmeSetVisible( bool inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",666)
	::nme::display::DisplayObject_obj::nme_display_object_set_visible(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",667)
	return inVal;
}
...
double DisplayObject_obj::nmeGetWidth( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",671)
...
double DisplayObject_obj::nmeSetWidth( double inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",674)
	::nme::display::DisplayObject_obj::nme_display_object_set_width(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",675)
	return inVal;
}
...
double DisplayObject_obj::nmeGetX( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",679)
...
double DisplayObject_obj::nmeSetX( double inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",682)
	::nme::display::DisplayObject_obj::nme_display_object_set_x(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",683)
	return inVal;
}
...
double DisplayObject_obj::nmeGetY( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",687)
...
double DisplayObject_obj::nmeSetY( double inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",690)
	::nme::display::DisplayObject_obj::nme_display_object_set_y(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObject.hx",691)
	return inVal;
}
...
Dynamic DisplayObject_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 1:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"mask") ) { if (inCallProp) return nmeSetMask(inValue);mask=inValue.Cast< ::nme::display::DisplayObject >(); return inValue; }
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"blendMode") ) { if (inCallProp) return nmeSetBlendMode(inValue);blendMode=inValue.Cast< ::nme::display::BlendMode >(); return inValue; }
		if (HX_FIELD_EQ(inName,"nmeHandle") ) { nmeHandle=inValue.Cast< Dynamic >(); return inValue; }
		if (HX_FIELD_EQ(inName,"transform") ) { if (inCallProp) return nmeSetTransform(inValue);transform=inValue.Cast< ::nme::geom::Transform >(); return inValue; }
		if (HX_FIELD_EQ(inName,"nmeParent") ) { nmeParent=inValue.Cast< ::nme::display::DisplayObjectContainer >(); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"scale9Grid") ) { if (inCallProp) return nmeSetScale9Grid(inValue);scale9Grid=inValue.Cast< ::nme::geom::Rectangle >(); return inValue; }
		if (HX_FIELD_EQ(inName,"scrollRect") ) { if (inCallProp) return nmeSetScrollRect(inValue);scrollRect=inValue.Cast< ::nme::geom::Rectangle >(); return inValue; }
