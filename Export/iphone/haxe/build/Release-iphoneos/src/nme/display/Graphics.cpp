...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",27)
...
Void Graphics_obj::arcTo( double inCX,double inCY,double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",33)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",39)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",45)
...
Void Graphics_obj::beginGradientFill( ::nme::display::GradientType type,Dynamic colors,Dynamic alphas,Dynamic ratios,::nme::geom::Matrix matrix,::nme::display::SpreadMethod spreadMethod,::nme::display::InterpolationMethod interpolationMethod,hx::Null< double >  __o_focalPointRatio){
double focalPointRatio = __o_focalPointRatio.Default(0.0);
	HX_SOURCE_PUSH("Graphics_obj::beginGradientFill");
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",52)
		if (((matrix == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",54)
			matrix = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",55)
			matrix->createGradientBox((int)200,(int)200,(int)0,(int)-100,(int)-100);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",58)
...
Void Graphics_obj::clear( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",63)
...
Void Graphics_obj::curveTo( double inCX,double inCY,double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",69)
...
Void Graphics_obj::drawCircle( double inX,double inY,double inRadius){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",75)
...
Void Graphics_obj::drawEllipse( double inX,double inY,double inWidth,double inHeight){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",81)
...
Void Graphics_obj::drawGraphicsData( Array< ::nme::display::IGraphicsData > graphicsData){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",88)
		Dynamic handles = Dynamic( Array_obj<Dynamic>::__new() );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",90)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",90)
			int _g = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",90)
			while(((_g < graphicsData->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",90)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",91)
				handles->__Field(HX_CSTRING("push"),true)(datum->nmeHandle);
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",93)
...
Void Graphics_obj::drawGraphicsDatum( ::nme::display::IGraphicsData graphicsDatum){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",98)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",104)
...
Void Graphics_obj::drawRect( double inX,double inY,double inWidth,double inHeight){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",110)
...
Void Graphics_obj::drawRoundRect( double inX,double inY,double inWidth,double inHeight,double inRadX,Dynamic inRadY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",116)
...
Void Graphics_obj::drawTiles( ::nme::display::Tilesheet sheet,Array< double > inXYID,hx::Null< bool >  __o_inSmooth,hx::Null< int >  __o_inFlags){
bool inSmooth = __o_inSmooth.Default(false);
int inFlags = __o_inFlags.Default(0);
	HX_SOURCE_PUSH("Graphics_obj::drawTiles");
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",126)
		this->beginBitmapFill(sheet->nmeBitmap,null(),false,inSmooth);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",128)
		if ((inSmooth)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",129)
			hx::OrEq(inFlags,(int)4096);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",131)
...
Void Graphics_obj::drawTriangles( Array< double > vertices,Array< int > indices,Array< double > uvtData,::nme::display::TriangleCulling culling,Array< int > colours,hx::Null< int >  __o_blendMode,Array< double > viewport){
int blendMode = __o_blendMode.Default(0);
	HX_SOURCE_PUSH("Graphics_obj::drawTriangles");
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",137)
		int cull = (  (((culling == null()))) ? int((int)0) : int((culling->__Index() - (int)1)) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",138)
...
Void Graphics_obj::endFill( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",143)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",149)
...
Void Graphics_obj::lineGradientStyle( ::nme::display::GradientType type,Dynamic colors,Dynamic alphas,Dynamic ratios,::nme::geom::Matrix matrix,::nme::display::SpreadMethod spreadMethod,::nme::display::InterpolationMethod interpolationMethod,hx::Null< double >  __o_focalPointRatio){
double focalPointRatio = __o_focalPointRatio.Default(0.0);
	HX_SOURCE_PUSH("Graphics_obj::lineGradientStyle");
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",156)
		if (((matrix == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",158)
			matrix = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",159)
			matrix->createGradientBox((int)200,(int)200,(int)0,(int)-100,(int)-100);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",162)
...
Void Graphics_obj::lineStyle( Dynamic thickness,hx::Null< int >  __o_color,hx::Null< double >  __o_alpha,hx::Null< bool >  __o_pixelHinting,::nme::display::LineScaleMode scaleMode,::nme::display::CapsStyle caps,::nme::display::JointStyle joints,hx::Null< double >  __o_miterLimit){
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",167)
...
Void Graphics_obj::lineTo( double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",173)
...
Void Graphics_obj::moveTo( double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",179)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/Graphics.hx",185)
