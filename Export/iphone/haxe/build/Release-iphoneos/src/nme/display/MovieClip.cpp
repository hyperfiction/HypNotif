...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/MovieClip.hx",19)
	super::__construct();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/MovieClip.hx",20)
	this->mCurrentFrame = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/MovieClip.hx",21)
...
::String MovieClip_obj::nmeGetType( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/MovieClip.hx",38)
...
int MovieClip_obj::nmeGetCurrentFrame( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/MovieClip.hx",60)
...
int MovieClip_obj::nmeGetTotalFrames( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/MovieClip.hx",61)
