...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",25)
	super::__construct(inHandle,inType);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",26)
...
::nme::display::DisplayObject DisplayObjectContainer_obj::addChild( ::nme::display::DisplayObject child){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",32)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",32)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",33)
	return child;
}
...
::nme::display::DisplayObject DisplayObjectContainer_obj::addChildAt( ::nme::display::DisplayObject child,int index){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",39)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",39)
		if (((child == hx::ObjectPtr<OBJ_>(this)))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",39)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",40)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",40)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",41)
	return child;
}
...
bool DisplayObjectContainer_obj::areInaccessibleObjectsUnderPoint( ::nme::geom::Point point){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",46)
	return false;
}
...
bool DisplayObjectContainer_obj::contains( ::nme::display::DisplayObject child){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",53)
	if (((child == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",54)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",56)
	if (((hx::ObjectPtr<OBJ_>(this) == child))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",57)
		return true;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",59)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",59)
		int _g = (int)0;
		...
		while(((_g < _g1->length))){
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",59)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",60)
			if (((c == child))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",61)
				return true;
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",63)
	return false;
}
...
::nme::display::DisplayObject DisplayObjectContainer_obj::getChildAt( int index){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",69)
	if (((bool((index >= (int)0)) && bool((index < this->nmeChildren->length))))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",70)
		return this->nmeChildren->__get(index);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",73)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",75)
	return null();
}
...
::nme::display::DisplayObject DisplayObjectContainer_obj::getChildByName( ::String name){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",81)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",81)
		int _g = (int)0;
		Array< ::nme::display::DisplayObject > _g1 = this->nmeChildren;
		...
		while(((_g < _g1->length))){
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",81)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",82)
			if (((name == c->nmeGetName()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",83)
				return c;
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",84)
	return null();
}
...
int DisplayObjectContainer_obj::getChildIndex( ::nme::display::DisplayObject child){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",89)
...
Array< ::nme::display::DisplayObject > DisplayObjectContainer_obj::getObjectsUnderPoint( ::nme::geom::Point point){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",96)
	Array< ::nme::display::DisplayObject > result = Array_obj< ::nme::display::DisplayObject >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",97)
	this->nmeGetObjectsUnderPoint(point,result);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",98)
	return result;
}
...
Void DisplayObjectContainer_obj::nmeAddChild( ::nme::display::DisplayObject child){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",104)
		if (((child == hx::ObjectPtr<OBJ_>(this)))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",105)
			hx::Throw (HX_CSTRING("Adding to self"));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",109)
		if (((child->nmeParent == hx::ObjectPtr<OBJ_>(this)))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",110)
			this->setChildIndex(child,(this->nmeChildren->length - (int)1));
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",115)
			child->nmeSetParent(hx::ObjectPtr<OBJ_>(this));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",116)
			this->nmeChildren->push(child);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",117)
			::nme::display::DisplayObjectContainer_obj::nme_doc_add_child(this->nmeHandle,child->nmeHandle);
		}
	}
return null();
...
Void DisplayObjectContainer_obj::nmeBroadcast( ::nme::events::Event inEvt){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",124)
		int i = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",126)
		if (((this->nmeChildren->length > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",127)
			while((true)){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",129)
				::nme::display::DisplayObject child = this->nmeChildren->__get(i);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",130)
				child->nmeBroadcast(inEvt);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",132)
				if (((i >= this->nmeChildren->length))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",133)
					break;
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",135)
				if (((this->nmeChildren->__get(i) == child))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",137)
					(i)++;
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",138)
					if (((i >= this->nmeChildren->length))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",139)
						break;
					}
				}
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",143)
...
::nme::display::DisplayObject DisplayObjectContainer_obj::nmeFindByID( int inID){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",149)
	if (((this->nmeID == inID))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",150)
		return hx::ObjectPtr<OBJ_>(this);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",152)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",152)
		int _g = (int)0;
		Array< ::nme::display::DisplayObject > _g1 = this->nmeChildren;
		...
		while(((_g < _g1->length))){
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",152)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",154)
			::nme::display::DisplayObject found = child->nmeFindByID(inID);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",156)
			if (((found != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",157)
				return found;
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",160)
...
int DisplayObjectContainer_obj::nmeGetChildIndex( ::nme::display::DisplayObject child){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",166)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",166)
		int _g1 = (int)0;
		int _g = this->nmeChildren->length;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",166)
			int i = (_g1)++;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",167)
			if (((this->nmeChildren->__get(i) == child))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",168)
				return i;
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",169)
	return (int)-1;
}
...
Void DisplayObjectContainer_obj::nmeGetObjectsUnderPoint( ::nme::geom::Point point,Array< ::nme::display::DisplayObject > result){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",175)
		this->super::nmeGetObjectsUnderPoint(point,result);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",177)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",177)
			int _g = (int)0;
			Array< ::nme::display::DisplayObject > _g1 = this->nmeChildren;
			...
			while(((_g < _g1->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",177)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",178)
...
Void DisplayObjectContainer_obj::nmeOnAdded( ::nme::display::DisplayObject inObj,bool inIsOnStage){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",184)
		this->super::nmeOnAdded(inObj,inIsOnStage);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",186)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",186)
			int _g = (int)0;
			Array< ::nme::display::DisplayObject > _g1 = this->nmeChildren;
			...
			while(((_g < _g1->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",186)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",187)
...
Void DisplayObjectContainer_obj::nmeOnRemoved( ::nme::display::DisplayObject inObj,bool inWasOnStage){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",193)
		this->super::nmeOnRemoved(inObj,inWasOnStage);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",195)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",195)
			int _g = (int)0;
			Array< ::nme::display::DisplayObject > _g1 = this->nmeChildren;
			...
			while(((_g < _g1->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",195)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",196)
...
Void DisplayObjectContainer_obj::nmeRemoveChildFromArray( ::nme::display::DisplayObject child){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",202)
		int i = this->nmeGetChildIndex(child);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",204)
		if (((i >= (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",206)
			::nme::display::DisplayObjectContainer_obj::nme_doc_remove_child(this->nmeHandle,i);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",207)
...
Void DisplayObjectContainer_obj::nmeSetChildIndex( ::nme::display::DisplayObject child,int index){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",214)
		if (((index > this->nmeChildren->length))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",215)
			hx::Throw ((HX_CSTRING("Invalid index position ") + index));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",217)
		::nme::display::DisplayObject s = null();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",218)
		int orig = this->nmeGetChildIndex(child);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",220)
		if (((orig < (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",222)
			::String msg = ((HX_CSTRING("setChildIndex : object ") + child->toString()) + HX_CSTRING(" not found."));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",224)
			if (((child->nmeParent == hx::ObjectPtr<OBJ_>(this)))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",226)
				int realindex = (int)-1;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",228)
				{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",228)
					int _g1 = (int)0;
					int _g = this->nmeChildren->length;
					...
					while(((_g1 < _g))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",228)
						int i = (_g1)++;
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",230)
						if (((this->nmeChildren->__get(i) == child))){
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",232)
							realindex = i;
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",233)
							break;
						}
					}
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",237)
				if (((realindex != (int)-1))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",238)
					hx::AddEq(msg,(HX_CSTRING("Internal error: Real child index was ") + ::Std_obj::string(realindex)));
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",240)
					hx::AddEq(msg,HX_CSTRING("Internal error: Child was not in nmeChildren array!"));
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",243)
			hx::Throw (msg);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",246)
		::nme::display::DisplayObjectContainer_obj::nme_doc_set_child_index(this->nmeHandle,child->nmeHandle,index);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",248)
		if (((index < orig))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",250)
			int i = orig;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",252)
			while(((i > index))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",254)
				this->nmeChildren[i] = this->nmeChildren->__get((i - (int)1));
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",255)
				(i)--;
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",258)
			this->nmeChildren[index] = child;
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",261)
			if (((orig < index))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",263)
				int i = orig;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",264)
				while(((i < index))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",266)
					this->nmeChildren[i] = this->nmeChildren->__get((i + (int)1));
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",267)
					(i)++;
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",270)
				this->nmeChildren[index] = child;
			}
		}
	}
...
Void DisplayObjectContainer_obj::nmeSwapChildrenAt( int index1,int index2){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",277)
		if (((bool((bool((bool((index1 < (int)0)) || bool((index2 < (int)0)))) || bool((index1 > this->nmeChildren->length)))) || bool((index2 > this->nmeChildren->length))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",278)
			hx::Throw (::nme::errors::RangeError_obj::__new(HX_CSTRING("swapChildrenAt : index out of bounds")));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",280)
		if (((index1 != index2))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",282)
			::nme::display::DisplayObject tmp = this->nmeChildren->__get(index1);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",283)
			this->nmeChildren[index1] = this->nmeChildren->__get(index2);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",284)
			this->nmeChildren[index2] = tmp;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",285)
...
::nme::display::DisplayObject DisplayObjectContainer_obj::removeChild( ::nme::display::DisplayObject child){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",292)
	int c = this->nmeGetChildIndex(child);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",294)
	if (((c >= (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",296)
		child->nmeSetParent(null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",297)
		return child;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",300)
...
::nme::display::DisplayObject DisplayObjectContainer_obj::removeChildAt( int index){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",306)
	if (((bool((index >= (int)0)) && bool((index < this->nmeChildren->length))))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",308)
		::nme::display::DisplayObject result = this->nmeChildren->__get(index);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",309)
		result->nmeSetParent(null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",310)
		return result;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",313)
	hx::Throw (::nme::errors::ArgumentError_obj::__new(HX_CSTRING("The supplied DisplayObject must be a child of the caller."),null()));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",313)
	return null();
}
...
Void DisplayObjectContainer_obj::setChildIndex( ::nme::display::DisplayObject child,int index){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",318)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",319)
			if (((index > this->nmeChildren->length))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",319)
				hx::Throw ((HX_CSTRING("Invalid index position ") + index));
			}
...
Void DisplayObjectContainer_obj::swapChildren( ::nme::display::DisplayObject child1,::nme::display::DisplayObject child2){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",325)
		int idx1 = this->nmeGetChildIndex(child1);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",326)
		int idx2 = this->nmeGetChildIndex(child2);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",327)
		if (((bool((idx1 < (int)0)) || bool((idx2 < (int)0))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",328)
			hx::Throw (HX_CSTRING("swapChildren:Could not find children"));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",329)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",329)
...
Void DisplayObjectContainer_obj::swapChildrenAt( int index1,int index2){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",334)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",335)
			if (((bool((bool((bool((index1 < (int)0)) || bool((index2 < (int)0)))) || bool((index1 > this->nmeChildren->length)))) || bool((index2 > this->nmeChildren->length))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",335)
				hx::Throw (::nme::errors::RangeError_obj::__new(HX_CSTRING("swapChildrenAt : index out of bounds")));
			}
...
bool DisplayObjectContainer_obj::nmeGetMouseChildren( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",344)
...
bool DisplayObjectContainer_obj::nmeSetMouseChildren( bool inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",347)
	::nme::display::DisplayObjectContainer_obj::nme_doc_set_mouse_children(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",348)
	return inVal;
}
...
int DisplayObjectContainer_obj::nmeGetNumChildren( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",352)
...
bool DisplayObjectContainer_obj::nmeGetTabChildren( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",353)
	return false;
}
...
bool DisplayObjectContainer_obj::nmeSetTabChildren( bool inValue){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/DisplayObjectContainer.hx",354)
	return false;
}
