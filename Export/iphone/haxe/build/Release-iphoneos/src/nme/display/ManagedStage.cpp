...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/ManagedStage.hx",43)
...
double ManagedStage_obj::nmeDoProcessStageEvent( Dynamic inEvent){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/ManagedStage.hx",62)
	this->nmePollTimers();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/ManagedStage.hx",64)
	double wake = this->super::nmeDoProcessStageEvent(inEvent);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/ManagedStage.hx",65)
	this->setNextWake(wake);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/ManagedStage.hx",67)
	return wake;
}
...
Void ManagedStage_obj::nmeRender( bool inSendEnterFrame){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/ManagedStage.hx",76)
		this->beginRender();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/ManagedStage.hx",77)
		this->super::nmeRender(inSendEnterFrame);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/ManagedStage.hx",78)
		this->endRender();
	}
return null();
}
...
Void ManagedStage_obj::pumpEvent( Dynamic inEvent){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/ManagedStage.hx",83)
...
Void ManagedStage_obj::resize( int inWidth,int inHeight){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/ManagedStage.hx",89)
...
Void ManagedStage_obj::sendQuit( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/display/ManagedStage.hx",95)
