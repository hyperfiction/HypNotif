...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/ColorTransform.hx",25)
	this->redMultiplier = inRedMultiplier;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/ColorTransform.hx",26)
	this->greenMultiplier = inGreenMultiplier;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/ColorTransform.hx",27)
	this->blueMultiplier = inBlueMultiplier;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/ColorTransform.hx",28)
	this->alphaMultiplier = inAlphaMultiplier;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/ColorTransform.hx",29)
	this->redOffset = inRedOffset;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/ColorTransform.hx",30)
	this->greenOffset = inGreenOffset;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/ColorTransform.hx",31)
	this->blueOffset = inBlueOffset;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/ColorTransform.hx",32)
...
Void ColorTransform_obj::concat( ::nme::geom::ColorTransform second){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/ColorTransform.hx",38)
		hx::AddEq(this->redMultiplier,second->redMultiplier);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/ColorTransform.hx",39)
		hx::AddEq(this->greenMultiplier,second->greenMultiplier);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/ColorTransform.hx",40)
		hx::AddEq(this->blueMultiplier,second->blueMultiplier);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/ColorTransform.hx",41)
