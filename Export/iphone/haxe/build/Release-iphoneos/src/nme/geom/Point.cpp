...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",41)
	this->x = inX;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",42)
	this->y = inY;
}
;
	return null();
...
::nme::geom::Point Point_obj::add( ::nme::geom::Point v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",47)
...
::nme::geom::Point Point_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",53)
...
bool Point_obj::equals( ::nme::geom::Point toCompare){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",67)
...
Void Point_obj::normalize( double thickness){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",79)
		if (((bool((this->x == (int)0)) && bool((this->y == (int)0))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",81)
			this->x = thickness;
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",84)
			double norm = (double(thickness) / double(::Math_obj::sqrt(((this->x * this->x) + (this->y * this->y)))));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",85)
			hx::MultEq(this->x,norm);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",86)
...
Void Point_obj::offset( double dx,double dy){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",93)
		hx::AddEq(this->x,dx);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",94)
		hx::AddEq(this->y,dy);
	}
return null();
}
...
::nme::geom::Point Point_obj::subtract( ::nme::geom::Point v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",105)
...
double Point_obj::nmeGetLength( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",116)
...
double Point_obj::distance( ::nme::geom::Point pt1,::nme::geom::Point pt2){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",60)
	double dx = (pt1->x - pt2->x);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",61)
	double dy = (pt1->y - pt2->y);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",62)
...
::nme::geom::Point Point_obj::interpolate( ::nme::geom::Point pt1,::nme::geom::Point pt2,double f){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",73)
...
::nme::geom::Point Point_obj::polar( double len,double angle){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Point.hx",99)
