...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",28)
	this->a = (  (((in_a == null()))) ? Dynamic(1.0) : Dynamic(in_a) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",29)
	this->b = (  (((in_b == null()))) ? Dynamic(0.0) : Dynamic(in_b) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",30)
	this->c = (  (((in_c == null()))) ? Dynamic(0.0) : Dynamic(in_c) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",31)
	this->d = (  (((in_d == null()))) ? Dynamic(1.0) : Dynamic(in_d) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",32)
	this->tx = (  (((in_tx == null()))) ? Dynamic(0.0) : Dynamic(in_tx) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",33)
...
::nme::geom::Matrix Matrix_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",38)
...
Void Matrix_obj::concat( ::nme::geom::Matrix m){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",59)
		double a1 = ((this->a * m->a) + (this->b * m->c));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",60)
		this->b = ((this->a * m->b) + (this->b * m->d));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",61)
		this->a = a1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",63)
		double c1 = ((this->c * m->a) + (this->d * m->c));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",64)
		this->d = ((this->c * m->b) + (this->d * m->d));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",66)
		this->c = c1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",68)
		double tx1 = (((this->tx * m->a) + (this->ty * m->c)) + m->tx);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",69)
		this->ty = (((this->tx * m->b) + (this->ty * m->d)) + m->ty);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",70)
		this->tx = tx1;
	}
return null();
}
...
Void Matrix_obj::createBox( double scaleX,double scaleY,Dynamic rotation,Dynamic tx,Dynamic ty){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",76)
		this->a = (  (((scaleX == null()))) ? double(1.0) : double(scaleX) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",77)
		this->d = (  (((scaleY == null()))) ? double(1.0) : double(scaleY) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",78)
		this->b = (  (((rotation == null()))) ? Dynamic(0.0) : Dynamic(rotation) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",79)
		this->tx = (  (((tx == null()))) ? Dynamic(0.0) : Dynamic(tx) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",80)
...
Void Matrix_obj::createGradientBox( double in_width,double in_height,Dynamic rotation,Dynamic in_tx,Dynamic in_ty){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",86)
		this->a = (double(in_width) / double(1638.4));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",87)
		this->d = (double(in_height) / double(1638.4));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",90)
		if (((bool((rotation != null())) && bool((rotation != 0.0))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",92)
			double cos = ::Math_obj::cos(rotation);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",93)
			double sin = ::Math_obj::sin(rotation);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",94)
			this->b = (sin * this->d);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",95)
			this->c = (-(sin) * this->a);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",96)
			hx::MultEq(this->a,cos);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",97)
			hx::MultEq(this->d,cos);
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",100)
			this->b = this->c = (int)0;
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",104)
		this->tx = (  (((in_tx != null()))) ? double((in_tx + (double(in_width) / double((int)2)))) : double((double(in_width) / double((int)2))) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",105)
...
Void Matrix_obj::identity( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",111)
		this->a = (int)1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",112)
		this->b = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",113)
		this->c = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",114)
		this->d = (int)1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",115)
		this->tx = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",116)
		this->ty = (int)0;
	}
return null();
}
...
::nme::geom::Matrix Matrix_obj::invert( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",122)
	double norm = ((this->a * this->d) - (this->b * this->c));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",124)
	if (((norm == (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",126)
		this->a = this->b = this->c = this->d = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",127)
		this->tx = -(this->tx);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",128)
		this->ty = -(this->ty);
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",132)
		norm = (double(1.0) / double(norm));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",133)
		double a1 = (this->d * norm);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",134)
		this->d = (this->a * norm);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",135)
		this->a = a1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",136)
		hx::MultEq(this->b,-(norm));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",137)
		hx::MultEq(this->c,-(norm));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",139)
		double tx1 = ((-(this->a) * this->tx) - (this->c * this->ty));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",140)
		this->ty = ((-(this->b) * this->tx) - (this->d * this->ty));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",141)
		this->tx = tx1;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",144)
...
::nme::geom::Matrix Matrix_obj::mult( ::nme::geom::Matrix m){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",150)
	::nme::geom::Matrix result = ::nme::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",152)
	result->a = ((this->a * m->a) + (this->b * m->c));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",153)
	result->b = ((this->a * m->b) + (this->b * m->d));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",154)
	result->c = ((this->c * m->a) + (this->d * m->c));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",155)
	result->d = ((this->c * m->b) + (this->d * m->d));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",157)
	result->tx = (((this->tx * m->a) + (this->ty * m->c)) + m->tx);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",158)
	result->ty = (((this->tx * m->b) + (this->ty * m->d)) + m->ty);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",160)
	return result;
}
...
Void Matrix_obj::rotate( double inTheta){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",178)
		double cos = ::Math_obj::cos(inTheta);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",179)
		double sin = ::Math_obj::sin(inTheta);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",181)
		double a1 = ((this->a * cos) - (this->b * sin));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",182)
		this->b = ((this->a * sin) + (this->b * cos));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",183)
		this->a = a1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",185)
		double c1 = ((this->c * cos) - (this->d * sin));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",186)
		this->d = ((this->c * sin) + (this->d * cos));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",187)
		this->c = c1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",189)
		double tx1 = ((this->tx * cos) - (this->ty * sin));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",190)
		this->ty = ((this->tx * sin) + (this->ty * cos));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",191)
		this->tx = tx1;
	}
return null();
}
...
Void Matrix_obj::scale( double inSX,double inSY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",204)
		hx::MultEq(this->a,inSX);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",205)
		hx::MultEq(this->b,inSY);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",207)
		hx::MultEq(this->c,inSX);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",208)
		hx::MultEq(this->d,inSY);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",210)
		hx::MultEq(this->tx,inSX);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",211)
...
Void Matrix_obj::setRotation( double inTheta,Dynamic inScale){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",217)
		double scale = (  (((inScale == null()))) ? Dynamic(1.0) : Dynamic(inScale) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",218)
		this->a = (::Math_obj::cos(inTheta) * scale);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",219)
		this->c = (::Math_obj::sin(inTheta) * scale);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",220)
		this->b = -(this->c);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",221)
		this->d = this->a;
	}
return null();
}
...
::nme::geom::Point Matrix_obj::transformPoint( ::nme::geom::Point inPos){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",226)
...
Void Matrix_obj::translate( double inDX,double inDY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",233)
		hx::AddEq(this->tx,inDX);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Matrix.hx",234)
