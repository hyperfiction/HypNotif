...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Transform.hx",21)
...
::nme::geom::ColorTransform Transform_obj::nmeGetColorTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Transform.hx",31)
...
::nme::geom::ColorTransform Transform_obj::nmeSetColorTransform( ::nme::geom::ColorTransform inTrans){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Transform.hx",32)
...
::nme::geom::ColorTransform Transform_obj::nmeGetConcatenatedColorTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Transform.hx",33)
...
::nme::geom::Matrix Transform_obj::nmeGetConcatenatedMatrix( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Transform.hx",34)
...
::nme::geom::Matrix Transform_obj::nmeGetMatrix( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Transform.hx",35)
...
::nme::geom::Matrix Transform_obj::nmeSetMatrix( ::nme::geom::Matrix inMatrix){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Transform.hx",36)
...
::nme::geom::Rectangle Transform_obj::nmeGetPixelBounds( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Transform.hx",37)
...
Dynamic Transform_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"matrix") ) { if (inCallProp) return nmeSetMatrix(inValue);matrix=inValue.Cast< ::nme::geom::Matrix >(); return inValue; }
	...
	case 11:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"colorTransform") ) { if (inCallProp) return nmeSetColorTransform(inValue);colorTransform=inValue.Cast< ::nme::geom::ColorTransform >(); return inValue; }
		break;
	case 18:
