...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",46)
	this->x = (  (((inX == null()))) ? Dynamic((int)0) : Dynamic(inX) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",47)
	this->y = (  (((inY == null()))) ? Dynamic((int)0) : Dynamic(inY) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",48)
	this->width = (  (((inWidth == null()))) ? Dynamic((int)0) : Dynamic(inWidth) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",49)
...
::nme::geom::Rectangle Rectangle_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",54)
...
bool Rectangle_obj::contains( double inX,double inY){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",60)
...
bool Rectangle_obj::containsPoint( ::nme::geom::Point point){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",66)
...
bool Rectangle_obj::containsRect( ::nme::geom::Rectangle rect){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",72)
...
bool Rectangle_obj::equals( ::nme::geom::Rectangle toCompare){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",78)
...
Void Rectangle_obj::extendBounds( ::nme::geom::Rectangle r){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",85)
		double dx = (this->x - r->x);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",86)
		if (((dx > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",88)
			hx::SubEq(this->x,dx);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",89)
			hx::AddEq(this->width,dx);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",91)
		double dy = (this->y - r->y);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",92)
		if (((dy > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",94)
			hx::SubEq(this->y,dy);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",95)
			hx::AddEq(this->height,dy);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",97)
		if (((r->nmeGetRight() > this->nmeGetRight()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",98)
			this->nmeSetRight(r->nmeGetRight());
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",99)
		if (((r->nmeGetBottom() > this->nmeGetBottom()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",100)
...
Void Rectangle_obj::inflate( double dx,double dy){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",106)
		hx::SubEq(this->x,dx);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",106)
		hx::AddEq(this->width,(dx * (int)2));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",107)
		hx::SubEq(this->y,dy);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",107)
...
Void Rectangle_obj::inflatePoint( ::nme::geom::Point point){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",112)
...
::nme::geom::Rectangle Rectangle_obj::intersection( ::nme::geom::Rectangle toIntersect){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",119)
	double x0 = (  (((this->x < toIntersect->x))) ? double(toIntersect->x) : double(this->x) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",120)
	double x1 = (  (((this->nmeGetRight() > toIntersect->nmeGetRight()))) ? double(toIntersect->nmeGetRight()) : double(this->nmeGetRight()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",121)
	if (((x1 <= x0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",122)
		return ::nme::geom::Rectangle_obj::__new(null(),null(),null(),null());
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",124)
	double y0 = (  (((this->y < toIntersect->y))) ? double(toIntersect->y) : double(this->y) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",125)
	double y1 = (  (((this->nmeGetBottom() > toIntersect->nmeGetBottom()))) ? double(toIntersect->nmeGetBottom()) : double(this->nmeGetBottom()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",126)
	if (((y1 <= y0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",127)
		return ::nme::geom::Rectangle_obj::__new(null(),null(),null(),null());
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",129)
...
bool Rectangle_obj::intersects( ::nme::geom::Rectangle toIntersect){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",135)
	double x0 = (  (((this->x < toIntersect->x))) ? double(toIntersect->x) : double(this->x) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",136)
	double x1 = (  (((this->nmeGetRight() > toIntersect->nmeGetRight()))) ? double(toIntersect->nmeGetRight()) : double(this->nmeGetRight()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",137)
	if (((x1 <= x0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",138)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",140)
	double y0 = (  (((this->y < toIntersect->y))) ? double(toIntersect->y) : double(this->y) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",141)
	double y1 = (  (((this->nmeGetBottom() > toIntersect->nmeGetBottom()))) ? double(toIntersect->nmeGetBottom()) : double(this->nmeGetBottom()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",142)
	return (y1 > y0);
}
...
bool Rectangle_obj::isEmpty( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",147)
...
Void Rectangle_obj::offset( double dx,double dy){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",154)
		hx::AddEq(this->x,dx);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",155)
		hx::AddEq(this->y,dy);
	}
return null();
}
...
Void Rectangle_obj::offsetPoint( ::nme::geom::Point point){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",161)
		hx::AddEq(this->x,point->x);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",162)
...
Void Rectangle_obj::setEmpty( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",167)
...
::nme::geom::Rectangle Rectangle_obj::transform( ::nme::geom::Matrix m){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",174)
	double tx0 = ((m->a * this->x) + (m->c * this->y));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",175)
	double tx1 = tx0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",176)
	double ty0 = ((m->b * this->x) + (m->d * this->y));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",177)
	double ty1 = tx0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",179)
	double tx = ((m->a * ((this->x + this->width))) + (m->c * this->y));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",180)
	double ty = ((m->b * ((this->x + this->width))) + (m->d * this->y));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",181)
	if (((tx < tx0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",181)
		tx0 = tx;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",182)
	if (((ty < ty0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",182)
		ty0 = ty;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",183)
	if (((tx > tx1))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",183)
		tx1 = tx;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",184)
	if (((ty > ty1))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",184)
		ty1 = ty;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",186)
	tx = ((m->a * ((this->x + this->width))) + (m->c * ((this->y + this->height))));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",187)
	ty = ((m->b * ((this->x + this->width))) + (m->d * ((this->y + this->height))));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",188)
	if (((tx < tx0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",188)
		tx0 = tx;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",189)
	if (((ty < ty0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",189)
		ty0 = ty;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",190)
	if (((tx > tx1))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",190)
		tx1 = tx;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",191)
	if (((ty > ty1))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",191)
		ty1 = ty;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",193)
	tx = ((m->a * this->x) + (m->c * ((this->y + this->height))));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",194)
	ty = ((m->b * this->x) + (m->d * ((this->y + this->height))));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",195)
	if (((tx < tx0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",195)
		tx0 = tx;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",196)
	if (((ty < ty0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",196)
		ty0 = ty;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",197)
	if (((tx > tx1))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",197)
		tx1 = tx;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",198)
	if (((ty > ty1))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",198)
		ty1 = ty;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",200)
...
::nme::geom::Rectangle Rectangle_obj::_union( ::nme::geom::Rectangle toUnion){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",206)
	double x0 = (  (((this->x > toUnion->x))) ? double(toUnion->x) : double(this->x) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",207)
	double x1 = (  (((this->nmeGetRight() < toUnion->nmeGetRight()))) ? double(toUnion->nmeGetRight()) : double(this->nmeGetRight()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",208)
	double y0 = (  (((this->y > toUnion->y))) ? double(toUnion->x) : double(this->y) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",209)
	double y1 = (  (((this->nmeGetBottom() < toUnion->nmeGetBottom()))) ? double(toUnion->nmeGetBottom()) : double(this->nmeGetBottom()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",210)
	return ::nme::geom::Rectangle_obj::__new(x0,y0,(x1 - x0),(y1 - y0));
}
...
double Rectangle_obj::nmeGetBottom( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",219)
...
double Rectangle_obj::nmeSetBottom( double b){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",220)
...
::nme::geom::Point Rectangle_obj::nmeGetBottomRight( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",221)
...
::nme::geom::Point Rectangle_obj::nmeSetBottomRight( ::nme::geom::Point p){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",222)
...
double Rectangle_obj::nmeGetLeft( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",223)
	return this->x;
}
...
double Rectangle_obj::nmeSetLeft( double l){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",224)
...
double Rectangle_obj::nmeGetRight( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",225)
...
double Rectangle_obj::nmeSetRight( double r){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",226)
	this->width = (r - this->x);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",226)
	return r;
}
...
::nme::geom::Point Rectangle_obj::nmeGetSize( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",227)
...
::nme::geom::Point Rectangle_obj::nmeSetSize( ::nme::geom::Point p){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",228)
	this->width = p->x;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",228)
	this->height = p->y;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",228)
...
double Rectangle_obj::nmeGetTop( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",229)
	return this->y;
}
...
double Rectangle_obj::nmeSetTop( double t){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",230)
...
::nme::geom::Point Rectangle_obj::nmeGetTopLeft( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",231)
...
::nme::geom::Point Rectangle_obj::nmeSetTopLeft( ::nme::geom::Point p){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",232)
	this->x = p->x;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",232)
	this->y = p->y;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/geom/Rectangle.hx",232)
...
Dynamic Rectangle_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 4:
		...
		if (HX_FIELD_EQ(inName,"size") ) { if (inCallProp) return nmeSetTopLeft(inValue);size=inValue.Cast< ::nme::geom::Point >(); return inValue; }
		break;
	case 5:
	...
	case 6:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"topLeft") ) { if (inCallProp) return nmeSetTopLeft(inValue);topLeft=inValue.Cast< ::nme::geom::Point >(); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"bottomRight") ) { if (inCallProp) return nmeSetBottomRight(inValue);bottomRight=inValue.Cast< ::nme::geom::Point >(); return inValue; }
	}
