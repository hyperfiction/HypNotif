...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",6)
	if (((inEncoded != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",8)
...
Void URLVariables_obj::decode( ::String inVars){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",13)
		Array< ::String > fields = ::Reflect_obj::fields(hx::ObjectPtr<OBJ_>(this));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",14)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",14)
			int _g = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",14)
			while(((_g < fields->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",14)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",15)
				::Reflect_obj::deleteField(hx::ObjectPtr<OBJ_>(this),f);
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",16)
		Array< ::String > fields1 = inVars.split(HX_CSTRING(";"))->join(HX_CSTRING("&")).split(HX_CSTRING("&"));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",17)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",17)
			int _g = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",17)
			while(((_g < fields1->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",17)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",19)
				int eq = f.indexOf(HX_CSTRING("="),null());
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",20)
				if (((eq > (int)0))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",21)
					this->__SetField(::StringTools_obj::urlDecode(f.substr((int)0,eq)),::StringTools_obj::urlDecode(f.substr((eq + (int)1),null())),false);
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",23)
					if (((eq != (int)0))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",24)
...
::String URLVariables_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",30)
	Array< ::String > result = Array_obj< ::String >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",31)
	Array< ::String > fields = ::Reflect_obj::fields(hx::ObjectPtr<OBJ_>(this));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",32)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",32)
		int _g = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",32)
		while(((_g < fields->length))){
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",32)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",33)
			result->push(((::StringTools_obj::urlEncode(f) + HX_CSTRING("=")) + ::StringTools_obj::urlEncode(::Reflect_obj::field(hx::ObjectPtr<OBJ_>(this),f))));
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLVariables.hx",35)
