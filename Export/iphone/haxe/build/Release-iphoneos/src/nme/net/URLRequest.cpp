...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",33)
	if (((inURL != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",34)
		this->url = inURL;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",35)
	this->verbose = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",36)
	this->userPassword = HX_CSTRING("");
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",37)
	this->cookieString = HX_CSTRING("");
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",38)
	this->authType = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",39)
	this->contentType = HX_CSTRING("application/x-www-form-urlencoded");
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",40)
...
Void URLRequest_obj::basicAuth( ::String inUser,::String inPasswd){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",46)
		this->authType = (int)1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",47)
...
Void URLRequest_obj::digestAuth( ::String inUser,::String inPasswd){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",53)
		this->authType = (int)2;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",54)
		this->userPassword = ((inUser + HX_CSTRING(":")) + inPasswd);
	}
return null();
}
...
Void URLRequest_obj::nmePrepare( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",59)
		if (((this->data == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",61)
			this->nmeBytes = null();
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",63)
			if ((::Std_obj::is(this->data,hx::ClassOf< ::nme::utils::ByteArray >()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",65)
				this->nmeBytes = this->data;
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",66)
				if ((::Std_obj::is(this->data,hx::ClassOf< ::nme::net::URLVariables >()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",68)
					::nme::net::URLVariables vars = this->data;
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",69)
					::String str = vars->toString();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",70)
					this->nmeBytes = ::nme::utils::ByteArray_obj::__new(null());
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",71)
					this->nmeBytes->writeUTFBytes(str);
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",73)
					if ((::Std_obj::is(this->data,hx::ClassOf< ::String >()))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",75)
						::String str = this->data;
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",76)
						this->nmeBytes = ::nme::utils::ByteArray_obj::__new(null());
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",77)
						this->nmeBytes->writeUTFBytes(str);
					}
					else{
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",79)
						if ((::Std_obj::is(this->data,hx::ClassOf< ::Dynamic >()))){
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",81)
							::nme::net::URLVariables vars = ::nme::net::URLVariables_obj::__new(null());
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",82)
							{
								HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",82)
								int _g = (int)0;
								...
								while(((_g < _g1->length))){
									...
									HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",82)
									++(_g);
									HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",83)
									if (((vars != null()))){
										HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",83)
							...
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",85)
							::String str = vars->toString();
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",86)
							this->nmeBytes = ::nme::utils::ByteArray_obj::__new(null());
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",87)
							this->nmeBytes->writeUTFBytes(str);
						}
						else{
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLRequest.hx",90)
