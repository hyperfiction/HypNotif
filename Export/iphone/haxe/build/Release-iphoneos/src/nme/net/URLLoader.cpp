...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",54)
	super::__construct(null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",55)
	this->nmeHandle = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",56)
	this->bytesLoaded = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",57)
	this->bytesTotal = (int)-1;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",58)
	this->state = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",59)
	this->dataFormat = ::nme::net::URLLoaderDataFormat_obj::TEXT_dyn();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",60)
	if (((request != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",61)
		this->load(request);
	}
}
;
...
Array< ::String > URLLoader_obj::getCookies( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",72)
...
Void URLLoader_obj::load( ::nme::net::URLRequest request){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",91)
		this->state = (int)1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",92)
		::String pref = request->url.substr((int)0,(int)7);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",93)
		if (((bool((pref != HX_CSTRING("http://"))) && bool((pref != HX_CSTRING("https:/")))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",95)
			try{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",96)
				::nme::utils::ByteArray bytes = ::nme::utils::ByteArray_obj::readFile(request->url);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",97)
				{
::nme::net::URLLoaderDataFormat _switch_1 = (this->dataFormat);
					switch((_switch_1)->GetIndex()){
						case 1: {
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",99)
							this->data = bytes->asString();
						}
						;break;
						case 2: {
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",101)
							this->data = ::nme::net::URLVariables_obj::__new(bytes->asString());
						}
						;break;
						default: {
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",103)
							this->data = bytes;
						}
					}
				}
				...
				{
					Dynamic e = __e;{
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",109)
						this->onError(e);
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",110)
						return null();
					}
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",113)
			this->nmeDataComplete();
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",117)
			request->nmePrepare();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",118)
			this->nmeHandle = ::nme::net::URLLoader_obj::nme_curl_create(request);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",119)
			if (((this->nmeHandle == null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",120)
				this->onError(HX_CSTRING("Could not open URL"));
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",124)
...
Void URLLoader_obj::nmeDataComplete( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",130)
		::nme::net::URLLoader_obj::activeLoaders->remove(hx::ObjectPtr<OBJ_>(this));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",131)
		if (((this->nmeOnComplete_dyn() != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",132)
			if ((this->nmeOnComplete(this->data))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",134)
				this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::COMPLETE,null(),null()));
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",136)
				this->DispatchIOErrorEvent();
			}
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",139)
			this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::COMPLETE,null(),null()));
		}
	}
return null();
...
Void URLLoader_obj::onError( ::String msg){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",171)
		::nme::net::URLLoader_obj::activeLoaders->remove(hx::ObjectPtr<OBJ_>(this));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",172)
...
Void URLLoader_obj::dispatchHTTPStatus( int code){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",175)
		this->dispatchEvent(::nme::events::HTTPStatusEvent_obj::__new(::nme::events::HTTPStatusEvent_obj::HTTP_STATUS,false,false,code));
	}
return null();
}
...
Void URLLoader_obj::update( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",180)
		if (((this->nmeHandle != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",183)
			int old_loaded = this->bytesLoaded;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",184)
			int old_total = this->bytesTotal;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",185)
			::nme::net::URLLoader_obj::nme_curl_update_loader(this->nmeHandle,hx::ObjectPtr<OBJ_>(this));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",186)
			if (((bool((old_total < (int)0)) && bool((this->bytesTotal > (int)0))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",187)
				this->dispatchEvent(::nme::events::Event_obj::__new(::nme::events::Event_obj::OPEN,null(),null()));
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",191)
			if (((bool((this->bytesTotal > (int)0)) && bool((this->bytesLoaded != old_loaded))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",192)
				this->dispatchEvent(::nme::events::ProgressEvent_obj::__new(HX_CSTRING("progress"),false,false,this->bytesLoaded,this->bytesTotal));
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",196)
			int code = ::nme::net::URLLoader_obj::nme_curl_get_code(this->nmeHandle);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",198)
			if (((this->state == (int)3))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",200)
				this->dispatchHTTPStatus(code);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",202)
				if (((code < (int)400))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",204)
					::nme::utils::ByteArray bytes = ::nme::net::URLLoader_obj::nme_curl_get_data(this->nmeHandle);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",205)
					{
::nme::net::URLLoaderDataFormat _switch_2 = (this->dataFormat);
						switch((_switch_2)->GetIndex()){
							case 1: case 2: {
								HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",207)
								this->data = (  (((bytes == null()))) ? ::String(HX_CSTRING("")) : ::String(bytes->asString()) );
							}
							;break;
							default: {
								HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",209)
								this->data = bytes;
							}
						}
					}
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",212)
					this->nmeDataComplete();
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",217)
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",218)
					this->nmeHandle = null();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",219)
					this->dispatchEvent(evt);
				}
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",222)
				if (((this->state == (int)4))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",224)
					this->dispatchHTTPStatus(code);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",226)
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",227)
					this->nmeHandle = null();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",228)
					this->dispatchEvent(evt);
				}
			}
		}
...
bool URLLoader_obj::hasActive( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",78)
...
Void URLLoader_obj::initialize( ::String inCACertFilePath){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",84)
...
bool URLLoader_obj::nmeLoadPending( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",147)
	return !(::nme::net::URLLoader_obj::activeLoaders->isEmpty());
}
...
Void URLLoader_obj::nmePollData( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",153)
		if ((!(::nme::net::URLLoader_obj::activeLoaders->isEmpty()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",156)
			::nme::net::URLLoader_obj::nme_curl_process_loaders();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",157)
			::List oldLoaders = ::nme::net::URLLoader_obj::activeLoaders;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",158)
			::nme::net::URLLoader_obj::activeLoaders = ::List_obj::__new();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",159)
			for(::cpp::FastIterator_obj< ::nme::net::URLLoader > *__it = ::cpp::CreateFastIterator< ::nme::net::URLLoader >(oldLoaders->iterator());  __it->hasNext(); ){
				...
				{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",161)
					loader->update();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",162)
					if (((loader->state == (int)2))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/net/URLLoader.hx",163)
