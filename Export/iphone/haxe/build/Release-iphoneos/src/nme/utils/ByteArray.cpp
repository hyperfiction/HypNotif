...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",46)
	this->bigEndian = true;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",47)
	this->position = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",48)
	if (((inSize >= (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",55)
		Array< unsigned char > data = Array_obj< unsigned char >::__new();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",56)
		if (((inSize > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",57)
			data[(inSize - (int)1)] = (int)0;
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",58)
...
{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",79)
...
{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",81)
			if (((inLen > (int)0))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",82)
				inArray->__Field(HX_CSTRING("ensureElem"),true)((inLen - (int)1),true);
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",83)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",80)
...
{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",85)
...
{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",86)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",88)
	Dynamic init = ::nme::Loader_obj::load(HX_CSTRING("nme_byte_array_init"),(int)4);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",89)
...
int ByteArray_obj::__get( int pos){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",65)
...
Void ByteArray_obj::__set( int pos,int v){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",95)
		this->b[pos] = v;
	}
return null();
}
...
::String ByteArray_obj::asString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",105)
...
Void ByteArray_obj::checkData( int inLength){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",113)
		if ((((inLength + this->position) > this->length))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",115)
			this->ThrowEOFi();
		}
	}
return null();
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",124)
		::nme::utils::ByteArray src = hx::ObjectPtr<OBJ_>(this);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",126)
		::haxe::io::Bytes result = ::cpp::zip::Compress_obj::run(src,(int)8);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",127)
		this->b = result->b;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",128)
		this->length = result->length;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",129)
...
Void ByteArray_obj::ensureElem( int inSize,bool inUpdateLenght){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",138)
		int len = (inSize + (int)1);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",148)
		if (((this->b->length < len))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",149)
			this->b->__SetSize(len);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",151)
		if (((bool(inUpdateLenght) && bool((this->length < len))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",152)
			this->length = len;
		}
	}
return null();
...
Void ByteArray_obj::push( int inByte){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",169)
...
Void ByteArray_obj::push_uncheck( int inByte){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",180)
...
bool ByteArray_obj::readBoolean( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",190)
...
int ByteArray_obj::readByte( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",196)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",203)
		if (((inLen == (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",204)
			inLen = (this->length - this->position);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",205)
		if ((((this->position + inLen) > this->length))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",206)
			this->ThrowEOFi();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",207)
		if (((outData->length < (inOffset + inLen)))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",208)
			outData->ensureElem(((inOffset + inLen) - (int)1),true);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",213)
		Array< unsigned char > b1 = this->b;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",214)
		Array< unsigned char > b2 = outData->b;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",215)
		int p = this->position;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",216)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",216)
			int _g = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",216)
			while(((_g < inLen))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",216)
				int i = (_g)++;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",217)
				b2[(inOffset + i)] = b1->__get((p + i));
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",219)
...
double ByteArray_obj::readDouble( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",225)
	if ((((this->position + (int)8) > this->length))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",226)
		this->ThrowEOFi();
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",231)
	::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::__new((int)8,this->b->slice(this->position,(this->position + (int)8)));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",234)
	hx::AddEq(this->position,(int)8);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",235)
...
double ByteArray_obj::readFloat( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",249)
	if ((((this->position + (int)4) > this->length))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",250)
		this->ThrowEOFi();
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",255)
	::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::__new((int)4,this->b->slice(this->position,(this->position + (int)4)));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",258)
	hx::AddEq(this->position,(int)4);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",259)
...
int ByteArray_obj::readInt( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",265)
	int ch1 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->ThrowEOFi()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",266)
	int ch2 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->ThrowEOFi()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",267)
	int ch3 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->ThrowEOFi()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",268)
	int ch4 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->ThrowEOFi()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",269)
...
int ByteArray_obj::readShort( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",275)
	int ch1 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->ThrowEOFi()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",276)
	int ch2 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->ThrowEOFi()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",277)
	int val = (  ((this->bigEndian)) ? int((int((int(ch1) << int((int)8))) | int(ch2))) : int((((int(ch2) << int((int)8))) + ch1)) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",278)
...
int ByteArray_obj::readUnsignedByte( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",283)
	return (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->ThrowEOFi()) );
}
...
int ByteArray_obj::readUnsignedInt( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",290)
	int ch1 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->ThrowEOFi()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",291)
	int ch2 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->ThrowEOFi()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",292)
	int ch3 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->ThrowEOFi()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",293)
	int ch4 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->ThrowEOFi()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",294)
	return (  ((this->bigEndian)) ? int((int((int((int((int(ch1) << int((int)24))) | int((int(ch2) << int((int)16))))) | int((int(ch3) << int((int)8))))) | int(ch4))) : int((int((int((int((int(ch4) << int((int)24))) | int((int(ch3) << int((int)16))))) | int((int(ch2) << int((int)8))))) | int(ch1))) );
}
...
int ByteArray_obj::readUnsignedShort( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",300)
	int ch1 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->ThrowEOFi()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",301)
	int ch2 = (  (((this->position < this->length))) ? int(this->b->__get((this->position)++)) : int(this->ThrowEOFi()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",302)
...
::String ByteArray_obj::readUTF( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",308)
	int len = this->readUnsignedShort();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",309)
...
::String ByteArray_obj::readUTFBytes( int inLen){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",315)
	if ((((this->position + inLen) > this->length))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",316)
		this->ThrowEOFi();
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",317)
	int p = this->position;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",318)
	hx::AddEq(this->position,inLen);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",323)
	::String result = HX_CSTRING("");
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",324)
	::__hxcpp_string_of_bytes(this->b,result,p,inLen);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",325)
	return result;
}
...
Void ByteArray_obj::setLength( int inLength){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",332)
		if (((inLength > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",333)
			this->ensureElem((inLength - (int)1),false);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",334)
...
int ByteArray_obj::ThrowEOFi( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",340)
	hx::Throw (::nme::errors::EOFError_obj::__new());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",341)
	return (int)0;
}
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",350)
		::nme::utils::ByteArray src = hx::ObjectPtr<OBJ_>(this);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",353)
		::haxe::io::Bytes result = ::cpp::zip::Uncompress_obj::run(src,null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",354)
		this->b = result->b;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",355)
		this->length = result->length;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",356)
		this->position = (int)0;
	}
return null();
}
...
Void ByteArray_obj::writeBoolean( bool value){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",364)
...
Void ByteArray_obj::writeByte( int value){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",370)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",377)
		if (((inLength == (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",378)
			inLength = bytes->length;
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",379)
		this->ensureElem(((this->length + inLength) - (int)1),false);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",380)
		int olen = this->length;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",381)
		hx::AddEq(this->length,inLength);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",382)
...
Void ByteArray_obj::writeDouble( double x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",391)
		::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::ofData(::nme::utils::ByteArray_obj::_double_bytes(x,this->bigEndian));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",393)
...
Void ByteArray_obj::writeFile( ::String inString){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",399)
...
Void ByteArray_obj::writeFloat( double x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",410)
		::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::ofData(::nme::utils::ByteArray_obj::_float_bytes(x,this->bigEndian));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",412)
		this->writeBytes(bytes,null(),null());
	}
return null();
}
...
Void ByteArray_obj::writeInt( int value){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",418)
		this->ensureElem((this->length + (int)3),false);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",419)
		if ((this->bigEndian)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",421)
			this->b->__unsafe_set((this->length)++,(int(value) >> int((int)24)));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",422)
			this->b->__unsafe_set((this->length)++,(int(value) >> int((int)16)));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",423)
			this->b->__unsafe_set((this->length)++,(int(value) >> int((int)8)));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",424)
			this->b->__unsafe_set((this->length)++,value);
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",428)
			this->b->__unsafe_set((this->length)++,value);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",429)
			this->b->__unsafe_set((this->length)++,(int(value) >> int((int)8)));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",430)
			this->b->__unsafe_set((this->length)++,(int(value) >> int((int)16)));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",431)
			this->b->__unsafe_set((this->length)++,(int(value) >> int((int)24)));
		}
	}
return null();
...
Void ByteArray_obj::writeShort( int value){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",442)
		this->ensureElem((this->length + (int)1),false);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",443)
		if ((this->bigEndian)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",445)
			this->b->__unsafe_set((this->length)++,(int(value) >> int((int)8)));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",446)
			this->b->__unsafe_set((this->length)++,value);
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",450)
			this->b->__unsafe_set((this->length)++,value);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",451)
			this->b->__unsafe_set((this->length)++,(int(value) >> int((int)8)));
		}
	}
return null();
...
Void ByteArray_obj::writeUnsignedInt( int value){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",457)
		this->writeInt(value);
	}
return null();
}
...
Void ByteArray_obj::writeUTF( ::String s){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",467)
		::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::ofString(s);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",469)
		this->writeShort(bytes->length);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",470)
		this->writeBytes(bytes,null(),null());
	}
return null();
}
...
Void ByteArray_obj::writeUTFBytes( ::String s){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",479)
		::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::ofString(s);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",481)
		this->writeBytes(bytes,null(),null());
	}
return null();
}
...
int ByteArray_obj::nmeGetBytesAvailable( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",490)
...
::String ByteArray_obj::nmeGetEndian( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",491)
...
::String ByteArray_obj::nmeSetEndian( ::String s){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",492)
...
::nme::utils::ByteArray ByteArray_obj::fromBytes( ::haxe::io::Bytes inBytes){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",158)
	::nme::utils::ByteArray result = ::nme::utils::ByteArray_obj::__new((int)-1);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",159)
	result->b = inBytes->b;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",160)
	result->length = inBytes->length;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",164)
	return result;
}
...
::nme::utils::ByteArray ByteArray_obj::readFile( ::String inString){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/ByteArray.hx",241)
