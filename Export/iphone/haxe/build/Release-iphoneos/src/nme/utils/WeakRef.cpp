...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",17)
	if ((inMakeWeak)){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",20)
		this->weakRef = ::nme::utils::WeakRef_obj::nme_weak_ref_create(hx::ObjectPtr<OBJ_>(this),inObject);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",21)
		this->hardRef = null();
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",25)
		this->weakRef = (int)-1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",26)
...
Dynamic WeakRef_obj::get( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",33)
	if (((this->hardRef != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",34)
		return this->hardRef;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",36)
	if (((this->weakRef < (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",37)
		return null();
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",39)
	Dynamic result = ::nme::utils::WeakRef_obj::nme_weak_ref_get(this->weakRef);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",40)
	if (((result == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",41)
		this->weakRef = (int)-1;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",42)
	return result;
}
...
::String WeakRef_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",48)
	if (((this->hardRef == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",49)
		return (HX_CSTRING("") + this->hardRef);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/utils/WeakRef.hx",51)
