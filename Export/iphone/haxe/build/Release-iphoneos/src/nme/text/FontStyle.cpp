...
::nme::text::FontStyle FontStyle_obj::BOLD;

::nme::text::FontStyle FontStyle_obj::BOLD_ITALIC;

::nme::text::FontStyle FontStyle_obj::ITALIC;

::nme::text::FontStyle FontStyle_obj::REGULAR;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("nme.text.FontStyle"), hx::TCanCast< FontStyle_obj >,sStaticFields,sMemberFields,
