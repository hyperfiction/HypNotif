...
::String Assets_obj::getResourceName( ::String id){
	...
	HX_SOURCE_POS("nme/installer/Assets.hx",42)
	::nme::installer::Assets_obj::initialize();
	HX_SOURCE_POS("nme/installer/Assets.hx",43)
...
{
		HX_SOURCE_POS("nme/installer/Assets.hx",48)
		::nme::installer::Assets_obj::initialize();
		HX_SOURCE_POS("nme/installer/Assets.hx",50)
		if (((bool(::nme::installer::Assets_obj::resourceTypes->exists(id)) && bool((::nme::installer::Assets_obj::resourceTypes->get(id) == HX_CSTRING("image")))))){
			...
			if (((bool(useCache) && bool(::nme::installer::Assets_obj::cachedBitmapData->exists(id))))){
				HX_SOURCE_POS("nme/installer/Assets.hx",52)
				...
				HX_SOURCE_POS("nme/installer/Assets.hx",66)
				return data;
			}
		}
		else{
			HX_SOURCE_POS("nme/installer/Assets.hx",72)
			...
			HX_SOURCE_POS("nme/installer/Assets.hx",74)
			return null();
		}
		HX_SOURCE_POS("nme/installer/Assets.hx",50)
		return null();
...
::neash::utils::ByteArray Assets_obj::getBytes( ::String id){
	...
	if ((::nme::installer::Assets_obj::resourceNames->exists(id))){
		...
		HX_SOURCE_POS("nme/installer/Assets.hx",93)
		return null();
	}
	HX_SOURCE_POS("nme/installer/Assets.hx",85)
	return null();
...
::neash::text::Font Assets_obj::getFont( ::String id){
	...
	if (((bool(::nme::installer::Assets_obj::resourceTypes->exists(id)) && bool((::nme::installer::Assets_obj::resourceTypes->get(id) == HX_CSTRING("font")))))){
		...
		HX_SOURCE_POS("nme/installer/Assets.hx",112)
		return null();
	}
	HX_SOURCE_POS("nme/installer/Assets.hx",104)
	return null();
...
::neash::media::Sound Assets_obj::getSound( ::String id){
	...
	HX_SOURCE_POS("nme/installer/Assets.hx",137)
	...
	HX_SOURCE_POS("nme/installer/Assets.hx",139)
	return null();
}
...
::String Assets_obj::getText( ::String id){
	...
	if (((bytes == null()))){
		...
		HX_SOURCE_POS("nme/installer/Assets.hx",152)
