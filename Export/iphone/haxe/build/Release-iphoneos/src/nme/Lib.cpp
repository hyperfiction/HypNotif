...
Void Lib_obj::close( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",49)
		Dynamic close = ::nme::Loader_obj::load(HX_CSTRING("nme_close"),(int)0);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",50)
		close();
	}
return null();
}
...
Void Lib_obj::create( Dynamic inOnLoaded,int inWidth,int inHeight,hx::Null< double >  __o_inFrameRate,hx::Null< int >  __o_inColour,hx::Null< int >  __o_inFlags,hx::Null< ::String >  __o_inTitle,::nme::display::BitmapData inIcon){
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",54)
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",56)
		if ((::nme::Lib_obj::sIsInit)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",57)
			hx::Throw (HX_CSTRING("nme.Lib.create called multiple times. This function is automatically called by the project code."));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",60)
		::nme::Lib_obj::sIsInit = true;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",61)
		::nme::Lib_obj::initWidth = inWidth1->__get((int)0);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",62)
		::nme::Lib_obj::initHeight = inHeight1->__get((int)0);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",63)
...
{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",67)
				::nme::Lib_obj::nmeMainFrame = inFrameHandle;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",68)
				Dynamic stage_handle = ::nme::Lib_obj::nme_get_frame_stage(::nme::Lib_obj::nmeMainFrame);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",69)
				::nme::Lib_obj::nmeStage = ::nme::display::Stage_obj::__new(stage_handle,inWidth1->__get((int)0),inHeight1->__get((int)0));
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",70)
				::nme::Lib_obj::nmeStage->nmeSetFrameRate(inFrameRate1->__get((int)0));
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",71)
				::nme::Lib_obj::nmeStage->nmeSetBG(inColour1->__get((int)0));
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",72)
				::nme::Lib_obj::nmeStage->onQuit = ::nme::Lib_obj::close_dyn();
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",73)
				if (((::nme::Lib_obj::nmeCurrent != null()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",74)
					::nme::Lib_obj::nmeStage->addChild(::nme::Lib_obj::nmeCurrent);
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",75)
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",64)
...
::nme::display::ManagedStage Lib_obj::createManagedStage( int inWidth,int inHeight){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",84)
	::nme::Lib_obj::initWidth = inWidth;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",85)
	::nme::Lib_obj::initHeight = inHeight;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",86)
	::nme::display::ManagedStage result = ::nme::display::ManagedStage_obj::__new(inWidth,inHeight);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",87)
	::nme::Lib_obj::nmeStage = result;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",88)
	return result;
}
...
Void Lib_obj::exit( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",94)
		Dynamic quit = ::nme::Lib_obj::nmeGetStage()->onQuit_dyn();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",95)
		if (((quit != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",96)
			quit().Cast< Void >();
		}
	}
return null();
...
Void Lib_obj::forceClose( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",111)
		Dynamic terminate = ::nme::Loader_obj::load(HX_CSTRING("nme_terminate"),(int)0);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",112)
		terminate();
	}
return null();
}
...
int Lib_obj::getTimer( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",117)
...
Void Lib_obj::getURL( ::nme::net::URLRequest url,::String target){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",124)
...
Void Lib_obj::nmeSetCurrentStage( ::nme::display::Stage inStage){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",133)
...
Void Lib_obj::postUICallback( Dynamic inCallback){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",139)
...
Void Lib_obj::setIcon( ::String path){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",160)
		Dynamic set_icon = ::nme::Loader_obj::load(HX_CSTRING("nme_set_icon"),(int)1);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",161)
		set_icon(path);
	}
return null();
}
...
Void Lib_obj::setPackage( ::String inCompany,::String inFile,::String inPack,::String inVersion){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",166)
		::nme::Lib_obj::company = inCompany;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",167)
		::nme::Lib_obj::file = inFile;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",168)
		::nme::Lib_obj::packageName = inPack;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",169)
		::nme::Lib_obj::version = inVersion;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",170)
...
::nme::display::MovieClip Lib_obj::nmeGetCurrent( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",178)
	if (((::nme::Lib_obj::nmeCurrent == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",180)
		::nme::Lib_obj::nmeCurrent = ::nme::display::MovieClip_obj::__new();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",181)
		if (((::nme::Lib_obj::nmeStage != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",182)
			::nme::Lib_obj::nmeStage->addChild(::nme::Lib_obj::nmeCurrent);
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",184)
...
::nme::display::Stage Lib_obj::nmeGetStage( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",190)
	if (((::nme::Lib_obj::nmeStage == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",191)
		hx::Throw (HX_CSTRING("Error : stage can't be accessed until init is called"));
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/Lib.hx",192)
