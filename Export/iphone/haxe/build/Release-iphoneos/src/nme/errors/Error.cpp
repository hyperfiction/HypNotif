...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/errors/Error.hx",14)
	this->message = inMessage;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/errors/Error.hx",15)
	this->errorID = id;
}
;
	return null();
...
::String Error_obj::getStackTrace( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/errors/Error.hx",20)
	return HX_CSTRING("");
}
...
::String Error_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,3,1/nme/errors/Error.hx",26)
	return this->message;
}
