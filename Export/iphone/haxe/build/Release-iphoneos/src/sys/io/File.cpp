...
::String File_obj::getContent( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",31)
	::haxe::io::Bytes b = ::sys::io::File_obj::getBytes(path);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",32)
	return b->toString();
}
...
::haxe::io::Bytes File_obj::getBytes( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",36)
	Array< unsigned char > data = ::sys::io::File_obj::file_contents(path);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",37)
...
Void File_obj::saveContent( ::String path,::String content){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",41)
		::sys::io::FileOutput f = ::sys::io::File_obj::write(path,null());
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",42)
		f->writeString(content);
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",43)
		f->close();
	}
return null();
}
...
Void File_obj::saveBytes( ::String path,::haxe::io::Bytes bytes){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",47)
		::sys::io::FileOutput f = ::sys::io::File_obj::write(path,null());
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",48)
		f->write(bytes);
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",49)
		f->close();
	}
return null();
}
...
{
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",52)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",56)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",60)
...
Void File_obj::copy( ::String src,::String dst){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",65)
		::sys::io::FileInput s = ::sys::io::File_obj::read(src,true);
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",66)
		::sys::io::FileOutput d = ::sys::io::File_obj::write(dst,true);
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",67)
		d->writeInput(s,null());
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",68)
		s->close();
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/File.hx",69)
		d->close();
	}
return null();
}
