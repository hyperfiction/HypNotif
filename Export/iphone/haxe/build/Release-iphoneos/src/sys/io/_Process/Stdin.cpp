...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",33)
	this->p = p;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",34)
...
int Stdin_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",48)
	try{
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",48)
		...
		{
			Dynamic e = __e;{
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",50)
				hx::Throw (::haxe::io::Eof_obj::__new());
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",53)
	return (int)0;
}
