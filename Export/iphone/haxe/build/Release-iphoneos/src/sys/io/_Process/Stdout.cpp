...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",68)
	this->p = p;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",69)
	this->out = out;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",70)
...
int Stdout_obj::readByte( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",74)
	if (((this->readBytes(this->buf,(int)0,(int)1) == (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",75)
		hx::Throw (::haxe::io::Error_obj::Blocked_dyn());
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",76)
...
int Stdout_obj::readBytes( ::haxe::io::Bytes str,int pos,int len){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",80)
	int result;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",81)
	try{
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",81)
		...
		{
			Dynamic e = __e;{
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",83)
				hx::Throw (::haxe::io::Eof_obj::__new());
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",86)
	if (((result == (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",86)
		hx::Throw (::haxe::io::Eof_obj::__new());
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/Process.hx",87)
	return result;
}
