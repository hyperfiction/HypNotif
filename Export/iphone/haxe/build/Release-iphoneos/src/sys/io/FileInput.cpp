...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",33)
	this->__f = f;
}
;
	return null();
...
int FileInput_obj::readByte( ){
	...
	struct _Function_1_1{
		inline static int Block( ::sys::io::FileInput_obj *__this){
			{
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",38)
				try{
					HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",38)
					...
					{
						Dynamic e = __e;{
							HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",40)
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",37)
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
	...
	struct _Function_1_1{
		inline static int Block( ::sys::io::FileInput_obj *__this,::haxe::io::Bytes &s,int &p,int &l){
			{
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",49)
				try{
					HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",49)
					...
					{
						Dynamic e = __e;{
							HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",51)
							return (  ((e->__IsArray())) ? int(hx::Throw (::haxe::io::Eof_obj::__new())) : int(hx::Throw (::haxe::io::Error_obj::Custom(e))) );
						}
					}
				}
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",48)
...
Void FileInput_obj::close( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",60)
		this->super::close();
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",61)
...
Void FileInput_obj::seek( int p,::sys::io::FileSeek pos){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",64)
...
int FileInput_obj::tell( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",68)
...
bool FileInput_obj::eof( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",73)
