...
bool FileSystem_obj::exists( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",36)
...
Void FileSystem_obj::rename( ::String path,::String newpath){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",40)
		if (((::sys::FileSystem_obj::sys_rename(path,newpath) == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",42)
...
Dynamic FileSystem_obj::stat( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",46)
	Dynamic s = ::sys::FileSystem_obj::sys_stat(path);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",47)
	if (((s == null()))){
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",48)
		return _Function_2_1::Block();
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",49)
	s->__FieldRef(HX_CSTRING("atime")) = ::Date_obj::fromTime((1000.0 * s->__Field(HX_CSTRING("atime"),true)));
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",50)
	s->__FieldRef(HX_CSTRING("mtime")) = ::Date_obj::fromTime((1000.0 * s->__Field(HX_CSTRING("mtime"),true)));
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",51)
	s->__FieldRef(HX_CSTRING("ctime")) = ::Date_obj::fromTime((1000.0 * s->__Field(HX_CSTRING("ctime"),true)));
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",52)
	return s;
}
...
::String FileSystem_obj::fullPath( ::String relpath){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",55)
...
::sys::_FileSystem::FileKind FileSystem_obj::kind( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",60)
	::String k = ::sys::FileSystem_obj::sys_file_type(path);
	struct _Function_1_1{
		inline static ::sys::_FileSystem::FileKind Block( ::String &k){
			{
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",61)
				::String _switch_1 = (k);
				if (  ( _switch_1==HX_CSTRING("file"))){
					HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",62)
					return ::sys::_FileSystem::FileKind_obj::kfile_dyn();
				}
				else if (  ( _switch_1==HX_CSTRING("dir"))){
					HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",63)
					return ::sys::_FileSystem::FileKind_obj::kdir_dyn();
				}
				else  {
					HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",64)
...
bool FileSystem_obj::isDirectory( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",68)
...
Void FileSystem_obj::createDirectory( ::String path){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",72)
		if (((::sys::FileSystem_obj::sys_create_dir(path,(int)493) == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",74)
...
Void FileSystem_obj::deleteFile( ::String path){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",77)
		if (((::sys::FileSystem_obj::file_delete(path) == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",79)
...
Void FileSystem_obj::deleteDirectory( ::String path){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",82)
		if (((::sys::FileSystem_obj::sys_remove_dir(path) == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",84)
...
Array< ::String > FileSystem_obj::readDirectory( ::String path){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",87)
