...
Void PrioQueueIterator_obj::reset( ){
{
		...
		HX_SOURCE_POS("/Volumes/workspaceHaxe/inthebox/src/org/shoebox/collections/PriorityQueue.hx",237)
		this->inc = (int)0;
	}
return null();
}
...
bool PrioQueueIterator_obj::hasNext( ){
	...
	HX_SOURCE_POS("/Volumes/workspaceHaxe/inthebox/src/org/shoebox/collections/PriorityQueue.hx",247)
...
Dynamic PrioQueueIterator_obj::next( ){
	...
	HX_SOURCE_POS("/Volumes/workspaceHaxe/inthebox/src/org/shoebox/collections/PriorityQueue.hx",257)
