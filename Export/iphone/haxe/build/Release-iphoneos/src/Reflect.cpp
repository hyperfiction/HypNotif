...
Dynamic Reflect_obj::getProperty( Dynamic o,::String field){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",42)
...
Void Reflect_obj::setProperty( Dynamic o,::String field,Dynamic value){
{
		...
		if (((o != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",48)
...
Dynamic Reflect_obj::callMethod( Dynamic o,Dynamic func,Dynamic args){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",54)
	func->__SetThis(o);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",55)
...
Array< ::String > Reflect_obj::fields( Dynamic o){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",59)
	if (((o == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",59)
	...
	o->__GetFields(a);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",62)
	return a;
}
...
bool Reflect_obj::compareMethods( Dynamic f1,Dynamic f2){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",76)
	if (((bool(!(::Reflect_obj::isFunction(f1))) || bool(!(::Reflect_obj::isFunction(f2)))))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",77)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",78)
...
bool Reflect_obj::isObject( Dynamic v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",82)
	if (((v == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",82)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",83)
	int t = v->__GetType();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",84)
...
Dynamic Reflect_obj::copy( Dynamic o){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",94)
	if (((o == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",94)
		return null();
	}
	...
	if (((o->__GetType() == ::vtArray))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",97)
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",98)
	Dynamic o2 = _Function_1_1::Block();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",99)
	{
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",99)
		int _g = (int)0;
		...
		while(((_g < _g1->length))){
			...
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",99)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",100)
			if (((o2 != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",100)
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",101)
	return o2;
}
...
Dynamic Reflect_obj::makeVarArgs( Dynamic f){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Reflect.hx",104)
