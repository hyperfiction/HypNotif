...
Void Sys_obj::print( Dynamic v){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",28)
		::__hxcpp_print(v);
	}
return null();
}
...
Void Sys_obj::println( Dynamic v){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",33)
		::Sys_obj::print(v);
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",34)
...
::haxe::io::Input Sys_obj::_stdin( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",37)
...
::haxe::io::Output Sys_obj::_stdout( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",41)
...
::haxe::io::Output Sys_obj::_stderr( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",45)
...
int Sys_obj::getChar( bool echo){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",49)
...
Array< ::String > Sys_obj::args( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",53)
	return ::__get_args();
}
...
::String Sys_obj::getEnv( ::String s){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",58)
	::String v = ::Sys_obj::get_env(s);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",59)
	if (((v == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",60)
		return null();
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",61)
	return v;
}
...
Void Sys_obj::putEnv( ::String s,::String v){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",64)
		::Sys_obj::put_env(s,v);
	}
return null();
}
...
Void Sys_obj::sleep( double seconds){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",68)
...
bool Sys_obj::setTimeLocale( ::String loc){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",72)
...
::String Sys_obj::getCwd( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",76)
...
Void Sys_obj::setCwd( ::String s){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",80)
		::Sys_obj::set_cwd(s);
	}
return null();
}
...
::String Sys_obj::systemName( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",84)
...
::String Sys_obj::escapeArgument( ::String arg){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",89)
	bool ok = true;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",90)
	{
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",90)
		int _g1 = (int)0;
		int _g = arg.length;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",90)
			int i = (_g1)++;
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",91)
			switch( (int)(arg.charCodeAt(i))){
				case (int)32: case (int)34: {
					HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",92)
					ok = false;
				}
				;break;
				case (int)0: case (int)13: case (int)10: {
					HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",94)
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",97)
	if ((ok)){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",98)
		return arg;
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",99)
...
int Sys_obj::command( ::String cmd,Array< ::String > args){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",103)
	if (((args != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",104)
		cmd = ::Sys_obj::escapeArgument(cmd);
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",105)
		{
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",105)
			int _g = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",105)
			while(((_g < args->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",105)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",106)
				hx::AddEq(cmd,(HX_CSTRING(" ") + ::Sys_obj::escapeArgument(a)));
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",108)
...
Void Sys_obj::exit( int code){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",111)
...
double Sys_obj::time( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",115)
...
double Sys_obj::cpuTime( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",119)
...
::String Sys_obj::executablePath( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",123)
...
::Hash Sys_obj::environment( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",128)
	Array< ::String > vars = ::Sys_obj::sys_env();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",129)
	::Hash result = ::Hash_obj::__new();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",130)
	int i = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",131)
	while(((i < vars->length))){
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",132)
		result->set(vars->__get(i),vars->__get((i + (int)1)));
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",133)
		hx::AddEq(i,(int)2);
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Sys.hx",135)
	return result;
}
